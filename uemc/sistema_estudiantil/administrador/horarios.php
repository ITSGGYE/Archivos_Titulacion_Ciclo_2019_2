...
include ("../menu_conexion/conectar.php");
	...
	$check = mysqli_query($conexion,"SELECT * FROM horarios WHERE año='$year' AND seccion='$section' AND cicloEspecializacion='$especializacion'");
	$count = mysqli_num_rows($check);
	if(!$count){
	//means not added so add now	
	// NOW INSERTING INTO THE DATABASE 
	// for monday
	$monday = mysqli_query($conexion, "INSERT INTO horarios (dia,hora1,hora2,hora3,hora4,hora5,hora6,hora7,hora8,año,seccion,cicloEspecializacion) VALUES ('$mday','$mper1','$mper2','$mper3','$mper4','$mper5','$mper6','$mper7','$mper8','$year','$section','$especializacion')");
	// for tuesday
$tuesday = mysqli_query($conexion, "INSERT INTO horarios (dia,hora1,hora2,hora3,hora4,hora5,hora6,hora7,hora8,año,seccion,cicloEspecializacion) VALUES ('$tday','$tper1','$tper2','$tper3','$tper4','$tper5','$tper6','$tper7','$tper8','$year','$section','$especializacion')");
// for wednesday
$wednesday = mysqli_query($conexion, "INSERT INTO horarios (dia,hora1,hora2,hora3,hora4,hora5,hora6,hora7,hora8,año,seccion,cicloEspecializacion) VALUES ('$wday','$wper1','$wper2','$wper3','$wper4','$wper5','$wper6','$wper7','$wper8','$year','$section','$especializacion')");
// for thursday
$thursday = mysqli_query($conexion, "INSERT INTO horarios (dia,hora1,hora2,hora3,hora4,hora5,hora6,hora7,hora8,año,seccion,cicloEspecializacion) VALUES ('$thday','$thper1','$thper2','$thper3','$thper4','$thper5','$thper6','$thper7','$thper8','$year','$section','$especializacion')");
// for friday
$friday = mysqli_query($conexion, "INSERT INTO horarios (dia,hora1,hora2,hora3,hora4,hora5,hora6,hora7,hora8,año,seccion,cicloEspecializacion) VALUES ('$fday','$fper1','$fper2','$fper3','$fper4','$fper5','$fper6','$fper7','$fper8','$year','$section','$especializacion')");
	
	$msg = "<font color=\"green\">El horario se ha guardado satisfactoriamente.</font>";
}
else{
