...
<html>
	...
	<body>
		<div class="container" align="center">
			...
			<br/>
			<div class="promote">
			<form method="post" action="registroCal.php" >
			<table class="table table-bordered table-hover" width="400px">
			<caption align="center"><h3>Agregar Calificaciones de los Estudiantes  </h3></caption>
			<tbody>
...
$count =  mysqli_num_rows($sql);
			echo "
			<div class='container'><div class='promotess'>
		<form method='post' action='registroCalificaciones'>
		<table class='table table-bordered table-hover'>
		<tbody>
		<th class='danger' colspan='3'>Asistencia del estudiante</th>
		<tr><td class='info'>			
