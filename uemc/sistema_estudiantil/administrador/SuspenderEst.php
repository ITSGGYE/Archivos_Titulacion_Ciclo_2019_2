...
if((isset($_POST["detainId"])) && (isset($_POST["Id"])) && (isset($_POST["year"])) && (isset($_POST["section"])) && (isset($_POST["espe"])) ){
 ...
 if($year == "Octavo"){
	...
	if($sql){
		...
		$det = mysqli_query($conexion, "UPDATE estudiantes SET Estado = 'Inactivo' WHERE idEst ='$id' ");
		if($det){
	...
	if($sql){
		//INDICATES THAT STUDENT IS PRESENT SO DETAINING THE STUDENT
		$det = mysqli_query($conexion, "UPDATE estudiantes SET Estado = '1' WHERE idEst ='$id' ");
		if($det){
			$msg = "<font color=\"green\">Suspendido con exito</font>";
		}
	}else{
  ...
  // NOW CHECKING 3-1 
   ...
   // NOW CHECKING 3-2 
	...
	if($sql){
		//INDICATES THAT STUDENT IS PRESENT SO DETAINING THE STUDENT
		$det = mysqli_query($conexion, "UPDATE estudiante SET Estado = '1' WHERE idEst ='$id' ");
		if($det){
			$msg = "<font color=\"green\">Suspendido con exito</font>";
		}
	}else{
...
<html>
	...
	<body>
		<div class="container" align="center">
			...
			<br/>
			<div class="promote">
			<form method="post" action="suspenderEst.php" name="regupdate">
