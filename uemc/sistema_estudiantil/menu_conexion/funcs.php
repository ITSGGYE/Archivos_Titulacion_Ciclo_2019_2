<?php
	...
	function registraUsuario($usuario, $pass_hash, $nombre, $email, $activo, $token, $tipo_usuario){
		...
		$stmt = $mysqli->prepare("INSERT INTO usuario (usuario, password, nombre, correo, activacion, token, id_tipo) VALUES(?,?,?,?,?,?,?)");
	...
	function enviarEmail($email, $nombre, $asunto, $cuerpo){
		...
		$mail->Host = '@gmail.com'; //Modificar
		$mail->Port = '587'; //Modificar
		
		$mail->Username = 'velizelmasvacan@gmail.com'; //Modificar
		$mail->Password = 'mylan2018'; //Modificar
		
		$mail->setFrom('velizelmasvacan@gmail.com', 'Sistema Acádemico Manuela Cañizares'); //Modificar
	...
	function login($usuario, $password)
	{
		...
		$stmt = $mysqli->prepare("SELECT id, id_tipo, password FROM usuario WHERE usuario = ? || correo = ? LIMIT 1");
