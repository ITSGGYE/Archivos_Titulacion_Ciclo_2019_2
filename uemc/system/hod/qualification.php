...
<?php
	...
	if(isset($_POST["est"]) && isset($_POST["par"]) && (isset($_POST["doc"])) && (isset($_POST["mat"])) && (isset($_POST["campo1"])) && (isset($_POST["campo2"])) && (isset($_POST["campo3"])) && (isset($_POST["campo4"])) && (isset($_POST["campo5"])) && (isset($_POST["campo6"])) && (isset($_POST["campo7"])) && (isset($_POST["campo8"])) && (isset($_POST["camp9"])) ){
	 ...
	 if($sem == "Octavo"){
		...
		if($countCheck != $count){
			$sql1 = mysqli_query($conexion,"INSERT INTO `qualification` (`parcial`, `Nombre`, `Curso`, `Seccion`, `Materia`,`Docente`,`prom_tai`,`prom_aic`,`prom_agc`,`prom_lo_y_le`,`eval_sum`,`prom_par`,`cualit`,`Conduct`,`observ`) VALUES ('$par','$est','$sem','$sec','$mat','$doc','$campo1','$campo2','$campo3','$campo4','$campo5','$campo6','$campo7','$campo8','$campo9');");
		}
		else{
