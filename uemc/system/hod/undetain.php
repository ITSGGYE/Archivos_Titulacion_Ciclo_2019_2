...
if((isset($_POST["detainId"])) && (isset($_POST["year"]))){
  ...
  if($year == "Octavo"){
	...
	if($sql){
		...
		$det = mysqli_query($conexion,"UPDATE s1 SET detained = '0' WHERE id = '$id'AND detained = '1' ");
		if($det){
...
// NOW CHECKING 1-2 
	...
	if($sql){
		//INDICATES THAT STUDENT IS PRESENT SO DETAINING THE STUDENT
		$det = mysqli_query( $conexion, "UPDATE s2 SET detained = '0' WHERE id = '$id' AND detained = '1' ");
		if($det){
			$msg = "<font color=\"green\">Exitosamente </font>";
		}
	}else{
...
// NOW CHECKING 2-1 
	...
	if($sql){
		//INDICATES THAT STUDENT IS PRESENT SO DETAINING THE STUDENT
		$det = mysqli_query( $conexion, "UPDATE s3 SET detained = '0' WHERE id = '$id' AND detained = '1' ");
		if($det){
			$msg = "<font color=\"green\">Exitosamente </font>";
		}
	}else{
...
<html>
	...
	<body>
		<div class="container" align="center">
			...
			<caption align="center"><h3>Deshacer estudiantes Suspendidos </h3></caption>
			<tbody>
			...
			<option value="Décimo">Décimo</option>
				...
				<tr>
					<td colspan="2" align="center" class="Realizado">
						<?php echo $msg; ?>
					</td>
				</tr>
			</tbody>			
