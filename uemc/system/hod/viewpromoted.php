		...
		<div class="container" align="center">
			...
			<tbody>
				...
				//view the promoted list
					if($yrs == "I-II"){
						$sts = mysqli_query($conexion,"SELECT * FROM s2");
						...
						$sts = mysqli_query($conexion,"SELECT * FROM s3");
						while($row=mysqli_fetch_array($sts)){
							$name = $row["sname"];
							$rid = $row["id"];
						...
						$sts = mysqli_query($conexion,"SELECT * FROM s4");
						while($row=mysqli_fetch_array($sts)){
							$name = $row["sname"];
							$rid = $row["id"];
						...
						$sts = mysqli_query($conexion,"SELECT * FROM s5");
						while($row=mysqli_fetch_array($sts)){
							$name = $row["sname"];
							$rid = $row["id"];
						...
						$sts = mysqli_query($conexion,"SELECT * FROM s6");
						while($row=mysqli_fetch_array($sts)){
							$name = $row["sname"];
							$rid = $row["id"];
						...
						$sts = mysqli_query($conexion,"SELECT * FROM s7");
						while($row=mysqli_fetch_array($sts)){
							$name = $row["sname"];
							$rid = $row["id"];
						...
						$sts = mysqli_query($conexion,"SELECT * FROM s8");
						while($row=mysqli_fetch_array($sts)){
							$name = $row["sname"];
							$rid = $row["id"];
