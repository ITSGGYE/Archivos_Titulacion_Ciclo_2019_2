...
if((isset($_POST["detainId"])) && (isset($_POST["year"]))){
 ...
 if($year == "Primero de Bachillerato"){
	...
	if($sql){
		...
		$det = mysqli_query($conexion, "UPDATE s4 SET detained = '1' WHERE id = '$id' ");
		if($det){
  ...
  // NOW CHECKING 3-1 
	...
	if($sql){
		//INDICATES THAT STUDENT IS PRESENT SO DETAINING THE STUDENT
		$det = mysqli_query($conexion, "UPDATE s5 SET detained = '1' WHERE id = '$id' ");
		if($det){
			$msg = "<font color=\"green\">Suspendido con exito</font>";
		}
	}else{
   ...
   // NOW CHECKING 3-2 
	...
	if($sql){
		//INDICATES THAT STUDENT IS PRESENT SO DETAINING THE STUDENT
		$det = mysqli_query($conexion, "UPDATE s6 SET detained = '1' WHERE id = '$id' ");
		if($det){
			$msg = "<font color=\"green\">Suspendido con exito</font>";
		}
	}else{
...
<html>
	...
	<body>
		<div class="container" align="center">
			...
			<br/>
			<div class="promote">
			<form method="post" action="detain2.php" name="regupdate">
