...
if((isset($_POST["rid"])) && (isset($_POST["year"])) && (isset($_POST["section"])) && (isset($_POST["names"])) ){
	...
	if($year == "Octavo"){
				...
				if($count){
					...
					$sql1 = mysqli_query( $conexion, "INSERT INTO `s1` (`id`, `sem`, `detained`,`sec`,`sname`) VALUES ('$id', 'Octavo', '0','$section','$sname')");
					if($sql1){
	...
	//for transfer students
				...
				if($count){
					...
					$sql1 = mysqli_query( $conexion, "INSERT INTO `s2` (`id`, `sem`, `detained`,`sec`,`sname`) VALUES ('$id', 'Noveno', '0','$section','$sname')");
					if($sql1){
						$msg = "<font color=\"green\">Registrado exitosamente</font>";
					}
	...
	//REGISTRATION FOR LATERAL ENTRY
				...
				if($count){
					...
					$sql1 = mysqli_query( $conexion, "INSERT INTO `s3` (`id`, `sem`, `detained`,`sec`,`sname`) VALUES ('$id', 'Décimo', '0','$section','$sname')");
					if($sql1){
						$msg = "<font color=\"green\">Registrado exitosamente</font>";
					}
...
//TRANSFER STUDENTS II II
				...
				if($count){
					...
					$sql1 = mysqli_query( $conexion, "INSERT INTO `s4` (`id`, `sem`, `detained`,`sec`,`sname`) VALUES ('$id', 'Primero de Bachillerato', '0','$section','$sname')");
					if($sql1){
						$msg = "<font color=\"green\">Registrado exitosamente</font>";
					}
	...
	// III-I TRANSFER STUDENTS
				...
				if($count){
					...
					$sql1 = mysqli_query( $conexion, "INSERT INTO `s5` (`id`, `sem`, `detained`,`sec`,`sname`) VALUES ('$id', 'Segundo de Bachillerato', '0','$section','$sname')");
					if($sql1){
						$msg = "<font color=\"green\">Registrado exitosamente</font>";
					}
	...
	//FOR TRANSFER STUDENTS III -II 
				...
				if($count){
					...
					$sql1 = mysqli_query( $conexion, "INSERT INTO `s6` (`id`, `sem`, `detained`,`sec`,`sname`) VALUES ('$id', 'Tercero de Bachillerato', '0','$section','$sname')");
					if($sql1){
						$msg = "<font color=\"green\">Registrado exitosamente</font>";
					}
