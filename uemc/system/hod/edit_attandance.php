...
if(isset($_POST["sem"]) && isset($_POST["section"]) && isset($_POST["sub"]) && isset($_POST["period"]) && isset($_POST["date"])){
	...
	if($a == "Octavo"){
		$sql = mysqli_query($conexion,  "SELECT * FROM a1 WHERE sec = '$section' and per='$period' and fac= '$sub' and day = '$dat' ");
		...
		if($count){
				...
				";
				$sql1 = mysqli_query($conexion, "SELECT * FROM a1 WHERE sec = '$section' and per='$period' and fac= '$sub' and day = '$dat' ");
	...
	// for editing 1-2 attendance
		...
		$sql = mysqli_query($conexion, "SELECT * FROM a2 WHERE sec = '$section' and per='$period' and fac= '$sub' and day = '$dat' ");
		$count =  mysqli_num_rows($sql);
			if($count){
					echo "
					<div class='container'><div class='promotess'>
				...
				<input type='hidden' name='period' value='$period'/> 
				";
				$sql1 = mysqli_query($conexion, "SELECT * FROM a2 WHERE sec = '$section' and per='$period' and fac= '$sub' and day = '$dat' ");
				while($row = mysqli_fetch_array($sql1)){
					$id = $row["id"];
					$sem = $row["sem"];
					$sections = $row["sec"];
	...
	//for editing 2-1 attendance
		...
		$sql = mysqli_query($conexion, "SELECT * FROM a3 WHERE sec = '$section' and per='$period' and fac= '$sub' and day = '$dat' ");
		$count =  mysqli_num_rows($sql);
		if($count){
					echo "
					<div class='container'><div class='promotess'>
				...
				<input type='hidden' name='period' value='$period'/> 
				";
				$sql1 = mysqli_query($conexion, "SELECT * FROM a3 WHERE sec = '$section' and per='$period' and fac= '$sub' and day = '$dat' ");
				while($row = mysqli_fetch_array($sql1)){
					$id = $row["id"];
					$sem = $row["sem"];
					$sections = $row["sec"];
	...
	//for editing 2-2 attendance
		...
		$sql = mysqli_query($conexion, "SELECT * FROM a4 WHERE sec = '$section' and per='$period' and fac= '$sub' and day = '$dat' ");
		$count =  mysqli_num_rows($sql);
		if($count){
					echo "
					<div class='container'><div class='promotess'>
				...
				<input type='hidden' name='period' value='$period'/> 
				";
				$sql1 = mysqli_query($conexion, "SELECT * FROM a4 WHERE sec = '$section' and per='$period' and fac= '$sub' and day = '$dat' ");
				while($row = mysqli_fetch_array($sql1)){
					$id = $row["id"];
					$sem = $row["sem"];
					$sections = $row["sec"];
	...
	//for edting 3-1 attendance
		...
		$sql = mysqli_query($conexion,  "SELECT * FROM a5 WHERE sec = '$section' and per='$period' and fac= '$sub' and day = '$dat' ");
		$count =  mysqli_num_rows($sql);
		if($count){
					echo "
					<div class='container'><div class='promotess'>
				...
				<input type='hidden' name='period' value='$period'/> 
				";
				$sql1 = mysqli_query($conexion, "SELECT * FROM a5 WHERE sec = '$section' and per='$period' and fac= '$sub' and day = '$dat' ");
				while($row = mysqli_fetch_array($sql1)){
					$id = $row["id"];
					$sem = $row["sem"];
					$sections = $row["sec"];
	...
	// for editing 3-2 attendance
		...
		$sql = mysqli_query($conexion, "SELECT * FROM a6 WHERE sec = '$section' and per='$period' and fac= '$sub' and day = '$dat' ");
		$count =  mysqli_num_rows($sql);
		if($count){
					echo "
					<div class='container'><div class='promotess'>
				...
				<input type='hidden' name='period' value='$period'/> 
				";
				$sql1 = mysqli_query($conexion, "SELECT * FROM a6 WHERE sec = '$section' and per='$period' and fac= '$sub' and day = '$dat' ");
				while($row = mysqli_fetch_array($sql1)){
					$id = $row["id"];
					$sem = $row["sem"];
					$sections = $row["sec"];
	...
	// for editing 4-1 attendance
		...
		$sql = mysqli_query($conexion, "SELECT * FROM a7 WHERE sec = '$section' and per='$period' and fac= '$sub' and day = '$dat' ");
		$count =  mysqli_num_rows($sql);
		if($count){
					echo "
					<div class='container'><div class='promotess'>
				...
				<input type='hidden' name='period' value='$period'/> 
				";
				$sql1 = mysqli_query($conexion, "SELECT * FROM a7 WHERE sec = '$section' and per='$period' and fac= '$sub' and day = '$dat' ");
				while($row = mysqli_fetch_array($sql1)){
					$id = $row["id"];
					$sem = $row["sem"];
					$sections = $row["sec"];
	...
	// for editing 4-2 attendance
		...
		$sql = mysqli_query($conexion,"SELECT * FROM a8 WHERE sec = '$section' and per='$period' and fac= '$sub' and day = '$dat' ");
		$count =  mysqli_num_rows($sql);
		if($count){
					echo "
					<div class='container'><div class='promotess'>
				...
				<input type='hidden' name='period' value='$period'/> 
				";
				$sql1 = mysqli_query($conexion, "SELECT * FROM a8 WHERE sec = '$section' and per='$period' and fac= '$sub' and day = '$dat' ");
				while($row = mysqli_fetch_array($sql1)){
					$id = $row["id"];
					$sem = $row["sem"];
					$sections = $row["sec"];
...
<?php
	...
	do{
		...
		if( isset($_POST["ids$i"]) ){
			...
			if($sem == "Octavo"){
				$sql1 = mysqli_query($conexion, "UPDATE `a1` SET  `atten`='$res' WHERE (id='$id' and sec = '$sec' and per='$period' and sname='$nmup') and (fac= '$subject' and day = '$date')");
			}
			// update 1-2 attendance
			else if($sem == "Noveno"){
				$sql1 = mysqli_query($conexion, "UPDATE `a2` SET  `atten`='$res' WHERE id='$id' and sec = '$sec' and per='$period' and sname='$nmup' and fac= '$subject' and day = '$date'");
			}
			// update 2-1 attendance
			else if($sem == "Décimo"){
				$sql1 = mysqli_query($conexion, "UPDATE `a3` SET  `atten`='$res' WHERE id='$id' and sec = '$sec' and per='$period' and sname='$nmup' and fac= '$subject' and day = '$date'");
			}
			//update 2-2 attendance
			else if($sem == "Primero de Bachillerato"){
				$sql1 = mysqli_query($conexion, "UPDATE `a4` SET  `atten`='$res' WHERE id='$id' and sec = '$sec' and per='$period' and sname='$nmup' and fac= '$subject' and day = '$date'");
			}
			//update 3-1 attendance
			else if($sem == "Segundo de Bachillerato"){
				$sql1 = mysqli_query($conexion, "UPDATE `a5` SET  `atten`='$res' WHERE id='$id' and sec = '$sec' and per='$period' and sname='$nmup' and fac= '$subject' and day = '$date'");
			}
			//update 3-2 attendance
			else if($sem == "Tercero de Bachillerato"){
				$sql1 = mysqli_query($conexion, "UPDATE `a6` SET  `atten`='$res' WHERE id='$id' and sec = '$sec' and per='$period' and sname='$nmup' and fac= '$subject' and day = '$date'");
			}
			//update 4-1 attendance
			else if($sem == "IV-I"){
				$sql1 = mysqli_query($conexion, "UPDATE `a7` SET  `atten`='$res' WHERE id='$id' and sec = '$sec' and per='$period' and sname='$nmup' and fac= '$subject' and day = '$date'");
			}
			//update 4-2 attendance
			else if($sem == "IV-II"){
				$sql1 = mysqli_query($conexion, "UPDATE `a8` SET  `atten`='$res' WHERE id='$id' and sec = '$sec' and per='$period' and sname='$nmup' and fac= '$subject' and day = '$date'");
			}
		}
		$i++;
	}while( $i <= $count );
