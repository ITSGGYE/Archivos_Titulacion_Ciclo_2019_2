...
if(isset($_POST["old_Id"]) && isset($_POST["new_Id"])){
	...
	$sql1 = mysqli_query($conexion,"SELECT * FROM user WHERE id='$id'and password = '$old' ");
	...
	if($ck == $old){
		...
		$sql = mysqli_query($conexion, "UPDATE user SET password = '$newID' WHERE id='$id' and password = '$old' ");
