<?php
    ...
    $result = $reportes->getReporteUsuarios();
            ...
            <div class="box-card-large">
                <table  class="centered" style="text-align: center;">
                   <b> <tr style="text-align: center; background-color: #95BC11;">
                        ...
                        <td style="text-align: center;color: white;font-weight: bold;"><b>CEDULA</b></td>
                        <td style="text-align: center;color: white;font-weight: bold;"><b>NOMBRES</b></td>
                        <td style="text-align: center;color: white;font-weight: bold;"><b>TIPO_USUARIO</b></td>
