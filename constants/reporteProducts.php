<?php
    ...
    $result = $reportes->getReporteProduct();
        ...
        <div class="conteiner">
            <div class="box-card-large">
                <table  class="centered" style="text-align: center;">
                   <b> <tr style="text-align: center; background-color: #95BC11;">
                        <td style="text-align: center; color: white;font-weight: bold;"><b>#</b></td>
                        <td style="text-align: center;color: white;font-weight: bold;"><b>COD. PRODUCTO</b></td>
                        <td style="text-align: center;color: white;font-weight: bold;"><b>NOMBRE PRODUCTO</b></td>
                        <td style="text-align: center;color: white;font-weight: bold;"><b>PRESENTACIÓN</b></td>
                        <td style="text-align: center;color: white;font-weight: bold;"><b>PRECIO</b></td>
                    </tr></b>
                    <tbody id="body">
                        ' . $result . '
                    </tbody>
