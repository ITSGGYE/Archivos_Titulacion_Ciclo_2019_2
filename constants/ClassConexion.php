...
class Conexion
{
    ...
    private $host = "127.0.0.1"; // variable para definir el host
    private $db = "GUANABASO"; // variable para definir la base de datos en la que vamos a trabajar
    private $user = "root"; // variable para definir el usuario que usaremos para ejecutar las consultas en la base de datos
