...
<body class="loader-active" style="background-image: url('imagen/fondo_blanco.jpg'); background-position: center center;      
    ...
    <section id="lgoin-page-wrap" style="margin-top:150px;" class="section-padding">
        ...
        <div class="contact-form">
            <div style="font-size: 18px; color: red; margin-top: 20px;" align="center">
                <?php
        ...
        <h4 style="color: #0985E1;">Registrar Datos de nuevo Estudiante</h4></center><br>
        <form style="color:#000;" enctype="multipart/form-data" action="" method="POST">
            <div class="col-xs-14">
            <div class="form-row">
               <div class="col-lg-2 col-md-3">
                  <input onkeypress="return soloCedula(event);" id="est_cedula" type="text" name="est_cedula" maxlength="10" placeholder="Escriba su cedula.." required>
              ...
              <div class="col-lg-4 col-md-3">
                ...
                <div class="col-lg-2 col-md-3">
                    <input onkeypress="return soloCedula(event);" id="est_convencional" name="est_convencional" maxlength="9" type="text" placeholder="Escriba convencional..">
                    <label style="color: #0985E1;">Convencional: <label style="color: red;">(opcional)</label></label>
               </div>       
        </div>

        <div class="form-row">
            <div class="col-lg-2 col-md-3">
                    <input onkeypress="return soloCedula(event);" id="est_celular" name="est_celular" maxlength="10" matype="text" placeholder="Escriba su Whatsapp.." required>
                    <label style="color: #0985E1;">Whatsapp: </label>
            </div>  

            <div class="col-lg-4 col-md-3">
                  <input onkeypress="return soloMail(event);" id="est_correo" name="est_correo" type="email" placeholder="Escriba su correo..">
                  <label style="color: #0985E1;">Correo Electronico: <label style="color: red;">(opcional)</label></label>
            </div>
        ...
        <div class="form-row">
            <div class="col-lg-1 col-md-3">
                <input onkeypress="return soloCedula(event);" id="est_edad" name="est_edad" type="text" maxlength="2" placeholder="Edad..">
                <label style="color: #0985E1;">Edad: </label>
            </div>
        
             <div class="col-lg-3 col-md-3">
              <input onkeypress="return soloLetras(event);" id="est_enfermedad" name="est_enfermedad" placeholder="Escribir tipo de enfermedad.." type="text">
              <label style="color: #0985E1;">Alguna Enfermedad: <label style="color: red;">(opcional)</label></label>
            </div>
        
              <div class="col-lg-3 col-md-3">
              <input onkeypress="return soloLetras(event);" placeholder="Tipo de alergia.." id="est_alergias" name="est_alergias" type="text">
                <label style="color: #0985E1;">Tipos de  Alergias: <label style="color: red;">(opcional)</label></label>
              </div>
        ...
        <div class="form-row">
              <div class="col-lg-2 col-md-3">
                <select name="est_curso" id="est_curso" class="form-control">
                  ...
                  <option  value="Nivelación 1">Nivelación 1</option>
                  <option  value="Nivelación 2">Nivelación 2</option>
                  <option  value="Nivelación 3">Nivelación 3</option>
                </select> 
      ...
      <div class="form-row">  
            ...
            <div class="form-row">
                ...
                <div class="col-lg-4 col-md-3">
                    <input onkeypress="return soloCedula(event);" placeholder="Escriba cedula.." id="est_cedula_ref" name="est_cedula_ref" maxlength="10" type="text">
            ...
            <div class="form-row">
               <div class="col-lg-4 col-md-3">
                    <input onkeypress="return soloCedula(event);" placeholder="Escriba telefono.." id="est_tlf_ref" name="est_tlf_ref" maxlength="10" type="text">
                    <label style="color: #0985E1;">Telefono: <label style="color: red;">(opcional)</label></label>
               </div>

               <div class="col-lg-4 col-md-3">
                    <input onkeypress="return soloMail(event);" placeholder="Escriba correo.." id="est_correo_ref" name="est_correo_ref" type="email">
                    <label style="color: #0985E1;">Correo: <label style="color: red;">(opcional)</label></label>
                </div>
