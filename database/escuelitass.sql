/*
 ...
 Source Schema         : escuelitass

 Target Server Type    : MySQL
 Target Server Version : 50711
 File Encoding         : 65001

 Date: 26/05/2020 00:46:03
*/
...
-- ----------------------------
INSERT INTO `anos_lectivos` VALUES (1, '2222 - 2223 ', 1, 1, '2019-10-10 23:29:59', '2020-05-24 01:18:59', NULL);
INSERT INTO `anos_lectivos` VALUES (98, '2020 - 2021 ', 2, 1, '2020-03-21 17:54:10', '2020-05-24 01:18:43', NULL);
INSERT INTO `anos_lectivos` VALUES (99, '2022 - 2023 ', 2, 1, '2020-04-24 19:41:47', '2020-05-24 01:18:45', NULL);
...
-- Records of aulas
-- ----------------------------
INSERT INTO `aulas` VALUES (41, '500', 45, 19, 1, '2020-03-23 01:57:26', '2020-03-23 22:41:33', NULL, 1);
INSERT INTO `aulas` VALUES (42, '201', 45, 19, 1, '2020-03-23 01:58:02', NULL, NULL, 1);
INSERT INTO `aulas` VALUES (46, '400', 45, 19, 1, '2020-03-23 02:02:49', '2020-05-17 09:25:59', NULL, 1);
INSERT INTO `aulas` VALUES (51, 'momo', 30, 18, 1, '2020-03-23 14:05:28', NULL, NULL, 1);
INSERT INTO `aulas` VALUES (52, '467', 45, 18, 1, '2020-03-23 14:59:38', NULL, NULL, 1);
INSERT INTO `aulas` VALUES (54, '600', 34, 19, 1, '2020-04-05 20:06:42', NULL, NULL, 1);
INSERT INTO `aulas` VALUES (55, 'rr', 25, 20, 1, '2020-04-10 23:55:57', NULL, NULL, 1);
INSERT INTO `aulas` VALUES (56, 'TE', 24, 27, 1, '2020-04-24 19:52:13', NULL, NULL, 1);
...
CREATE TABLE `aulas_jornadas`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `id_jornadas_2`(`id_jornadas`, `id_aulas`) USING BTREE,
  UNIQUE INDEX `id_jornadas_3`(`id_aulas`, `id_jornadas`) USING BTREE,
...
-- ----------------------------
INSERT INTO `aulas_jornadas` VALUES (55, 135, 41, '2020-03-23 01:57:26', NULL, NULL, 1, 0);
INSERT INTO `aulas_jornadas` VALUES (56, 135, 42, '2020-03-23 01:58:02', NULL, NULL, 1, 0);
INSERT INTO `aulas_jornadas` VALUES (57, 136, 46, '2020-03-23 02:02:49', NULL, NULL, 1, 0);
INSERT INTO `aulas_jornadas` VALUES (60, 135, 46, '2020-03-23 15:01:54', '2020-05-17 09:25:59', NULL, 1, 0);
INSERT INTO `aulas_jornadas` VALUES (61, 136, 54, '2020-04-05 20:06:54', NULL, NULL, 1, 0);
INSERT INTO `aulas_jornadas` VALUES (62, 137, 55, '2020-04-10 23:56:07', NULL, NULL, 1, 0);
INSERT INTO `aulas_jornadas` VALUES (63, 138, 56, '2020-04-24 19:52:22', NULL, NULL, 1, 0);
...
INSERT INTO `ctlg_materias` VALUES (7, 'Inglés', '2019-11-03 00:43:36', '2020-02-14 19:42:23', NULL, 1);
...
CREATE TABLE `cursos`  (
  ...
  `updated_at` timestamp(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `id_ctlg_cursos_2`(`id_ctlg_cursos`, `id_anos_lectivos`) USING BTREE,
  INDEX `id_organizaciones`(`id_organizaciones`) USING BTREE,
  INDEX `id_ctlg_estados`(`id_ctlg_estados`) USING BTREE,
...
-- Records of cursos
-- ----------------------------
INSERT INTO `cursos` VALUES (48, 1, 1, 1, 1, '2020-03-24 01:19:43', NULL, '2020-05-17 09:25:59');
INSERT INTO `cursos` VALUES (49, 3, 1, 1, 1, '2020-03-24 01:19:43', NULL, '2020-05-16 15:15:23');
INSERT INTO `cursos` VALUES (50, 4, 1, 1, 1, '2020-03-24 01:19:43', NULL, '2020-05-16 15:15:23');
INSERT INTO `cursos` VALUES (51, 2, 1, 98, 1, '2020-04-10 23:56:45', NULL, NULL);
INSERT INTO `cursos` VALUES (52, 2, 1, 99, 1, '2020-04-24 19:49:13', NULL, NULL);
...
-- ----------------------------
INSERT INTO `cursos_jornadas` VALUES (23, 48, 135, '2020-03-25 17:17:33', NULL, NULL, 1);
INSERT INTO `cursos_jornadas` VALUES (25, 50, 136, '2020-03-27 22:46:07', NULL, NULL, 1);
INSERT INTO `cursos_jornadas` VALUES (26, 48, 136, '2020-04-05 20:07:15', NULL, NULL, 1);
INSERT INTO `cursos_jornadas` VALUES (27, 51, 137, '2020-04-10 23:57:28', NULL, NULL, 1);
INSERT INTO `cursos_jornadas` VALUES (28, 52, 138, '2020-04-24 19:52:41', NULL, NULL, 1);
...
CREATE TABLE `cursos_materias`  (
  ...
  `deleted_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `id_cursos_2`(`id_cursos`, `id_materias`) USING BTREE,
  INDEX `id_cursos`(`id_cursos`) USING BTREE,
...
-- ----------------------------
INSERT INTO `cursos_materias` VALUES (49, 48, 27, 1, '2020-03-24 01:57:18', '2020-05-17 09:25:59', NULL);
INSERT INTO `cursos_materias` VALUES (50, 48, 28, 1, '2020-03-24 01:57:18', '2020-05-17 09:25:59', NULL);
INSERT INTO `cursos_materias` VALUES (51, 48, 29, 1, '2020-03-24 01:57:18', '2020-05-17 09:25:59', NULL);
INSERT INTO `cursos_materias` VALUES (52, 48, 32, 1, '2020-03-24 01:57:18', '2020-05-17 09:25:59', NULL);
INSERT INTO `cursos_materias` VALUES (53, 49, 27, 1, '2020-03-24 01:57:18', NULL, NULL);
INSERT INTO `cursos_materias` VALUES (54, 49, 28, 1, '2020-03-24 01:57:18', NULL, NULL);
INSERT INTO `cursos_materias` VALUES (55, 49, 29, 1, '2020-03-24 01:57:18', NULL, NULL);
INSERT INTO `cursos_materias` VALUES (56, 49, 30, 1, '2020-03-24 01:57:18', NULL, NULL);
INSERT INTO `cursos_materias` VALUES (57, 50, 31, 1, '2020-03-24 15:40:58', NULL, NULL);
INSERT INTO `cursos_materias` VALUES (58, 50, 32, 1, '2020-03-24 15:42:13', NULL, NULL);
INSERT INTO `cursos_materias` VALUES (59, 51, 33, 1, '2020-04-10 23:57:01', NULL, NULL);
INSERT INTO `cursos_materias` VALUES (60, 51, 34, 1, '2020-04-10 23:57:01', NULL, NULL);
INSERT INTO `cursos_materias` VALUES (61, 52, 35, 1, '2020-04-24 19:50:45', NULL, NULL);
INSERT INTO `cursos_materias` VALUES (62, 52, 36, 1, '2020-04-24 19:50:45', NULL, NULL);
INSERT INTO `cursos_materias` VALUES (63, 52, 37, 1, '2020-04-24 19:50:45', NULL, NULL);
...
CREATE TABLE `cursos_paralelos_aulas`  (
  ...
  `id_ctlg_estados` int(11) NULL DEFAULT 1,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `id_cursos_2`(`id_cursos`, `id_paralelos`) USING BTREE,
  UNIQUE INDEX `id_paralelos_2`(`id_aulas`, `id_paralelos`) USING BTREE,
  UNIQUE INDEX `id_cursos_3`(`id_cursos`, `id_aulas`) USING BTREE,
  INDEX `id_cursos`(`id_cursos`) USING BTREE,
  INDEX `id_aulas`(`id_aulas`) USING BTREE,
...
-- ----------------------------
INSERT INTO `cursos_paralelos_aulas` VALUES (31, 48, 46, 22, '2020-03-25 17:17:33', '2020-05-17 09:25:59', NULL, 1);
INSERT INTO `cursos_paralelos_aulas` VALUES (38, 48, 41, 23, '2020-03-25 17:44:25', '2020-03-25 18:03:34', NULL, 1);
INSERT INTO `cursos_paralelos_aulas` VALUES (40, 50, 46, 26, '2020-03-27 22:46:07', NULL, NULL, 1);
INSERT INTO `cursos_paralelos_aulas` VALUES (45, 48, 54, 27, '2020-04-05 20:07:15', NULL, NULL, 1);
INSERT INTO `cursos_paralelos_aulas` VALUES (46, 51, 55, 28, '2020-04-10 23:57:28', NULL, NULL, 1);
INSERT INTO `cursos_paralelos_aulas` VALUES (47, 52, 56, 29, '2020-04-24 19:52:41', NULL, NULL, 1);
...
CREATE TABLE `docentes`  (
  ...
  CONSTRAINT `docentes_ibfk_9` FOREIGN KEY (`id_usuarios`) REFERENCES `usuarios` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of docentes
-- ----------------------------
INSERT INTO `docentes` VALUES (21, 'DANIELES', 'FRANCO', 1, '0930456371', 3, 1, 'daniel@gmail.com', 'samanes 7', ' 221 - 5869', 1, 1, '2020-03-25 18:38:35', '2020-05-07 01:21:05', NULL, 16);
INSERT INTO `docentes` VALUES (22, 'fer', 'fer', 2, '2215869', 6, 2, 'fer@gmail.com', 'samanes6', ' 589 - 6933', 1, 1, '2020-03-25 18:43:33', '2020-03-26 18:04:47', NULL, 17);
...
CREATE TABLE `docentes_asignar_curso`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_docentes_jornadas_materias` int(11) NOT NULL,
  `id_cursos_paralelos_aulas` int(11) NOT NULL,
  `id_ctlg_estados` int(11) NULL DEFAULT 1,
  `created_at` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0),
  `deleted_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `id_docentes_jornadas_materias_2`(`id_docentes_jornadas_materias`, `id_cursos_paralelos_aulas`) USING BTREE,
...
-- ----------------------------
INSERT INTO `docentes_asignar_curso` VALUES (19, 71, 38, 1, '2020-03-27 22:42:42', '2020-03-28 00:09:01', NULL);
INSERT INTO `docentes_asignar_curso` VALUES (20, 70, 40, 1, '2020-03-27 22:53:04', NULL, NULL);
INSERT INTO `docentes_asignar_curso` VALUES (21, 57, 31, 1, '2020-03-27 23:10:54', '2020-05-17 09:25:59', NULL);
INSERT INTO `docentes_asignar_curso` VALUES (22, 57, 38, 1, '2020-03-27 23:10:54', NULL, NULL);
INSERT INTO `docentes_asignar_curso` VALUES (23, 72, 46, 1, '2020-04-10 23:58:38', NULL, NULL);
INSERT INTO `docentes_asignar_curso` VALUES (24, 41, 31, 1, '2020-04-24 18:25:11', '2020-05-17 09:25:59', NULL);
...
CREATE TABLE `docentes_jornadas_materias`  (
  ...
  `deleted_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `id_docentes_2`(`id_docentes`, `id_jornadas`, `id_materias`, `id_anos_lectivos`) USING BTREE,
...
-- ----------------------------
INSERT INTO `docentes_jornadas_materias` VALUES (40, 21, 136, 30, 1, 1, '2020-03-26 18:39:43', '2020-03-27 01:58:41', NULL);
INSERT INTO `docentes_jornadas_materias` VALUES (41, 21, 135, 28, 1, 1, '2020-03-26 18:39:43', '2020-05-17 09:25:59', NULL);
INSERT INTO `docentes_jornadas_materias` VALUES (57, 21, 135, 32, 1, 1, '2020-03-26 23:06:18', '2020-05-17 09:25:59', NULL);
INSERT INTO `docentes_jornadas_materias` VALUES (58, 22, 136, 27, 1, 1, '2020-03-26 23:06:37', NULL, NULL);
INSERT INTO `docentes_jornadas_materias` VALUES (69, 22, 136, 32, 1, 1, '2020-03-27 22:52:29', NULL, NULL);
INSERT INTO `docentes_jornadas_materias` VALUES (70, 22, 136, 31, 1, 1, '2020-03-27 22:52:29', NULL, NULL);
INSERT INTO `docentes_jornadas_materias` VALUES (71, 22, 135, 28, 1, 1, '2020-03-27 23:03:49', '2020-05-17 09:25:59', NULL);
INSERT INTO `docentes_jornadas_materias` VALUES (72, 21, 137, 33, 98, 1, '2020-04-10 23:57:57', NULL, NULL);
...
-- Records of dre
-- ----------------------------
INSERT INTO `dre` VALUES (1, 138, 'tuytitiyiti', '2020-04-11 18:23:17', '2020-05-16 15:22:00', NULL, 2, 21);
INSERT INTO `dre` VALUES (2, 138, 'rrrrrrrrrrr', '2020-04-11 18:43:57', NULL, NULL, 1, 21);
INSERT INTO `dre` VALUES (3, 139, 'realizar una plana repitiendo su nombre completo', '2020-04-11 19:26:07', NULL, NULL, 1, 23);
INSERT INTO `dre` VALUES (4, 137, 'Lección 1', '2020-04-18 01:50:35', NULL, NULL, 1, 21);
INSERT INTO `dre` VALUES (5, 154, 'ffdsdd', '2020-04-18 01:51:02', NULL, NULL, 1, 21);
INSERT INTO `dre` VALUES (6, 156, 'htyrt', '2020-04-18 01:51:23', NULL, NULL, 1, 21);
INSERT INTO `dre` VALUES (7, 157, 'eddee', '2020-04-18 01:51:42', NULL, NULL, 1, 21);
INSERT INTO `dre` VALUES (8, 158, 'lecc', '2020-04-18 01:52:05', NULL, NULL, 1, 21);
INSERT INTO `dre` VALUES (9, 148, 'hfdhfh', '2020-04-18 01:52:46', NULL, NULL, 1, 21);
INSERT INTO `dre` VALUES (10, 145, 'liuouioiuo', '2020-04-18 01:53:07', NULL, NULL, 1, 21);
INSERT INTO `dre` VALUES (11, 152, 'fgjhjty', '2020-04-18 01:53:24', NULL, NULL, 1, 21);
INSERT INTO `dre` VALUES (12, 137, 'MESA', '2020-04-21 16:47:31', '2020-04-21 16:48:20', NULL, 1, 21);
INSERT INTO `dre` VALUES (13, 148, 'DFHYTRUHT', '2020-04-24 14:12:27', NULL, NULL, 1, 21);
INSERT INTO `dre` VALUES (14, 149, 'REE', '2020-04-24 14:12:51', NULL, NULL, 1, 21);
INSERT INTO `dre` VALUES (15, 160, 'EXAMEN', '2020-04-24 16:06:25', '2020-04-24 16:06:50', NULL, 1, 21);
INSERT INTO `dre` VALUES (16, 139, 'TARES25', '2020-04-24 19:59:59', NULL, NULL, 1, 23);
INSERT INTO `dre` VALUES (17, 136, 'TREDD', '2020-04-24 20:01:33', NULL, NULL, 1, 21);
INSERT INTO `dre` VALUES (18, 153, 'YASABE', '2020-05-08 22:13:53', NULL, NULL, 1, 19);
INSERT INTO `dre` VALUES (19, 152, 'DIME QUE SI', '2020-05-08 22:41:56', '2020-05-08 22:49:51', NULL, 1, 21);
INSERT INTO `dre` VALUES (20, 158, 'QUE PASO', '2020-05-08 22:51:56', '2020-05-08 22:52:20', NULL, 1, 21);
...
-- ----------------------------
INSERT INTO `edificios` VALUES (18, 'tres', 'samanes 5', 1, '2020-03-23 00:11:57', '2020-03-23 01:13:43', NULL, 1);
INSERT INTO `edificios` VALUES (19, 'martha', 'samanes 5', 1, '2020-03-23 00:14:18', '2020-05-17 08:49:29', NULL, 1);
INSERT INTO `edificios` VALUES (20, 'dd', 'rrr', 1, '2020-03-23 00:33:43', NULL, NULL, 1);
INSERT INTO `edificios` VALUES (21, 'ferna', 'deo', 1, '2020-03-23 00:38:47', NULL, NULL, 1);
INSERT INTO `edificios` VALUES (22, 'reo', 'de', 1, '2020-03-23 00:39:47', NULL, NULL, 1);
INSERT INTO `edificios` VALUES (23, 'mesa', 'feo', 1, '2020-03-23 00:57:05', NULL, NULL, 1);
INSERT INTO `edificios` VALUES (24, 'tres zona norte', 'samanes 5', 1, '2020-03-23 01:14:50', NULL, NULL, 1);
INSERT INTO `edificios` VALUES (25, 'tres patines', 'venezuela', 1, '2020-03-23 01:30:58', NULL, NULL, 1);
INSERT INTO `edificios` VALUES (26, 'GFG', 'hhgh', 1, '2020-04-24 19:45:16', NULL, NULL, 1);
INSERT INTO `edificios` VALUES (27, 'TYTR', 'tryty', 1, '2020-04-24 19:51:55', NULL, NULL, 1);
...
CREATE TABLE `edificios_anos_lectivos`  (
  ...
  `id_ctlg_estados` int(11) NOT NULL DEFAULT 1,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `id_edificios_2`(`id_edificios`, `id_anos_lectivos`) USING BTREE,
  INDEX `id_edificios`(`id_edificios`) USING BTREE,
  INDEX `id_ctlg_estados`(`id_ctlg_estados`) USING BTREE,
  INDEX `id_anos_lectivos`(`id_anos_lectivos`) USING BTREE,
...
-- ----------------------------
INSERT INTO `edificios_anos_lectivos` VALUES (42, 18, 1, '2020-03-23 01:13:07', NULL, NULL, 1);
INSERT INTO `edificios_anos_lectivos` VALUES (43, 19, 1, '2020-03-23 01:13:08', '2020-05-17 09:25:59', NULL, 1);
INSERT INTO `edificios_anos_lectivos` VALUES (46, 25, 1, '2020-03-23 01:31:48', NULL, NULL, 1);
INSERT INTO `edificios_anos_lectivos` VALUES (47, 20, 98, '2020-04-10 23:55:34', NULL, NULL, 1);
INSERT INTO `edificios_anos_lectivos` VALUES (48, 27, 99, '2020-04-24 19:52:02', NULL, NULL, 1);
...
CREATE TABLE `estudiantes`  (
  ...
  `celular` varchar(13) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  CONSTRAINT `estudiantes_ibfk_4` FOREIGN KEY (`id_usuarios`) REFERENCES `usuarios` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of estudiantes
-- ----------------------------
INSERT INTO `estudiantes` VALUES (22, 'martha juliana', 'angulo canga', 1, '0930456405', 'martha@gmail.com', 'samanes 8', ' 222 - 2222', ' 09-99999999', 9, 521, 74, 'asmática', '1991-08-16', 3, 2, 7, 50, 1, '2020-03-28 00:15:12', '2020-05-07 01:05:22', NULL, 18);
INSERT INTO `estudiantes` VALUES (23, 'pepe moisés', 'antepara cerezo', 1, '0931363451', 'jeremias@gmail.com', 'samanes 9', ' 252 - 5555', ' 55-55555555', 9, 548, 79, '', '2002-03-07', 1, 1, 7, 50, 1, '2020-03-28 00:52:34', '2020-03-28 00:53:06', NULL, NULL);
INSERT INTO `estudiantes` VALUES (24, 'isaac', 'deo', 2, '2345', 'isaac@gmail.com', 'wttre', ' 353 - 4535', ' 54-34534534', 6, 311, 47, '', '2009-10-15', 2, 1, 5, 8, 1, '2020-04-05 18:17:13', '2020-05-08 22:01:46', NULL, 20);
...
CREATE TABLE `estudiantes_familiares`  (
  ...
  `deleted_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `id_estudiantes_2`(`id_estudiantes`, `id_familiares`) USING BTREE,
...
-- ----------------------------
INSERT INTO `estudiantes_familiares` VALUES (15, 23, 115, '2020-04-05 01:10:30', NULL, NULL);
INSERT INTO `estudiantes_familiares` VALUES (16, 22, 115, '2020-04-05 01:10:30', NULL, NULL);
INSERT INTO `estudiantes_familiares` VALUES (17, 22, 116, '2020-04-05 01:26:48', '2020-05-08 19:29:36', '2020-05-08 19:29:36');
INSERT INTO `estudiantes_familiares` VALUES (18, 23, 114, '2020-05-08 18:49:19', '2020-05-08 19:29:35', '2020-05-08 19:29:35');
INSERT INTO `estudiantes_familiares` VALUES (19, 23, 113, '2020-05-08 18:58:11', '2020-05-08 19:29:34', '2020-05-08 19:29:34');
...
-- ----------------------------
INSERT INTO `familiares` VALUES (97, 'tgreyerte', 'fdgreyre', 2, '456', 3, 'gfdhgfd@gmail.com', 5, 'hhtytrytr', ' 564 - 6456', ' 36-65477575', 2, 'dgdgfgs', 'gsdgdgsdg', 2, ' 453 - 4643', 'dfhfdhgfhgfh', '2020-04-05 00:25:15', NULL, NULL, NULL, 1);
INSERT INTO `familiares` VALUES (99, 'tgreyerte', 'fdgreyre', 2, '354457', 3, 'gfdhgfd@gmail.com', 5, 'hhtytrytr', ' 564 - 6456', ' 36-65477575', 2, 'dgdgfgs', 'gsdgdgsdg', 2, ' 453 - 4643', 'dfhfdhgfhgfh', '2020-04-05 00:32:49', NULL, NULL, NULL, 1);
INSERT INTO `familiares` VALUES (100, 'tgreyerte', 'fdgreyre', 2, '435466', 3, 'gfdhgfd@gmail.com', 5, 'hhtytrytr', ' 564 - 6456', ' 36-65477575', 2, 'dgdgfgs', 'gsdgdgsdg', 2, ' 453 - 4643', 'dfhfdhgfhgfh', '2020-04-05 00:33:27', NULL, NULL, NULL, 1);
INSERT INTO `familiares` VALUES (102, 'tgreyerte', 'fdgreyre', 2, '666', 3, 'gfdhgfd@gmail.com', 5, 'hhtytrytr', ' 564 - 6456', ' 36-65477575', 2, 'dgdgfgs', 'gsdgdgsdg', 2, ' 453 - 4643', 'dfhfdhgfhgfh', '2020-04-05 00:35:27', NULL, NULL, NULL, 1);
INSERT INTO `familiares` VALUES (105, 'sreurtti', 'ttkoo', 2, '6344', 6, 'edeeeede@gmail.com', 3, 'ffdgdfsd', ' 354 - 7572', ' 23-3467577', 1, 'fffvfvfr', 'wsbxgb', 122, ' 678 - 6586', 'dfhyfdh2222', '2020-04-05 00:37:38', NULL, NULL, NULL, 1);
INSERT INTO `familiares` VALUES (106, 'edededede', 'ededededdedd', 2, '12345', 6, '1swswwsw', 5, 'sdfcrfc', ' 123 - 3445', ' 12-3445543', 2, 'dedeeeede', 'ededededede', 18, ' 112 - 3344', ' vv vvfvfvvfvfvf', '2020-04-05 00:40:58', NULL, NULL, NULL, 1);
INSERT INTO `familiares` VALUES (108, 'edededede', 'ededededdedd', 2, '888', 6, '1swswwsw', 5, 'sdfcrfc', ' 123 - 3445', ' 12-3445543', 2, 'dedeeeede', 'ededededede', 18, ' 112 - 3344', ' vv vvfvfvvfvfvf', '2020-04-05 00:41:53', NULL, NULL, NULL, 1);
INSERT INTO `familiares` VALUES (110, 'edededede', 'ededededdedd', 2, '7668', 6, '1swswwsw', 5, 'sdfcrfc', ' 123 - 3445', ' 12-3445543', 2, 'dedeeeede', 'ededededede', 18, ' 112 - 3344', ' vv vvfvfvvfvfvf', '2020-04-05 00:42:29', NULL, NULL, NULL, 1);
INSERT INTO `familiares` VALUES (111, 'reytry', 'reyty', 2, '464657', 6, 'etetetet', 5, 'reyreyre', ' 463 - 6757', ' 53-53464366', 5, 'hfdhdfyhdd', 'sgtetetrete', 8, ' 353 - 2653', 'fdsgffd', '2020-04-05 01:04:21', NULL, NULL, NULL, 1);
INSERT INTO `familiares` VALUES (113, 'reytry', 'reyty', 2, '4655', 6, 'etetetet', 5, 'reyreyre', ' 463 - 6757', ' 53-53464366', 5, 'hfdhdfyhdd', 'sgtetetrete', 8, ' 353 - 2653', 'fdsgffd', '2020-04-05 01:05:48', NULL, NULL, NULL, 1);
INSERT INTO `familiares` VALUES (114, 'ghgjtr', 'rgtrrt', 2, '544535', 1, 'gfhfghgfhf', 5, 'fhfhfgh', ' 342 - 6443', ' 43-52532552', 4, 'gfhff', 'htyrtrt', 8, ' 345 - 3333', 'gjuyytr', '2020-04-05 01:07:04', NULL, NULL, NULL, 1);
INSERT INTO `familiares` VALUES (115, 'UU', 'YTURYUYTU', 2, '56765', 1, 'yuyuyuty', 3, 'gfggfjghjgj', ' 454 - 3543', ' 43-54354354', 3, 'hdhfhfgh', 'dhhhfhgh', 136, ' 544 - 6546', 'dfhfhdf', '2020-04-05 01:10:01', NULL, '2020-05-24 02:51:26', NULL, 1);
INSERT INTO `familiares` VALUES (116, 'sgterte', 'tretretre', 2, '6436436', 60, 'dsfdsf', 5, 'fsdfsds', ' 345 - 3453', ' 45-43543543', 1, 'sdgtdsgtdgtds', 'dsgtsgtrt', 8, ' 436 - 4647', 'dgfdgfd', '2020-04-05 01:23:43', NULL, NULL, NULL, 1);
INSERT INTO `familiares` VALUES (117, 'fghtfg', 'tyututyu', 2, '57546756', 7, 'ghtyyiyti', 3, 'yutyutyu', ' 657 - 5676', ' 46-55756756', 2, 'tytutyu', 'uy5tutu', 8, ' 574 - 5757', 'fxhfdhf', '2020-04-05 01:25:20', '2020-05-08 11:35:22', '2020-05-08 11:35:22', NULL, 1);
...
CREATE TABLE `inscripciones`  (
  ...
  `id_jornadas` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `id_estudiantes_2`(`id_estudiantes`, `id_cursos`, `id_anos_lectivos`, `id_jornadas`) USING BTREE,
  UNIQUE INDEX `id_estudiantes_3`(`id_estudiantes`, `id_anos_lectivos`) USING BTREE,
  UNIQUE INDEX `id_estudiantes_4`(`id_estudiantes`, `id_jornadas`) USING BTREE,
  INDEX `id_estudiantes`(`id_estudiantes`) USING BTREE,
  INDEX `id_ctlg_estados`(`id_ctlg_estados`) USING BTREE,
  INDEX `id_anos_lectivos`(`id_anos_lectivos`) USING BTREE,
  INDEX `id_cursos`(`id_cursos`) USING BTREE,
...
-- ----------------------------
INSERT INTO `inscripciones` VALUES (10, 22, 51, 98, '2020-04-10 23:59:04', NULL, NULL, 1, 1, 137);
INSERT INTO `inscripciones` VALUES (11, 22, 48, 1, '2020-04-11 18:41:51', '2020-05-17 09:25:59', NULL, 1, 1, 135);
INSERT INTO `inscripciones` VALUES (12, 23, 48, 1, '2020-04-11 18:42:03', '2020-05-17 09:25:59', NULL, 1, 1, 135);
INSERT INTO `inscripciones` VALUES (13, 24, 48, 1, '2020-04-23 23:21:44', '2020-05-17 09:25:59', NULL, 1, 1, 135);
INSERT INTO `inscripciones` VALUES (14, 22, 52, 99, '2020-04-24 19:58:36', NULL, NULL, 1, 1, 138);
...
CREATE TABLE `insumos`  (
  ...
  `updated_at` timestamp(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `id_parciales_2`(`id_parciales`, `id_ctlg_insumos`) USING BTREE,
  INDEX `id_ctlg_estados`(`id_ctlg_estados`) USING BTREE,
...
-- Records of insumos
-- ----------------------------
INSERT INTO `insumos` VALUES (136, 94, 5, 1, '2020-03-22 21:33:48', NULL, '2020-05-17 09:25:59');
INSERT INTO `insumos` VALUES (137, 94, 2, 1, '2020-03-22 21:33:48', NULL, '2020-05-17 09:25:59');
INSERT INTO `insumos` VALUES (138, 94, 3, 1, '2020-03-22 21:33:48', NULL, '2020-05-17 09:25:59');
INSERT INTO `insumos` VALUES (139, 102, 1, 1, '2020-04-10 23:55:00', NULL, NULL);
INSERT INTO `insumos` VALUES (140, 102, 2, 1, '2020-04-10 23:55:00', NULL, NULL);
INSERT INTO `insumos` VALUES (145, 99, 5, 1, '2020-04-18 01:39:22', NULL, '2020-05-17 09:25:59');
INSERT INTO `insumos` VALUES (146, 99, 2, 1, '2020-04-18 01:39:22', NULL, '2020-05-17 09:25:59');
INSERT INTO `insumos` VALUES (147, 99, 3, 1, '2020-04-18 01:39:22', NULL, '2020-05-17 09:25:59');
INSERT INTO `insumos` VALUES (148, 98, 5, 1, '2020-04-18 01:39:22', NULL, '2020-05-17 09:25:59');
INSERT INTO `insumos` VALUES (149, 98, 2, 1, '2020-04-18 01:39:22', NULL, '2020-05-17 09:25:59');
INSERT INTO `insumos` VALUES (150, 98, 3, 1, '2020-04-18 01:39:22', NULL, '2020-05-17 09:25:59');
INSERT INTO `insumos` VALUES (151, 100, 5, 1, '2020-04-18 01:39:22', NULL, '2020-05-17 09:25:59');
INSERT INTO `insumos` VALUES (152, 100, 2, 1, '2020-04-18 01:39:22', NULL, '2020-05-17 09:25:59');
INSERT INTO `insumos` VALUES (153, 100, 3, 1, '2020-04-18 01:39:22', NULL, '2020-05-17 09:25:59');
INSERT INTO `insumos` VALUES (154, 95, 5, 1, '2020-04-18 01:39:54', NULL, '2020-05-17 09:25:59');
INSERT INTO `insumos` VALUES (155, 95, 2, 1, '2020-04-18 01:39:54', NULL, '2020-05-17 09:25:59');
INSERT INTO `insumos` VALUES (156, 95, 3, 1, '2020-04-18 01:39:54', NULL, '2020-05-17 09:25:59');
INSERT INTO `insumos` VALUES (157, 96, 5, 1, '2020-04-18 01:39:54', NULL, '2020-05-17 09:25:59');
INSERT INTO `insumos` VALUES (158, 96, 2, 1, '2020-04-18 01:39:54', NULL, '2020-05-17 09:25:59');
INSERT INTO `insumos` VALUES (159, 96, 3, 1, '2020-04-18 01:39:54', NULL, '2020-05-17 09:25:59');
INSERT INTO `insumos` VALUES (160, 97, 6, 1, '2020-04-24 16:05:35', NULL, '2020-05-17 09:25:59');
INSERT INTO `insumos` VALUES (161, 103, 1, 1, '2020-04-24 19:44:46', NULL, NULL);
INSERT INTO `insumos` VALUES (162, 103, 2, 1, '2020-04-24 19:44:46', NULL, NULL);
INSERT INTO `insumos` VALUES (163, 103, 3, 1, '2020-04-24 19:44:46', NULL, NULL);
INSERT INTO `insumos` VALUES (164, 103, 4, 1, '2020-04-24 19:44:46', NULL, NULL);
INSERT INTO `insumos` VALUES (165, 103, 5, 1, '2020-04-24 19:44:46', NULL, NULL);
INSERT INTO `insumos` VALUES (166, 104, 1, 1, '2020-04-24 19:44:46', NULL, NULL);
INSERT INTO `insumos` VALUES (167, 104, 2, 1, '2020-04-24 19:44:46', NULL, NULL);
INSERT INTO `insumos` VALUES (168, 104, 3, 1, '2020-04-24 19:44:46', NULL, NULL);
INSERT INTO `insumos` VALUES (169, 104, 4, 1, '2020-04-24 19:44:46', NULL, NULL);
INSERT INTO `insumos` VALUES (170, 104, 5, 1, '2020-04-24 19:44:46', NULL, NULL);
INSERT INTO `insumos` VALUES (171, 105, 1, 1, '2020-04-24 19:44:46', NULL, NULL);
INSERT INTO `insumos` VALUES (172, 105, 2, 1, '2020-04-24 19:44:46', NULL, NULL);
INSERT INTO `insumos` VALUES (173, 105, 3, 1, '2020-04-24 19:44:46', NULL, NULL);
INSERT INTO `insumos` VALUES (174, 105, 4, 1, '2020-04-24 19:44:46', NULL, NULL);
INSERT INTO `insumos` VALUES (175, 105, 5, 1, '2020-04-24 19:44:46', NULL, NULL);
...
CREATE TABLE `jornadas`  (
  ...
  `deleted_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `id_ctlg_jornadas_2`(`id_ctlg_jornadas`, `id_anos_lectivos`) USING BTREE,
...
-- Records of jornadas
-- ----------------------------
INSERT INTO `jornadas` VALUES (135, 1, 1, 1, 1, '2020-03-22 17:15:24', '2020-05-17 09:25:59', NULL);
INSERT INTO `jornadas` VALUES (136, 2, 1, 1, 1, '2020-03-23 01:58:32', NULL, NULL);
INSERT INTO `jornadas` VALUES (137, 1, 98, 1, 1, '2020-04-10 23:53:44', NULL, NULL);
INSERT INTO `jornadas` VALUES (138, 1, 99, 1, 1, '2020-04-24 19:43:34', NULL, NULL);
INSERT INTO `jornadas` VALUES (139, 2, 99, 1, 1, '2020-04-24 19:43:34', NULL, NULL);
INSERT INTO `jornadas` VALUES (140, 3, 99, 1, 1, '2020-04-24 19:43:34', NULL, NULL);
...
CREATE TABLE `materias`  (
  ...
  `deleted_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `id_ctlg_materias`(`id_ctlg_materias`, `id_anos_lectivos`) USING BTREE,
...
-- Records of materias
-- ----------------------------
INSERT INTO `materias` VALUES (27, 7, 1, 1, 1, '2020-03-22 22:21:32', '2020-05-17 09:25:59', NULL);
INSERT INTO `materias` VALUES (28, 8, 1, 1, 1, '2020-03-22 22:21:32', '2020-05-17 09:25:59', NULL);
INSERT INTO `materias` VALUES (29, 9, 1, 1, 1, '2020-03-22 22:21:32', '2020-05-17 09:25:59', NULL);
INSERT INTO `materias` VALUES (30, 10, 1, 1, 1, '2020-03-22 22:21:32', '2020-05-17 09:25:59', NULL);
INSERT INTO `materias` VALUES (31, 11, 1, 1, 1, '2020-03-22 22:21:32', '2020-05-17 09:25:59', NULL);
INSERT INTO `materias` VALUES (32, 12, 1, 1, 1, '2020-03-22 22:21:32', '2020-05-17 09:25:59', NULL);
INSERT INTO `materias` VALUES (33, 6, 1, 98, 1, '2020-04-10 23:55:15', NULL, NULL);
INSERT INTO `materias` VALUES (34, 7, 1, 98, 1, '2020-04-10 23:55:15', NULL, NULL);
INSERT INTO `materias` VALUES (35, 7, 1, 99, 1, '2020-04-24 19:45:04', NULL, NULL);
INSERT INTO `materias` VALUES (36, 6, 1, 99, 1, '2020-04-24 19:45:04', NULL, NULL);
INSERT INTO `materias` VALUES (37, 8, 1, 99, 1, '2020-04-24 19:45:04', NULL, NULL);
...
CREATE TABLE `matriculas`  (
  ...
  `id_ctlg_estados` int(11) NULL DEFAULT 1,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `id_inscripciones_2`(`id_inscripciones`, `id_cursos_paralelos_aulas`) USING BTREE,
  UNIQUE INDEX `id_inscripciones_3`(`id_inscripciones`, `id_cursos_paralelos_aulas`) USING BTREE,
  UNIQUE INDEX `id_inscripciones_4`(`id_inscripciones`) USING BTREE,
  INDEX `matriculas_fk_5`(`id_ctlg_estados`) USING BTREE,
  INDEX `id_inscripciones`(`id_inscripciones`) USING BTREE,
  INDEX `id_paralelos`(`id_cursos_paralelos_aulas`) USING BTREE,
  ...
  CONSTRAINT `matriculas_ibfk_3` FOREIGN KEY (`id_cursos_paralelos_aulas`) REFERENCES `cursos_paralelos_aulas` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 24 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of matriculas
-- ----------------------------
INSERT INTO `matriculas` VALUES (20, 11, 31, '2020-04-11 18:42:23', '2020-05-17 09:25:59', NULL, 1);
INSERT INTO `matriculas` VALUES (21, 12, 31, '2020-04-11 18:42:38', '2020-05-17 09:25:59', NULL, 1);
INSERT INTO `matriculas` VALUES (22, 13, 31, '2020-04-23 23:22:19', '2020-05-17 09:25:59', NULL, 1);
INSERT INTO `matriculas` VALUES (23, 14, 47, '2020-04-24 19:58:53', NULL, NULL, 1);
...
CREATE TABLE `nota1`  (
  ...
  `id_ctlg_estados` int(11) NULL DEFAULT 1,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `id_matriculas_2`(`id_matriculas`, `id_actividades_cursos`) USING BTREE,
  INDEX `id_matriculas`(`id_matriculas`) USING BTREE,
...
-- Records of nota1
-- ----------------------------
INSERT INTO `nota1` VALUES (8, 20, 1, 8.01, '2020-04-11 22:30:08', '2020-05-16 15:22:00', NULL, 2);
INSERT INTO `nota1` VALUES (12, 21, 1, 7.01, '2020-04-12 18:08:09', '2020-04-24 17:58:41', NULL, 1);
INSERT INTO `nota1` VALUES (13, 20, 2, 10.00, '2020-04-12 18:12:57', '2020-04-24 17:56:31', NULL, 1);
INSERT INTO `nota1` VALUES (14, 21, 2, 9.00, '2020-04-18 01:54:25', '2020-04-24 17:56:35', NULL, 1);
INSERT INTO `nota1` VALUES (15, 21, 4, 9.99, '2020-04-18 01:54:39', '2020-04-24 17:59:45', NULL, 1);
INSERT INTO `nota1` VALUES (16, 20, 4, 9.00, '2020-04-18 01:54:48', '2020-04-24 17:32:38', NULL, 1);
INSERT INTO `nota1` VALUES (17, 20, 5, 4.00, '2020-04-18 01:55:23', NULL, NULL, 1);
INSERT INTO `nota1` VALUES (18, 21, 5, 9.00, '2020-04-18 01:55:27', NULL, NULL, 1);
INSERT INTO `nota1` VALUES (19, 20, 6, 7.00, '2020-04-18 01:55:36', NULL, NULL, 1);
INSERT INTO `nota1` VALUES (20, 21, 6, 0.00, '2020-04-18 01:55:42', '2020-05-09 01:59:29', NULL, 1);
INSERT INTO `nota1` VALUES (21, 20, 7, 6.00, '2020-04-18 01:55:50', NULL, NULL, 1);
INSERT INTO `nota1` VALUES (22, 21, 7, 8.00, '2020-04-18 01:55:54', NULL, NULL, 1);
INSERT INTO `nota1` VALUES (23, 20, 8, 8.00, '2020-04-18 01:56:11', NULL, NULL, 1);
INSERT INTO `nota1` VALUES (24, 21, 8, 10.00, '2020-04-18 01:56:19', NULL, NULL, 1);
INSERT INTO `nota1` VALUES (25, 20, 9, 10.00, '2020-04-18 01:56:31', NULL, NULL, 1);
INSERT INTO `nota1` VALUES (26, 21, 9, 0.00, '2020-04-18 01:56:36', NULL, NULL, 1);
INSERT INTO `nota1` VALUES (27, 20, 10, 10.00, '2020-04-18 01:56:45', NULL, NULL, 1);
INSERT INTO `nota1` VALUES (28, 21, 10, 10.00, '2020-04-18 01:56:50', NULL, NULL, 1);
INSERT INTO `nota1` VALUES (29, 20, 11, 4.00, '2020-04-18 01:57:09', NULL, NULL, 1);
INSERT INTO `nota1` VALUES (30, 21, 11, 6.00, '2020-04-18 01:57:13', NULL, NULL, 1);
INSERT INTO `nota1` VALUES (31, 20, 12, 7.02, '2020-04-21 16:48:48', '2020-05-06 21:59:07', NULL, 1);
INSERT INTO `nota1` VALUES (32, 21, 12, 0.03, '2020-04-21 16:48:49', '2020-05-06 21:58:15', NULL, 1);
INSERT INTO `nota1` VALUES (33, 22, 1, 0.00, '2020-04-23 23:23:29', '2020-04-25 15:07:26', NULL, 1);
INSERT INTO `nota1` VALUES (34, 20, 13, 10.00, '2020-04-24 14:13:16', NULL, NULL, 1);
INSERT INTO `nota1` VALUES (35, 21, 13, 8.25, '2020-04-24 14:13:24', NULL, NULL, 1);
INSERT INTO `nota1` VALUES (36, 22, 13, 7.00, '2020-04-24 14:13:32', NULL, NULL, 1);
INSERT INTO `nota1` VALUES (37, 22, 5, 10.00, '2020-04-24 14:14:17', NULL, NULL, 1);
INSERT INTO `nota1` VALUES (38, 22, 2, 0.00, '2020-04-24 15:29:15', NULL, NULL, 1);
INSERT INTO `nota1` VALUES (39, 22, 12, 0.01, '2020-04-24 15:30:12', '2020-05-06 21:58:23', NULL, 1);
INSERT INTO `nota1` VALUES (40, 22, 4, 0.02, '2020-04-24 15:30:48', '2020-04-24 17:59:40', NULL, 1);
INSERT INTO `nota1` VALUES (41, 20, 14, 0.00, '2020-04-24 15:32:42', NULL, NULL, 1);
INSERT INTO `nota1` VALUES (42, 21, 14, 0.00, '2020-04-24 15:32:42', NULL, NULL, 1);
INSERT INTO `nota1` VALUES (43, 22, 14, 0.00, '2020-04-24 15:32:43', NULL, NULL, 1);
INSERT INTO `nota1` VALUES (44, 22, 6, 0.00, '2020-04-24 15:41:26', NULL, NULL, 1);
INSERT INTO `nota1` VALUES (45, 22, 15, 9.00, '2020-04-24 16:07:30', NULL, NULL, 1);
INSERT INTO `nota1` VALUES (46, 21, 15, 10.00, '2020-04-24 16:07:34', NULL, NULL, 1);
INSERT INTO `nota1` VALUES (47, 20, 15, 7.00, '2020-04-24 16:07:40', NULL, NULL, 1);
INSERT INTO `nota1` VALUES (48, 20, 17, 5.02, '2020-04-24 20:01:51', '2020-04-24 20:03:02', NULL, 1);
INSERT INTO `nota1` VALUES (49, 21, 17, 0.03, '2020-04-24 20:01:57', NULL, NULL, 1);
INSERT INTO `nota1` VALUES (50, 22, 17, 10.00, '2020-04-24 20:02:05', NULL, NULL, 1);
INSERT INTO `nota1` VALUES (51, 22, 9, 0.04, '2020-05-06 22:01:42', NULL, NULL, 1);
INSERT INTO `nota1` VALUES (52, 20, 20, 0.00, '2020-05-09 01:50:46', NULL, NULL, 1);
INSERT INTO `nota1` VALUES (53, 20, 19, 0.03, '2020-05-09 02:07:22', NULL, NULL, 1);
INSERT INTO `nota1` VALUES (54, 22, 19, 0.00, '2020-05-09 02:07:50', NULL, NULL, 1);
INSERT INTO `nota1` VALUES (55, 21, 19, 10.00, '2020-05-09 02:07:55', NULL, NULL, 1);
...
INSERT INTO `opciones` VALUES (4, 1, 'Jornadas', 2, 'access_alarms', 'jornadas', 1, '2019-10-13 02:11:13', '2020-03-11 16:23:44', NULL, 1);
INSERT INTO `opciones` VALUES (5, 1, 'Edificios', 3, 'location_city', 'edificios', 1, '2019-10-13 04:32:35', '2020-03-11 16:27:28', NULL, 1);
INSERT INTO `opciones` VALUES (6, 1, 'Aulas', 4, 'apartment', 'aulas', 1, '2019-10-13 04:33:21', '2020-03-11 16:27:04', NULL, 1);
INSERT INTO `opciones` VALUES (7, 1, 'Cursos', 6, 'account_balance_wallet', 'cursos', 1, '2019-10-13 05:51:23', '2020-03-11 16:40:37', NULL, 1);
INSERT INTO `opciones` VALUES (8, 1, 'Docentes', 5, 'business_center', 'docentes', 1, '2019-10-14 14:31:46', '2020-03-11 16:29:39', NULL, 1);
INSERT INTO `opciones` VALUES (9, 1, 'Docentes - Jornadas - Materias', 6, 'local_library', 'docentes_jornadas_materias', 1, '2020-03-10 16:52:58', '2020-03-11 16:33:37', NULL, 1);
INSERT INTO `opciones` VALUES (10, 1, 'Asignación de Curso', 7, 'home_work', 'docentes_asignar_cursos', 1, '2020-03-10 16:53:57', '2020-03-11 16:32:26', NULL, 1);
INSERT INTO `opciones` VALUES (11, 1, 'Cursos - Materia', 8, 'style', 'cursos_materias', 1, '2020-03-10 16:54:31', '2020-03-11 16:34:22', NULL, 1);
INSERT INTO `opciones` VALUES (12, 1, 'Cursos - Paralelos - Aulas', 9, 'amp_stories', 'cursos_paralelos_aulas', 1, '2020-03-10 16:55:23', '2020-03-11 16:38:14', NULL, 1);
INSERT INTO `opciones` VALUES (13, 1, 'Estudiantes', 10, 'wc', 'estudiantes', 1, '2020-03-10 16:56:02', '2020-03-11 16:30:13', NULL, 1);
INSERT INTO `opciones` VALUES (14, 1, 'Representante', 11, 'people_alt', 'familiares', 1, '2020-03-10 16:56:31', '2020-03-11 16:26:43', NULL, 1);
INSERT INTO `opciones` VALUES (15, 1, 'Inscripciones', 12, 'edit', 'inscripciones', 1, '2020-03-10 16:57:07', '2020-03-11 16:36:03', NULL, 1);
INSERT INTO `opciones` VALUES (16, 1, 'Matriculaciones', 13, 'layers', 'matriculaciones', 1, '2020-03-10 16:57:34', '2020-03-11 16:34:16', NULL, 1);
INSERT INTO `opciones` VALUES (17, 1, 'Insumos', 14, 'event_note', 'insumos', 1, '2020-03-10 16:58:36', '2020-03-11 16:31:49', NULL, 1);
INSERT INTO `opciones` VALUES (18, 1, 'Parciales', 15, 'table_chart', 'parciales', 1, '2020-03-10 16:58:39', '2020-03-11 16:36:46', NULL, 1);
INSERT INTO `opciones` VALUES (19, 1, 'Periodos', 16, 'insert_invitation', 'periodos', 1, '2020-03-10 16:59:13', '2020-03-11 16:37:47', NULL, 1);
INSERT INTO `opciones` VALUES (20, 1, 'Usuarios', 17, 'perm_contact_calendar', 'usuarios', 1, '2020-03-10 16:59:27', '2020-03-11 16:39:36', NULL, 1);
INSERT INTO `opciones` VALUES (21, 1, 'Actividades del Cursos', 18, 'folder_special', 'actividades_cursos', 1, '2020-03-10 17:00:39', '2020-03-11 16:30:42', NULL, 1);
INSERT INTO `opciones` VALUES (22, 1, 'Notas', 19, 'book', 'notas', 1, '2020-03-10 17:01:12', '2020-03-11 16:41:25', NULL, 1);
INSERT INTO `opciones` VALUES (23, 1, 'Paralelos', 20, 'feed', 'paralelos', 1, '2020-03-10 17:01:38', '2020-03-11 16:42:38', NULL, 1);
INSERT INTO `opciones` VALUES (24, 1, 'Materias', 21, 'emoji_symbols', 'materias', 1, '2020-03-10 17:06:10', '2020-03-11 16:29:08', NULL, 1);
INSERT INTO `opciones` VALUES (25, 1, 'Notas Generales', 22, NULL, 'notas_secretarias', 1, '2020-04-11 22:23:31', NULL, NULL, 1);
INSERT INTO `opciones` VALUES (26, 1, 'Libreta', 23, NULL, 'libretas', 1, '2020-04-12 21:20:45', '2020-04-12 21:20:54', NULL, 1);
INSERT INTO `opciones` VALUES (27, 1, 'Libreta', 24, NULL, 'libretas_doc', 1, '2020-04-24 14:35:16', NULL, NULL, 1);
INSERT INTO `opciones` VALUES (28, 1, 'Reporte', 25, NULL, 'libretas_est', 1, '2020-05-06 22:27:27', '2020-05-06 22:27:49', NULL, 1);
INSERT INTO `opciones` VALUES (29, 1, 'Años Lectivos', 26, NULL, 'anos_lectivos_dir', 1, '2020-05-18 01:06:11', '2020-05-18 01:08:51', NULL, 1);
...
CREATE TABLE `paralelos`  (
  ...
  `id_anos_lectivos` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `nombre`(`nombre`, `id_anos_lectivos`) USING BTREE,
  INDEX `id_ctlg_estados`(`id_ctlg_estados`) USING BTREE,
  INDEX `id_organizaciones`(`id_organizaciones`) USING BTREE,
  INDEX `id_anos_lectivos`(`id_anos_lectivos`) USING BTREE,
...
-- ----------------------------
INSERT INTO `paralelos` VALUES (22, 'rey', 1, 1, '2020-03-23 23:57:44', '2020-05-17 09:25:59', NULL, 1);
INSERT INTO `paralelos` VALUES (23, 'rio', 1, 1, '2020-03-23 23:57:52', NULL, NULL, 1);
INSERT INTO `paralelos` VALUES (26, 'C', 1, 1, '2020-03-27 22:45:22', NULL, NULL, 1);
INSERT INTO `paralelos` VALUES (27, 'd', 1, 1, '2020-04-05 20:04:32', NULL, NULL, 1);
INSERT INTO `paralelos` VALUES (28, 'ttt', 1, 1, '2020-04-10 23:56:24', NULL, NULL, 98);
INSERT INTO `paralelos` VALUES (29, 'E', 1, 1, '2020-04-24 19:47:52', NULL, NULL, 99);
...
CREATE TABLE `paralelos_jornadas`  (
  ...
  `id_ctlg_estados` int(11) NULL DEFAULT 1,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `ano`(`id_jornadas`, `id_paralelos`) USING BTREE,
  INDEX `id_paralelos`(`id_paralelos`) USING BTREE,
  INDEX `id_jornadas`(`id_jornadas`) USING BTREE,
  INDEX `id_ctlg_estados`(`id_ctlg_estados`) USING BTREE,
...
-- ----------------------------
INSERT INTO `paralelos_jornadas` VALUES (47, 22, 135, '2020-03-24 00:23:26', '2020-05-17 09:25:59', NULL, 1);
INSERT INTO `paralelos_jornadas` VALUES (48, 23, 135, '2020-03-24 00:23:26', NULL, NULL, 1);
INSERT INTO `paralelos_jornadas` VALUES (55, 26, 136, '2020-03-27 22:45:36', NULL, NULL, 1);
INSERT INTO `paralelos_jornadas` VALUES (56, 27, 136, '2020-04-05 20:04:46', NULL, NULL, 1);
INSERT INTO `paralelos_jornadas` VALUES (57, 28, 137, '2020-04-10 23:56:33', NULL, NULL, 1);
INSERT INTO `paralelos_jornadas` VALUES (58, 29, 138, '2020-04-24 19:48:08', NULL, NULL, 1);
...
CREATE TABLE `parciales`  (
  ...
  `id_ctlg_estados` int(11) NOT NULL DEFAULT 1,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `id_periodos_2`(`id_periodos`, `id_ctlg_parciales`) USING BTREE,
...
-- ----------------------------
INSERT INTO `parciales` VALUES (94, 59, 1, '2020-03-22 17:36:21', '2020-05-17 09:25:59', NULL, 1);
INSERT INTO `parciales` VALUES (95, 59, 2, '2020-03-22 17:36:21', '2020-05-17 09:25:59', NULL, 1);
INSERT INTO `parciales` VALUES (96, 59, 3, '2020-03-22 17:36:21', '2020-05-17 09:25:59', NULL, 1);
INSERT INTO `parciales` VALUES (97, 59, 4, '2020-03-22 17:36:21', '2020-05-17 09:25:59', NULL, 1);
INSERT INTO `parciales` VALUES (98, 60, 1, '2020-03-22 17:36:21', '2020-05-17 09:25:59', NULL, 1);
INSERT INTO `parciales` VALUES (99, 60, 2, '2020-03-22 17:36:21', '2020-05-17 09:25:59', NULL, 1);
INSERT INTO `parciales` VALUES (100, 60, 3, '2020-03-22 17:36:21', '2020-05-17 09:25:59', NULL, 1);
INSERT INTO `parciales` VALUES (101, 60, 4, '2020-03-22 17:36:21', NULL, NULL, 1);
INSERT INTO `parciales` VALUES (102, 61, 1, '2020-04-10 23:54:34', NULL, NULL, 1);
INSERT INTO `parciales` VALUES (103, 64, 1, '2020-04-24 19:44:25', NULL, NULL, 1);
INSERT INTO `parciales` VALUES (104, 64, 2, '2020-04-24 19:44:26', NULL, NULL, 1);
INSERT INTO `parciales` VALUES (105, 64, 3, '2020-04-24 19:44:26', NULL, NULL, 1);
INSERT INTO `parciales` VALUES (106, 65, 1, '2020-04-24 19:44:26', NULL, NULL, 1);
INSERT INTO `parciales` VALUES (107, 65, 2, '2020-04-24 19:44:26', NULL, NULL, 1);
INSERT INTO `parciales` VALUES (108, 65, 3, '2020-04-24 19:44:26', NULL, NULL, 1);
...
INSERT INTO `perfiles` VALUES (5, 'Estudiantes', 1, '2020-03-11 16:53:40', NULL, NULL);
...
INSERT INTO `perfiles_opciones` VALUES (27, 2, 3, '2020-03-11 17:26:39', '2020-03-11 17:27:30', NULL);
INSERT INTO `perfiles_opciones` VALUES (28, 2, 4, '2020-03-11 17:27:37', '2020-03-11 17:29:30', NULL);
INSERT INTO `perfiles_opciones` VALUES (29, 2, 19, '2020-03-11 17:29:37', NULL, NULL);
INSERT INTO `perfiles_opciones` VALUES (30, 2, 18, '2020-03-11 17:29:41', '2020-03-11 17:29:58', NULL);
INSERT INTO `perfiles_opciones` VALUES (31, 2, 17, '2020-03-11 17:30:05', NULL, NULL);
INSERT INTO `perfiles_opciones` VALUES (32, 2, 24, '2020-03-11 17:30:16', NULL, NULL);
INSERT INTO `perfiles_opciones` VALUES (33, 2, 5, '2020-03-11 17:30:21', NULL, NULL);
INSERT INTO `perfiles_opciones` VALUES (34, 2, 6, '2020-03-11 17:30:26', NULL, NULL);
INSERT INTO `perfiles_opciones` VALUES (35, 2, 23, '2020-03-11 17:30:35', NULL, NULL);
INSERT INTO `perfiles_opciones` VALUES (36, 2, 7, '2020-03-11 17:30:43', NULL, NULL);
INSERT INTO `perfiles_opciones` VALUES (37, 2, 11, '2020-03-11 17:30:51', NULL, NULL);
INSERT INTO `perfiles_opciones` VALUES (38, 2, 12, '2020-03-11 17:30:59', NULL, NULL);
INSERT INTO `perfiles_opciones` VALUES (39, 2, 8, '2020-03-11 17:31:06', NULL, NULL);
INSERT INTO `perfiles_opciones` VALUES (40, 2, 9, '2020-03-11 17:31:12', NULL, NULL);
INSERT INTO `perfiles_opciones` VALUES (41, 2, 10, '2020-03-11 17:31:20', NULL, NULL);
INSERT INTO `perfiles_opciones` VALUES (42, 2, 20, '2020-03-11 17:31:26', NULL, NULL);
INSERT INTO `perfiles_opciones` VALUES (43, 3, 13, '2020-03-11 17:31:37', '2020-03-11 17:32:34', NULL);
INSERT INTO `perfiles_opciones` VALUES (44, 3, 14, '2020-03-11 17:32:41', '2020-03-11 17:32:46', NULL);
INSERT INTO `perfiles_opciones` VALUES (45, 3, 15, '2020-03-11 17:32:54', NULL, NULL);
INSERT INTO `perfiles_opciones` VALUES (46, 3, 16, '2020-03-11 17:33:02', NULL, NULL);
INSERT INTO `perfiles_opciones` VALUES (47, 4, 21, '2020-03-11 17:33:30', NULL, NULL);
INSERT INTO `perfiles_opciones` VALUES (48, 4, 22, '2020-03-11 17:33:37', NULL, NULL);
INSERT INTO `perfiles_opciones` VALUES (49, 1, 25, '2020-04-11 22:24:11', '2020-04-11 22:25:31', NULL);
INSERT INTO `perfiles_opciones` VALUES (50, 1, 26, '2020-04-12 21:21:30', NULL, NULL);
INSERT INTO `perfiles_opciones` VALUES (51, 4, 27, '2020-04-24 14:35:43', NULL, NULL);
INSERT INTO `perfiles_opciones` VALUES (52, 3, 25, '2020-04-24 14:40:18', NULL, NULL);
INSERT INTO `perfiles_opciones` VALUES (53, 3, 26, '2020-04-24 14:40:28', NULL, NULL);
INSERT INTO `perfiles_opciones` VALUES (54, 5, 28, '2020-05-06 22:28:34', NULL, NULL);
INSERT INTO `perfiles_opciones` VALUES (55, 1, 29, '2020-05-18 01:09:26', NULL, NULL);
...
CREATE TABLE `periodos`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `id_anos_lectivos`(`id_anos_lectivos`, `id_ctlg_periodos`) USING BTREE,
...
-- Records of periodos
-- ----------------------------
INSERT INTO `periodos` VALUES (59, 1, 1, '2020-03-22 17:35:54', '2020-05-17 09:25:59', NULL, 1);
INSERT INTO `periodos` VALUES (60, 1, 2, '2020-03-22 17:35:54', '2020-05-17 09:25:59', NULL, 1);
INSERT INTO `periodos` VALUES (61, 98, 2, '2020-04-10 23:53:59', '2020-04-24 17:39:57', NULL, 1);
INSERT INTO `periodos` VALUES (64, 99, 1, '2020-04-24 19:43:57', NULL, NULL, 1);
INSERT INTO `periodos` VALUES (65, 99, 2, '2020-04-24 19:43:57', NULL, NULL, 1);
...
CREATE TABLE `usuarios`  (
  ...
  `id_perfiles` int(11) NULL DEFAULT NULL,
  `correo` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `contrasena` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '123456',
...
-- Records of usuarios
-- ----------------------------
INSERT INTO `usuarios` VALUES (1, 'Oscar', 'Antepara', 1, 'admin@gmail.com', 'sha1$2ca7a0d4$1$21fb8ae198f30bd861ed52bb4222c2d27de3327f', NULL, 1, NULL, NULL, '2020-03-11 17:36:40', 1);
INSERT INTO `usuarios` VALUES (16, 'DANIELES', 'FRANCO', 4, 'daniel@gmail.com', 'sha1$2ca7a0d4$1$21fb8ae198f30bd861ed52bb4222c2d27de3327f', NULL, 1, '2020-03-25 18:38:34', NULL, '2020-05-07 01:21:05', 1);
INSERT INTO `usuarios` VALUES (17, 'fer', 'fer', 4, 'fer@gmail.com', 'sha1$2ca7a0d4$1$21fb8ae198f30bd861ed52bb4222c2d27de3327f', NULL, 1, '2020-03-25 18:43:33', NULL, '2020-03-27 16:32:00', 1);
INSERT INTO `usuarios` VALUES (18, 'martha  juliana', 'angulo canga', 5, 'martha@gmail.com', 'sha1$2ca7a0d4$1$21fb8ae198f30bd861ed52bb4222c2d27de3327f', NULL, 1, '2020-03-28 00:15:12', NULL, '2020-05-07 01:08:12', 1);
INSERT INTO `usuarios` VALUES (19, 'jeremías moisés', 'antepara cerezo', 5, 'jeremias@gmail.com', NULL, NULL, 1, '2020-03-28 00:52:34', NULL, NULL, 1);
INSERT INTO `usuarios` VALUES (20, 'isaac', 'deo', 5, 'isaac@gmail.com', 'sha1$2ca7a0d4$1$21fb8ae198f30bd861ed52bb4222c2d27de3327f', NULL, 1, '2020-04-05 18:17:14', NULL, '2020-05-08 22:55:36', 1);
INSERT INTO `usuarios` VALUES (21, 'Monica', 'Franco', 3, 'monica@gmail.com', 'sha1$2ca7a0d4$1$21fb8ae198f30bd861ed52bb4222c2d27de3327f', NULL, 1, '2020-04-24 14:41:43', NULL, '2020-04-24 14:41:52', 1);
INSERT INTO `usuarios` VALUES (22, 'rio', 'rio', 2, 'rio@gmail.com', 'sha1$2ca7a0d4$1$21fb8ae198f30bd861ed52bb4222c2d27de3327f', NULL, 1, '2020-04-24 14:46:28', NULL, '2020-04-24 14:48:18', 1);

-- ----------------------------
-- View structure for ano_cur_mat_per_par_ins_jor_aul_para
-- ----------------------------
DROP VIEW IF EXISTS `ano_cur_mat_per_par_ins_jor_aul_para`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `ano_cur_mat_per_par_ins_jor_aul_para` AS select `anos_lectivos`.`nombre` AS `ano`,`ctlg_cursos`.`nombre` AS `curso`,`ctlg_materias`.`nombre` AS `materia`,`ctlg_periodos`.`nombre` AS `periodo`,`ctlg_parciales`.`nombre` AS `parcial`,`ctlg_insumos`.`nombre` AS `insumo`,`ctlg_jornadas`.`nombre` AS `jornada`,`aulas`.`nombre` AS `aula`,`paralelos`.`nombre` AS `paralelo`,`cursos_materias`.`id_cursos` AS `id_cursos`,`cursos_materias`.`id_materias` AS `id_materias` from (((((((((((((((((((`anos_lectivos` join `cursos` on((`cursos`.`id_anos_lectivos` = `anos_lectivos`.`id`))) join `materias` on((`materias`.`id_anos_lectivos` = `anos_lectivos`.`id`))) join `ctlg_cursos` on((`cursos`.`id_ctlg_cursos` = `ctlg_cursos`.`id`))) join `ctlg_materias` on((`materias`.`id_ctlg_materias` = `ctlg_materias`.`id`))) join `cursos_materias` on(((`cursos_materias`.`id_cursos` = `cursos`.`id`) and (`cursos_materias`.`id_materias` = `materias`.`id`)))) join `periodos` on((`periodos`.`id_anos_lectivos` = `anos_lectivos`.`id`))) join `ctlg_periodos` on((`periodos`.`id_ctlg_periodos` = `ctlg_periodos`.`id`))) join `parciales` on((`parciales`.`id_periodos` = `periodos`.`id`))) join `ctlg_parciales` on((`parciales`.`id_ctlg_parciales` = `ctlg_parciales`.`id`))) join `insumos` on((`insumos`.`id_parciales` = `parciales`.`id`))) join `ctlg_insumos` on((`insumos`.`id_ctlg_insumos` = `ctlg_insumos`.`id`))) join `jornadas` on((`jornadas`.`id_anos_lectivos` = `anos_lectivos`.`id`))) join `ctlg_jornadas` on((`jornadas`.`id_ctlg_jornadas` = `ctlg_jornadas`.`id`))) join `cursos_jornadas` on(((`cursos_jornadas`.`id_cursos` = `cursos`.`id`) and (`cursos_jornadas`.`id_jornadas` = `jornadas`.`id`)))) join `cursos_paralelos_aulas` on((`cursos_paralelos_aulas`.`id_cursos` = `cursos`.`id`))) join `aulas` on((`cursos_paralelos_aulas`.`id_aulas` = `aulas`.`id`))) join `paralelos` on(((`paralelos`.`id_anos_lectivos` = `anos_lectivos`.`id`) and (`cursos_paralelos_aulas`.`id_paralelos` = `paralelos`.`id`)))) join `aulas_jornadas` on(((`aulas_jornadas`.`id_jornadas` = `jornadas`.`id`) and (`aulas_jornadas`.`id_aulas` = `aulas`.`id`)))) join `paralelos_jornadas` on(((`paralelos_jornadas`.`id_paralelos` = `paralelos`.`id`) and (`paralelos_jornadas`.`id_jornadas` = `jornadas`.`id`)))) ;

-- ----------------------------
-- View structure for cur_est
-- ----------------------------
DROP VIEW IF EXISTS `cur_est`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `cur_est` AS select `anos_lectivos`.`nombre` AS `ano`,`ctlg_cursos`.`nombre` AS `curso`,`ctlg_materias`.`nombre` AS `materia`,`ctlg_periodos`.`nombre` AS `periodo`,`ctlg_parciales`.`nombre` AS `parcial`,`ctlg_insumos`.`nombre` AS `insumo`,`ctlg_jornadas`.`nombre` AS `jornada`,`aulas`.`nombre` AS `aula`,`paralelos`.`nombre` AS `paralelo`,`estudiantes`.`nombres` AS `nombres`,`estudiantes`.`apellidos` AS `apellidos` from ((((((((((((((((((((((`anos_lectivos` join `cursos` on((`cursos`.`id_anos_lectivos` = `anos_lectivos`.`id`))) join `materias` on((`materias`.`id_anos_lectivos` = `anos_lectivos`.`id`))) join `ctlg_cursos` on((`cursos`.`id_ctlg_cursos` = `ctlg_cursos`.`id`))) join `ctlg_materias` on((`materias`.`id_ctlg_materias` = `ctlg_materias`.`id`))) join `cursos_materias` on(((`cursos_materias`.`id_cursos` = `cursos`.`id`) and (`cursos_materias`.`id_materias` = `materias`.`id`)))) join `periodos` on((`periodos`.`id_anos_lectivos` = `anos_lectivos`.`id`))) join `ctlg_periodos` on((`periodos`.`id_ctlg_periodos` = `ctlg_periodos`.`id`))) join `parciales` on((`parciales`.`id_periodos` = `periodos`.`id`))) join `ctlg_parciales` on((`parciales`.`id_ctlg_parciales` = `ctlg_parciales`.`id`))) join `insumos` on((`insumos`.`id_parciales` = `parciales`.`id`))) join `ctlg_insumos` on((`insumos`.`id_ctlg_insumos` = `ctlg_insumos`.`id`))) join `jornadas` on((`jornadas`.`id_anos_lectivos` = `anos_lectivos`.`id`))) join `ctlg_jornadas` on((`jornadas`.`id_ctlg_jornadas` = `ctlg_jornadas`.`id`))) join `cursos_jornadas` on(((`cursos_jornadas`.`id_cursos` = `cursos`.`id`) and (`cursos_jornadas`.`id_jornadas` = `jornadas`.`id`)))) join `cursos_paralelos_aulas` on((`cursos_paralelos_aulas`.`id_cursos` = `cursos`.`id`))) join `aulas` on((`cursos_paralelos_aulas`.`id_aulas` = `aulas`.`id`))) join `paralelos` on(((`paralelos`.`id_anos_lectivos` = `anos_lectivos`.`id`) and (`cursos_paralelos_aulas`.`id_paralelos` = `paralelos`.`id`)))) join `aulas_jornadas` on(((`aulas_jornadas`.`id_jornadas` = `jornadas`.`id`) and (`aulas_jornadas`.`id_aulas` = `aulas`.`id`)))) join `paralelos_jornadas` on(((`paralelos_jornadas`.`id_paralelos` = `paralelos`.`id`) and (`paralelos_jornadas`.`id_jornadas` = `jornadas`.`id`)))) join `inscripciones` on(((`inscripciones`.`id_anos_lectivos` = `anos_lectivos`.`id`) and (`inscripciones`.`id_cursos` = `cursos`.`id`) and (`inscripciones`.`id_jornadas` = `jornadas`.`id`)))) join `estudiantes` on((`inscripciones`.`id_estudiantes` = `estudiantes`.`id`))) join `matriculas` on(((`matriculas`.`id_inscripciones` = `inscripciones`.`id`) and (`matriculas`.`id_cursos_paralelos_aulas` = `cursos_paralelos_aulas`.`id`)))) ;

-- ----------------------------
-- View structure for cur_est_not
-- ----------------------------
DROP VIEW IF EXISTS `cur_est_not`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `cur_est_not` AS select `anos_lectivos`.`nombre` AS `ano`,`ctlg_cursos`.`nombre` AS `curso`,`ctlg_materias`.`nombre` AS `materia`,`ctlg_periodos`.`nombre` AS `periodo`,`ctlg_parciales`.`nombre` AS `parcial`,`ctlg_insumos`.`nombre` AS `insumo`,`ctlg_jornadas`.`nombre` AS `jornada`,`aulas`.`nombre` AS `aula`,`paralelos`.`nombre` AS `paralelo`,concat(`estudiantes`.`nombres`,' ',`estudiantes`.`apellidos`) AS `nombres`,`dre`.`descripcion` AS `descripcion`,`nota1`.`valor` AS `nota` from ((((((((((((((((((((((((((`anos_lectivos` join `cursos` on((`cursos`.`id_anos_lectivos` = `anos_lectivos`.`id`))) join `materias` on((`materias`.`id_anos_lectivos` = `anos_lectivos`.`id`))) join `ctlg_cursos` on((`cursos`.`id_ctlg_cursos` = `ctlg_cursos`.`id`))) join `ctlg_materias` on((`materias`.`id_ctlg_materias` = `ctlg_materias`.`id`))) join `cursos_materias` on(((`cursos_materias`.`id_cursos` = `cursos`.`id`) and (`cursos_materias`.`id_materias` = `materias`.`id`)))) join `periodos` on((`periodos`.`id_anos_lectivos` = `anos_lectivos`.`id`))) join `ctlg_periodos` on((`periodos`.`id_ctlg_periodos` = `ctlg_periodos`.`id`))) join `parciales` on((`parciales`.`id_periodos` = `periodos`.`id`))) join `ctlg_parciales` on((`parciales`.`id_ctlg_parciales` = `ctlg_parciales`.`id`))) join `insumos` on((`insumos`.`id_parciales` = `parciales`.`id`))) join `ctlg_insumos` on((`insumos`.`id_ctlg_insumos` = `ctlg_insumos`.`id`))) join `jornadas` on((`jornadas`.`id_anos_lectivos` = `anos_lectivos`.`id`))) join `ctlg_jornadas` on((`jornadas`.`id_ctlg_jornadas` = `ctlg_jornadas`.`id`))) join `cursos_jornadas` on(((`cursos_jornadas`.`id_cursos` = `cursos`.`id`) and (`cursos_jornadas`.`id_jornadas` = `jornadas`.`id`)))) join `cursos_paralelos_aulas` on((`cursos_paralelos_aulas`.`id_cursos` = `cursos`.`id`))) join `aulas` on((`cursos_paralelos_aulas`.`id_aulas` = `aulas`.`id`))) join `paralelos` on(((`paralelos`.`id_anos_lectivos` = `anos_lectivos`.`id`) and (`cursos_paralelos_aulas`.`id_paralelos` = `paralelos`.`id`)))) join `aulas_jornadas` on(((`aulas_jornadas`.`id_jornadas` = `jornadas`.`id`) and (`aulas_jornadas`.`id_aulas` = `aulas`.`id`)))) join `paralelos_jornadas` on(((`paralelos_jornadas`.`id_paralelos` = `paralelos`.`id`) and (`paralelos_jornadas`.`id_jornadas` = `jornadas`.`id`)))) join `inscripciones` on(((`inscripciones`.`id_anos_lectivos` = `anos_lectivos`.`id`) and (`inscripciones`.`id_cursos` = `cursos`.`id`) and (`inscripciones`.`id_jornadas` = `jornadas`.`id`)))) join `estudiantes` on((`inscripciones`.`id_estudiantes` = `estudiantes`.`id`))) join `matriculas` on(((`matriculas`.`id_inscripciones` = `inscripciones`.`id`) and (`matriculas`.`id_cursos_paralelos_aulas` = `cursos_paralelos_aulas`.`id`)))) join `docentes_jornadas_materias` on(((`docentes_jornadas_materias`.`id_jornadas` = `jornadas`.`id`) and (`docentes_jornadas_materias`.`id_materias` = `materias`.`id`) and (`docentes_jornadas_materias`.`id_anos_lectivos` = `anos_lectivos`.`id`)))) join `docentes_asignar_curso` on(((`docentes_asignar_curso`.`id_docentes_jornadas_materias` = `docentes_jornadas_materias`.`id`) and (`docentes_asignar_curso`.`id_cursos_paralelos_aulas` = `cursos_paralelos_aulas`.`id`)))) join `dre` on(((`dre`.`id_insumos` = `insumos`.`id`) and (`dre`.`id_docentes_asignar_curso` = `docentes_asignar_curso`.`id`) and (`dre`.`id_docentes_asignar_curso` = `docentes_asignar_curso`.`id`)))) join `nota1` on(((`nota1`.`id_matriculas` = `matriculas`.`id`) and (`nota1`.`id_actividades_cursos` = `dre`.`id`)))) ;

-- ----------------------------
-- View structure for cur_est_not_copy1
-- ----------------------------
DROP VIEW IF EXISTS `cur_est_not_copy1`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `cur_est_not_copy1` AS select `anos_lectivos`.`nombre` AS `ano`,`ctlg_cursos`.`nombre` AS `curso`,`ctlg_materias`.`nombre` AS `materia`,`ctlg_periodos`.`nombre` AS `periodo`,`ctlg_parciales`.`nombre` AS `parcial`,`ctlg_jornadas`.`nombre` AS `jornada`,`aulas`.`nombre` AS `aula`,`paralelos`.`nombre` AS `paralelo`,concat(`estudiantes`.`nombres`,' ',`estudiantes`.`apellidos`) AS `nombres`,round(avg((case when (`ctlg_insumos`.`id` = 1) then ifnull(`nota1`.`valor`,0) end)),2) AS `tarea`,round(avg((case when (`ctlg_insumos`.`id` = 2) then ifnull(`nota1`.`valor`,0) end)),2) AS `leccion`,round(avg((case when (`ctlg_insumos`.`id` = 3) then ifnull(`nota1`.`valor`,0) end)),2) AS `act_individual`,round(avg((case when (`ctlg_insumos`.`id` = 4) then ifnull(`nota1`.`valor`,0) end)),2) AS `act_grupal`,round(avg((case when (`ctlg_insumos`.`id` = 5) then ifnull(`nota1`.`valor`,0) end)),2) AS `evaluacion_escrita`,`materias`.`id` AS `mate`,`cursos`.`id` AS `cur`,`estudiantes`.`id` AS `id` from ((((((((((((((((((((((((((`anos_lectivos` join `cursos` on((`cursos`.`id_anos_lectivos` = `anos_lectivos`.`id`))) join `materias` on((`materias`.`id_anos_lectivos` = `anos_lectivos`.`id`))) join `ctlg_cursos` on((`cursos`.`id_ctlg_cursos` = `ctlg_cursos`.`id`))) join `ctlg_materias` on((`materias`.`id_ctlg_materias` = `ctlg_materias`.`id`))) join `cursos_materias` on(((`cursos_materias`.`id_cursos` = `cursos`.`id`) and (`cursos_materias`.`id_materias` = `materias`.`id`)))) join `periodos` on((`periodos`.`id_anos_lectivos` = `anos_lectivos`.`id`))) join `ctlg_periodos` on((`periodos`.`id_ctlg_periodos` = `ctlg_periodos`.`id`))) join `parciales` on((`parciales`.`id_periodos` = `periodos`.`id`))) join `ctlg_parciales` on((`parciales`.`id_ctlg_parciales` = `ctlg_parciales`.`id`))) join `insumos` on((`insumos`.`id_parciales` = `parciales`.`id`))) join `ctlg_insumos` on((`insumos`.`id_ctlg_insumos` = `ctlg_insumos`.`id`))) join `jornadas` on((`jornadas`.`id_anos_lectivos` = `anos_lectivos`.`id`))) join `ctlg_jornadas` on((`jornadas`.`id_ctlg_jornadas` = `ctlg_jornadas`.`id`))) join `cursos_jornadas` on(((`cursos_jornadas`.`id_cursos` = `cursos`.`id`) and (`cursos_jornadas`.`id_jornadas` = `jornadas`.`id`)))) join `cursos_paralelos_aulas` on((`cursos_paralelos_aulas`.`id_cursos` = `cursos`.`id`))) join `aulas` on((`cursos_paralelos_aulas`.`id_aulas` = `aulas`.`id`))) join `paralelos` on(((`paralelos`.`id_anos_lectivos` = `anos_lectivos`.`id`) and (`cursos_paralelos_aulas`.`id_paralelos` = `paralelos`.`id`)))) join `aulas_jornadas` on(((`aulas_jornadas`.`id_jornadas` = `jornadas`.`id`) and (`aulas_jornadas`.`id_aulas` = `aulas`.`id`)))) join `paralelos_jornadas` on(((`paralelos_jornadas`.`id_paralelos` = `paralelos`.`id`) and (`paralelos_jornadas`.`id_jornadas` = `jornadas`.`id`)))) join `inscripciones` on(((`inscripciones`.`id_anos_lectivos` = `anos_lectivos`.`id`) and (`inscripciones`.`id_cursos` = `cursos`.`id`) and (`inscripciones`.`id_jornadas` = `jornadas`.`id`)))) join `estudiantes` on((`inscripciones`.`id_estudiantes` = `estudiantes`.`id`))) join `matriculas` on(((`matriculas`.`id_inscripciones` = `inscripciones`.`id`) and (`matriculas`.`id_cursos_paralelos_aulas` = `cursos_paralelos_aulas`.`id`)))) join `docentes_jornadas_materias` on(((`docentes_jornadas_materias`.`id_jornadas` = `jornadas`.`id`) and (`docentes_jornadas_materias`.`id_materias` = `materias`.`id`) and (`docentes_jornadas_materias`.`id_anos_lectivos` = `anos_lectivos`.`id`)))) join `docentes_asignar_curso` on(((`docentes_asignar_curso`.`id_docentes_jornadas_materias` = `docentes_jornadas_materias`.`id`) and (`docentes_asignar_curso`.`id_cursos_paralelos_aulas` = `cursos_paralelos_aulas`.`id`)))) join `dre` on(((`dre`.`id_insumos` = `insumos`.`id`) and (`dre`.`id_docentes_asignar_curso` = `docentes_asignar_curso`.`id`) and (`dre`.`id_docentes_asignar_curso` = `docentes_asignar_curso`.`id`)))) join `nota1` on(((`nota1`.`id_matriculas` = `matriculas`.`id`) and (`nota1`.`id_actividades_cursos` = `dre`.`id`)))) group by `estudiantes`.`id` ;

-- ----------------------------
-- View structure for cur_est_not_copy2
-- ----------------------------
DROP VIEW IF EXISTS `cur_est_not_copy2`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `cur_est_not_copy2` AS select `anos_lectivos`.`nombre` AS `ano`,`ctlg_cursos`.`nombre` AS `curso`,`ctlg_materias`.`nombre` AS `materia`,`ctlg_periodos`.`nombre` AS `periodo`,`ctlg_parciales`.`nombre` AS `parcial`,`ctlg_jornadas`.`nombre` AS `jornada`,`aulas`.`nombre` AS `aula`,`paralelos`.`nombre` AS `paralelo`,round(avg((case when (`ctlg_insumos`.`id` = 1) then ifnull(`nota1`.`valor`,0) end)),2) AS `tarea`,round(avg((case when (`ctlg_insumos`.`id` = 2) then ifnull(`nota1`.`valor`,0) end)),2) AS `leccion`,round(avg((case when (`ctlg_insumos`.`id` = 3) then ifnull(`nota1`.`valor`,0) end)),2) AS `act_individual`,round(avg((case when (`ctlg_insumos`.`id` = 4) then ifnull(`nota1`.`valor`,0) end)),2) AS `act_grupal`,round(avg((case when (`ctlg_insumos`.`id` = 5) then ifnull(`nota1`.`valor`,0) end)),2) AS `evaluacion_escrita`,concat(`estudiantes`.`nombres`,' ',`estudiantes`.`apellidos`) AS `estudiante` from ((((((((((((((((((((((((((`anos_lectivos` join `cursos` on((`cursos`.`id_anos_lectivos` = `anos_lectivos`.`id`))) join `materias` on((`materias`.`id_anos_lectivos` = `anos_lectivos`.`id`))) join `ctlg_cursos` on((`cursos`.`id_ctlg_cursos` = `ctlg_cursos`.`id`))) join `ctlg_materias` on((`materias`.`id_ctlg_materias` = `ctlg_materias`.`id`))) join `cursos_materias` on(((`cursos_materias`.`id_cursos` = `cursos`.`id`) and (`cursos_materias`.`id_materias` = `materias`.`id`)))) join `periodos` on((`periodos`.`id_anos_lectivos` = `anos_lectivos`.`id`))) join `ctlg_periodos` on((`periodos`.`id_ctlg_periodos` = `ctlg_periodos`.`id`))) join `parciales` on((`parciales`.`id_periodos` = `periodos`.`id`))) join `ctlg_parciales` on((`parciales`.`id_ctlg_parciales` = `ctlg_parciales`.`id`))) join `insumos` on((`insumos`.`id_parciales` = `parciales`.`id`))) join `ctlg_insumos` on((`insumos`.`id_ctlg_insumos` = `ctlg_insumos`.`id`))) join `jornadas` on((`jornadas`.`id_anos_lectivos` = `anos_lectivos`.`id`))) join `ctlg_jornadas` on((`jornadas`.`id_ctlg_jornadas` = `ctlg_jornadas`.`id`))) join `cursos_jornadas` on(((`cursos_jornadas`.`id_cursos` = `cursos`.`id`) and (`cursos_jornadas`.`id_jornadas` = `jornadas`.`id`)))) join `cursos_paralelos_aulas` on((`cursos_paralelos_aulas`.`id_cursos` = `cursos`.`id`))) join `aulas` on((`cursos_paralelos_aulas`.`id_aulas` = `aulas`.`id`))) join `paralelos` on(((`paralelos`.`id_anos_lectivos` = `anos_lectivos`.`id`) and (`cursos_paralelos_aulas`.`id_paralelos` = `paralelos`.`id`)))) join `aulas_jornadas` on(((`aulas_jornadas`.`id_jornadas` = `jornadas`.`id`) and (`aulas_jornadas`.`id_aulas` = `aulas`.`id`)))) join `paralelos_jornadas` on(((`paralelos_jornadas`.`id_paralelos` = `paralelos`.`id`) and (`paralelos_jornadas`.`id_jornadas` = `jornadas`.`id`)))) join `inscripciones` on(((`inscripciones`.`id_anos_lectivos` = `anos_lectivos`.`id`) and (`inscripciones`.`id_cursos` = `cursos`.`id`) and (`inscripciones`.`id_jornadas` = `jornadas`.`id`)))) join `estudiantes` on((`inscripciones`.`id_estudiantes` = `estudiantes`.`id`))) join `matriculas` on(((`matriculas`.`id_inscripciones` = `inscripciones`.`id`) and (`matriculas`.`id_cursos_paralelos_aulas` = `cursos_paralelos_aulas`.`id`)))) join `docentes_jornadas_materias` on(((`docentes_jornadas_materias`.`id_jornadas` = `jornadas`.`id`) and (`docentes_jornadas_materias`.`id_materias` = `materias`.`id`) and (`docentes_jornadas_materias`.`id_anos_lectivos` = `anos_lectivos`.`id`)))) join `docentes_asignar_curso` on(((`docentes_asignar_curso`.`id_docentes_jornadas_materias` = `docentes_jornadas_materias`.`id`) and (`docentes_asignar_curso`.`id_cursos_paralelos_aulas` = `cursos_paralelos_aulas`.`id`)))) join `dre` on(((`dre`.`id_insumos` = `insumos`.`id`) and (`dre`.`id_docentes_asignar_curso` = `docentes_asignar_curso`.`id`) and (`dre`.`id_docentes_asignar_curso` = `docentes_asignar_curso`.`id`)))) join `nota1` on(((`nota1`.`id_matriculas` = `matriculas`.`id`) and (`nota1`.`id_actividades_cursos` = `dre`.`id`)))) group by `materias`.`id`,`cursos`.`id`,`estudiantes`.`id`,`parciales`.`id`,`periodos`.`id` ;

-- ----------------------------
-- View structure for inse
-- ----------------------------
DROP VIEW IF EXISTS `inse`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `inse` AS select `anos_lectivos`.`id` AS `id_ano`,`materias`.`id` AS `id_materia`,`cursos`.`id` AS `id_curso`,`periodos`.`id` AS `id_periodo`,`parciales`.`id` AS `id_parcial`,`jornadas`.`id` AS `id_jornada`,`aulas`.`id` AS `id_aula`,`paralelos`.`id` AS `id_paralelo`,`estudiantes`.`id` AS `id_estudiante`,`inscripciones`.`id` AS `id_inscripcion`,`matriculas`.`id` AS `id_matricula`,round(avg((case when (`ctlg_insumos`.`id` = 1) then ifnull(`nota1`.`valor`,0) end)),2) AS `tarea`,round(avg((case when (`ctlg_insumos`.`id` = 2) then ifnull(`nota1`.`valor`,0) end)),2) AS `leccion`,round(avg((case when (`ctlg_insumos`.`id` = 3) then ifnull(`nota1`.`valor`,0) end)),2) AS `act_individual`,round(avg((case when (`ctlg_insumos`.`id` = 4) then ifnull(`nota1`.`valor`,0) end)),2) AS `act_grupal`,round(avg((case when (`ctlg_insumos`.`id` = 5) then ifnull(`nota1`.`valor`,0) end)),2) AS `evaluacion_escrita`,`cursos_paralelos_aulas`.`id` AS `cpa`,concat(`estudiantes`.`nombres`,' ',`estudiantes`.`apellidos`) AS `estudiantes`,`anos_lectivos`.`nombre` AS `ano`,`ctlg_cursos`.`nombre` AS `curso`,`ctlg_materias`.`nombre` AS `materia`,`ctlg_periodos`.`nombre` AS `periodo`,`ctlg_parciales`.`nombre` AS `parcial`,`ctlg_jornadas`.`nombre` AS `jornada`,`aulas`.`nombre` AS `aula`,`paralelos`.`nombre` AS `paralelo` from ((((((((((((((((((((((((((`anos_lectivos` join `cursos` on((`cursos`.`id_anos_lectivos` = `anos_lectivos`.`id`))) join `materias` on((`materias`.`id_anos_lectivos` = `anos_lectivos`.`id`))) join `ctlg_cursos` on((`cursos`.`id_ctlg_cursos` = `ctlg_cursos`.`id`))) join `ctlg_materias` on((`materias`.`id_ctlg_materias` = `ctlg_materias`.`id`))) join `cursos_materias` on(((`cursos_materias`.`id_cursos` = `cursos`.`id`) and (`cursos_materias`.`id_materias` = `materias`.`id`)))) join `periodos` on((`periodos`.`id_anos_lectivos` = `anos_lectivos`.`id`))) join `ctlg_periodos` on((`periodos`.`id_ctlg_periodos` = `ctlg_periodos`.`id`))) join `parciales` on((`parciales`.`id_periodos` = `periodos`.`id`))) join `ctlg_parciales` on((`parciales`.`id_ctlg_parciales` = `ctlg_parciales`.`id`))) join `insumos` on((`insumos`.`id_parciales` = `parciales`.`id`))) join `ctlg_insumos` on((`insumos`.`id_ctlg_insumos` = `ctlg_insumos`.`id`))) join `jornadas` on((`jornadas`.`id_anos_lectivos` = `anos_lectivos`.`id`))) join `ctlg_jornadas` on((`jornadas`.`id_ctlg_jornadas` = `ctlg_jornadas`.`id`))) join `cursos_jornadas` on(((`cursos_jornadas`.`id_cursos` = `cursos`.`id`) and (`cursos_jornadas`.`id_jornadas` = `jornadas`.`id`)))) join `cursos_paralelos_aulas` on((`cursos_paralelos_aulas`.`id_cursos` = `cursos`.`id`))) join `aulas` on((`cursos_paralelos_aulas`.`id_aulas` = `aulas`.`id`))) join `paralelos` on(((`paralelos`.`id_anos_lectivos` = `anos_lectivos`.`id`) and (`cursos_paralelos_aulas`.`id_paralelos` = `paralelos`.`id`)))) join `aulas_jornadas` on(((`aulas_jornadas`.`id_jornadas` = `jornadas`.`id`) and (`aulas_jornadas`.`id_aulas` = `aulas`.`id`)))) join `paralelos_jornadas` on(((`paralelos_jornadas`.`id_paralelos` = `paralelos`.`id`) and (`paralelos_jornadas`.`id_jornadas` = `jornadas`.`id`)))) join `inscripciones` on(((`inscripciones`.`id_anos_lectivos` = `anos_lectivos`.`id`) and (`inscripciones`.`id_cursos` = `cursos`.`id`) and (`inscripciones`.`id_jornadas` = `jornadas`.`id`)))) join `estudiantes` on((`inscripciones`.`id_estudiantes` = `estudiantes`.`id`))) join `matriculas` on(((`matriculas`.`id_inscripciones` = `inscripciones`.`id`) and (`matriculas`.`id_cursos_paralelos_aulas` = `cursos_paralelos_aulas`.`id`)))) join `docentes_jornadas_materias` on(((`docentes_jornadas_materias`.`id_jornadas` = `jornadas`.`id`) and (`docentes_jornadas_materias`.`id_materias` = `materias`.`id`) and (`docentes_jornadas_materias`.`id_anos_lectivos` = `anos_lectivos`.`id`)))) join `docentes_asignar_curso` on(((`docentes_asignar_curso`.`id_docentes_jornadas_materias` = `docentes_jornadas_materias`.`id`) and (`docentes_asignar_curso`.`id_cursos_paralelos_aulas` = `cursos_paralelos_aulas`.`id`)))) join `dre` on(((`dre`.`id_insumos` = `insumos`.`id`) and (`dre`.`id_docentes_asignar_curso` = `docentes_asignar_curso`.`id`) and (`dre`.`id_docentes_asignar_curso` = `docentes_asignar_curso`.`id`)))) join `nota1` on(((`nota1`.`id_matriculas` = `matriculas`.`id`) and (`nota1`.`id_actividades_cursos` = `dre`.`id`)))) group by `materias`.`id`,`cursos`.`id`,`estudiantes`.`id`,`parciales`.`id`,`periodos`.`id` ;
