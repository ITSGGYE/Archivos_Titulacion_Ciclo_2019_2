...
document.miforma.nombre.focus();	
 ...
 if(key == especiales[i]){
	...
	var decripcion11a = document.getElementById("nombre");
         ...
         alert('Digite la descripcion del tipo de cliente');
		 document.miforma.nombre.focus();
		 return false;
    }
...
ajax.onreadystatechange = function() {
			...
			if (ajax.readyState == 4){
				...
				if (jugador.value == 1 || jugador.value == 2 )
				{
								...
								if (jugador.value == 1 )
								{
									...
									window.alert("Favor revise descripcion del tipo de cliente ya existe");
									document.miforma.nombre.focus();
		...
		ajax.send("&dorsal="+dorsal+"&equipo1="+equipo1+"&ruc4="+ruc4)
...
window.alert("El registro se creo con exito");
				...
				if (veri==0)
		{
					$.post("grabaregis.php",{ nome:nome,code:code,dorsal:dorsal },function(data){$("#curso").html(data);})	
		...
		if (veri==1)
		{
				...
				$.post("grabaregis1.php",{ nome:nome,code:code,dorsal:dorsal },function(data){$("#curso").html(data);})
		}		
    ...
    <div class="contentpanel">
      ...
      <div class="pull-left breadcrumb_admin clear_both">
        ...
        <div class="pull-left page_title theme_color">
          ...
          <h1>Registro de Tipos de Clietes </h1>
          <h2 class=""></h2>
        </div>
        <div class="pull-right">
          <ol class="breadcrumb">
            ...
            <li><a href="tipoclie.php">Salir <img src="dibujo/sal.png" width="30" height="25" title="Salir" /></a></li>
  ...
  <tr>
    <td><div class="directorioCentros">
		<div class="sqlQueryContent">
			<div class="elements">
				<div class="header">
					<h3 align="center">Datos de Tipos de Clientes </h3>  
...
Tipo de Cliente</label> 
    ...
    <td><input name="nombre" type="text" class="success" onKeyPress="return soloLetras(event); " id="nombre" maxlength="30" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
...
<input name="codi" type="hidden" class="field2" id="codi" value="" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td><input name="curso" type="hidden" id="curso" ></td>
    ...
    <td>&nbsp;</td>
				 ...
				 <div class="searcherButtons">
					 <button type="button" name="clean" onclick="limpiar();"> Limpiar</button>	
