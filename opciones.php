 ...
 function suma6(i)
{
	  ...
	  var opcion=document.getElementById("opcio"+i);
opcion1=opcion.value;




var prog=document.getElementById("pro"+i);
proga=prog.value;


$.post("cuegrapro.php",{opcion1:opcion1,proga:proga },function(data){$("#asca").html(data);})
...
var uno=document.getElementById("pr"+i);
...
return retorno;
 ...
 if(key == especiales[i]){
	...
	var decripcion11 = document.getElementById("descri");
         ...
         alert('Digite descripcion de la opcion');
		 document.formName.descri.focus();
		 return false;
    }
			...
			if (ajax.readyState == 4){
				...
				if (jugador.value == 1 || jugador.value == 2 )
				{
								...
								if (jugador.value == 1 )
								{
									...
									window.alert("Favor revise descripcion de la opcion esye dato ya existe");
  ...
  <?php include "menu.php";?>	
    ...
    <div class="page-content">
	 ...
	 <form method="post" name="formName" action="" onSubmit="enviarDatos(); return false">	   
		   <table width="867">
  <tr>
    <td width="280">Opcion Descripcion</td>
    <td width="320" colspan="2"><input name="descri" type="text" class="field2" id="descri" style="text-transform:capitalize; height:19px;"  onkeypress="return soloLetras(event); " size="40" maxlength="60"  /></td>
    <td width="245"></td>
  </tr>
  <tr>
    <td><input name="cedula2" type="hidden" size="5" class="field2" id="cedula2"  value="" />
      ...
      <input name="op" type="hidden" size="5" class="field2" id="op" value="2" />
...
<input name="cedula4" type="hidden" id="cedula4" value="">
	...
	<input name="vidautil" type="hidden" class="field2" id="vidautil" value="" />	<input  name="asca"  type="hidden" id="asca"  value="" ><input name="razon" type="hidden" class="field2" id="razon" onKeyPress="return soloLetras1(event); " value="" /><input name="deta" type="text" class="field2" id="deta" style="height:19px;" readonly="true"  size="20" maxlength="60"  /></td>
