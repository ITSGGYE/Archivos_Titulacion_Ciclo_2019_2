...
$cuecondescri="";
				...
				$result22 = $mysqli->query("select tipousu from tipousu where idtipo1 = '$idpro'");
...
var opcio=document.getElementById("t1"+i);
var idt=document.getElementById("t2"+i);




dorsal = document.formName.op.value;
idtipo=document.formName.razon.value;

//$.post("carga42.php",{ id:uno.value,id1:dos.value },function(data){$("#curso").html(data);})

$.post("cliquita.php",{ idop:opcio.value,dorsal:dorsal,idtipo:idtipo,idt:idt.value,op:op },function(data){$("#curso").html(data);})
  ...
  <?php include "menu.php";?>	
    ...
    <div class="page-content">
	 ...
	 <form method="post" name="formName" action="" onSubmit="enviarDatos(); return false">	   
		   <table width="867">
  <tr>
    <td width="280">Tipo de Usuario<input name="cedula2" type="hidden" size="5" class="field2" id="cedula2"  value="" />
						
      <input name="monto2" type="hidden" size="5" class="field2" id="monto2"  value="" />
      <input name="op" type="hidden" size="5" class="field2" id="op" value="11" />
...
<input name="cedula4" type="hidden" id="cedula4" value="">
    ...
    <td width="245"><div align="center"> <a href="tipousuario.php"><img  src="grafico/nue4.png" border="0"  /></a></div></td>
  </tr>
</table>
