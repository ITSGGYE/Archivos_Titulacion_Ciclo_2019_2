...
<body class="loader-active" style="background-image: url('imagen/fondo_blanco.jpg'); background-position: center center;      
    ...
    <h2 style="text-align: center; color: #0A91E4; font-size: 1.7rem;">Ficha de Identificación del Pasante</h2>
        <table class="table table-sm" style="color: #000;">
        <tr>
        <td width=80%>    
        <table>
        <tr>
        ...
        <th style="color:#0A91E4;">Dependiente:</th>
        <td scope="row" ><?php echo $dependiente; ?></td>
        ...
        <th style="color:#0A91E4;">Universidad:</th>
        <td scope="row" ><?php echo $universidad; ?></td>
        ...
        if($_GET["cargar"] == "ver_estudiantes"){
            ...
            echo '<td scope="row" > <img src="../appws/files/pasantes/'.$foto.'"></td>';
        }
        ?>
        </tr>
