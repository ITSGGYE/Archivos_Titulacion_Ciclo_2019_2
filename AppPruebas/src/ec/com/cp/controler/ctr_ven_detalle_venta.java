 ...
 * @author Usuario
 */
public class ctr_ven_detalle_venta {
...
//    DBConeccion conectarBD = new DBConeccion();
    ...
    public String insertarDetalleVenta(model_ven_detalle_venta obj,Long id_cliente,Long id_sucursal,
        ...
        try {/*N `id_cliente1` INT,IN `id_sucursal1` INT,
            ...
            CallableStatement prodProAlm = con.prepareCall(
                    "{ call ven_detalle_venta_insert(?,?,?,?,?,?,?,?,?,?,?,?,?,?) }");
            prodProAlm.setLong(1, id_cliente);
