 ...
 * @author Usuario
 */
public class artConsultaMarcaEscojer extends javax.swing.JDialog {
...
//    ArrayList<model_pdt_marca_dos> listar = null;
    ...
    public artConsultaMarcaEscojer(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
...
//        Tablas.listarArticulos(listArticulo, tba_articulo);
...
int i = 0;
    ...
    public model_pdt_marca_dos devuelveObjeto(Long id, List<model_pdt_marca_dos> lista) {
        ...
        for (int i = 0; i < lista.size(); i++) {
            ...
            if (Objects.equals(lista.get(i).getId_marca(), id)) {
                doc = lista.get(i);System.out.println("**9");
                break;
            }
        }
        return doc;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(artConsultaMarcaEscojer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                artConsultaMarcaEscojer dialog = new artConsultaMarcaEscojer(new javax.swing.JFrame(), true);
