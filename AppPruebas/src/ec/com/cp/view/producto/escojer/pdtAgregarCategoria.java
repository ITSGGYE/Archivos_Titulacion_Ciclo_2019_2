 ...
 * @author Usuario
 */
public class pdtAgregarCategoria extends javax.swing.JDialog {
    ...
    public pdtAgregarCategoria(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pdtAgregarCategoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                pdtAgregarCategoria dialog = new pdtAgregarCategoria(new javax.swing.JFrame(), true);
