...
import ec.com.cp.view.subcategoria.*;
 ...
 * @author Usuario
 */
public class pdtAgregarSubCategorias extends javax.swing.JDialog {
    ...
    public pdtAgregarSubCategorias(java.awt.Frame parent, boolean modal, String categoria) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        ...
        cat = categoria;
        cagarCbxCategoria();
        cbx_categoria.setSelectedItem(cat);
        cbx_categoria.setEnabled(false);
    }

    public pdtAgregarSubCategorias(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        setLocationRelativeTo(null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pdtAgregarSubCategorias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                pdtAgregarSubCategorias dialog = new pdtAgregarSubCategorias(new javax.swing.JFrame(), true);
