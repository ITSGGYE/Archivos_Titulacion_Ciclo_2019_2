 ...
 * @author Usuario
 */
public class pdtConsultaMarcaEscojer extends javax.swing.JDialog {
...
//    ArrayList<model_pdt_marca_dos> listar = null;
    ...
    public pdtConsultaMarcaEscojer(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    public pdtConsultaMarcaEscojer(java.awt.Frame parent, boolean modal, int id,String cat,String subCat) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        setLocationRelativeTo(null);
...
//    Tablas.listarMarca(listMarca, tba_articulo);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        pdtAgregarMarca ga = new pdtAgregarMarca(new javax.swing.JFrame(), true,categoria,subcategoria);
        ga.setVisible(true);
        tabla(id_subcat);
...
//        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pdtConsultaMarcaEscojer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                pdtConsultaMarcaEscojer dialog = new pdtConsultaMarcaEscojer(new javax.swing.JFrame(), true);
