...
//    ArrayList<model_pdt_marca_dos> listar = null;
    ...
    public model_pdt_marca_dos devuelveObjeto(String datos, ArrayList<model_pdt_marca_dos> listarobj) {
        model_pdt_marca_dos objeto1 = null;
        for (int i = 0; i < listarobj.size(); i++) {
            if (datos.equals(listarobj.get(i).getId_marca().toString())) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        int id = 0;
        if (tba_articulo.getSelectedRow() >= 0) {
            /*hgfrt*/
            id = tba_articulo.getSelectedRow();
            marca = devuelveObjeto(tba_articulo.getValueAt(id, 0).toString(), listMarca);
            if (marca != null) {
                FrmEditarMarca Ec = new FrmEditarMarca(new javax.swing.JFrame(), true, marca);
                Ec.setVisible(true);
                tabla();
            }
        } else {
