 ...
 * @author Usuario
 */
public class FrmEditarSubCategorias extends javax.swing.JDialog {
    ...
    public FrmEditarSubCategorias(java.awt.Frame parent, boolean modal, model_pdt_subcategoria_join_subcategoria subCat) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        ...
        cagarCbxCategoria();
        SubCategoria = subCat;
        txt_categoria.setText(SubCategoria.getNombre());
...
//        btnBoton.setVisible(false);
    ...
    public FrmEditarSubCategorias(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        setLocationRelativeTo(null);
    ...
    private void initComponents() {
        ...
        btnBoton.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(cbx_categoria, javax.swing.GroupLayout.PREFERRED_SIZE, 273, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            subcategoria.setId_subcategoria(SubCategoria.getId_subcategoria());
            String o = crudSubCat.actualizarSubCategoria(subcategoria);
    ...
    public void proceso() {
        ...
        for (int m = 0; m < listMarca.size(); m++) {
            if (Objects.equals(listMarca.get(m).getId_subcategoria(), SubCategoria.getId_subcategoria())) {
    ...
    public void activaInactivar() {
        ...
        int r = JOptionPane.showConfirmDialog(null, "¿ESTA SEGURO DE " + boton + " A: " + SubCategoria.getNombre() + "?", "", JOptionPane.YES_NO_OPTION);
        if (r == JOptionPane.YES_OPTION) {
            ...
            try {
                Long id = SubCategoria.getId_subcategoria();
                SubCategoria.setId_subcategoria(id);
                System.out.println("sub categoria: " + id);
                SubCategoria.setEstado(estado.charAt(0));
                System.out.println("estado: " + estado.charAt(0));
                SubCategoria.setUsuario_actulizacion("yo");

                String msg = crudSubCat.activarInactivarSubCategoria(SubCategoria);
                proceso();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmEditarSubCategorias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmEditarSubCategorias dialog = new FrmEditarSubCategorias(new javax.swing.JFrame(), true);
