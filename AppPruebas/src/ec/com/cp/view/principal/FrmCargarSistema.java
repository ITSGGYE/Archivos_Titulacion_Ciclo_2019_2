...
import ec.com.cp.util.util_cargar;
import ec.com.cp.util.util_variables;
 ...
 * @author admin1
 */
public final class FrmCargarSistema extends javax.swing.JFrame {

    private static final long serialVersionUID = 1L;
    util_cargar hilo;
    Fila c = new Fila();
//    comp_variables fondo = new comp_variables();
    ...
    public void imagenes() {
        ImageIcon logo = new ImageIcon(getClass().getResource("/imagenes/venta.jpg"));
    ...
    private void carga_pbStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_carga_pbStateChanged
        if (carga_pb.getValue() == 100) {
            try {
                ...
                Logger.getLogger(FrmCargarSistema.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmCargarSistema.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new FrmCargarSistema().setVisible(true);
        });
    }
