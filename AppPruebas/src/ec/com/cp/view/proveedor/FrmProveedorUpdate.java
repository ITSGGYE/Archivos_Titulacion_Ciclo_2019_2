 ...
 * @author alumno
 */
public final class FrmProveedorUpdate extends javax.swing.JDialog {
    ...
    model_seg_proveedor_join objProveedor = null;
     ...
     * @param proveedor
     */
    public FrmProveedorUpdate(java.awt.Frame parent, boolean modal, model_seg_usuario_join usuario, model_emp_empresa_join empresa, model_seg_proveedor_join proveedor) {
        super(parent, modal);
        initComponents();
    ...
    public FrmProveedorUpdate(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public void form() {
        String estado = objProveedor.getEstado();
        System.out.println("estado: "+estado);
        txtCedula.setText(objProveedor.getCedula());
        txtCorreo.setText(objProveedor.getEmail());
        txtDireccion.setText(objProveedor.getDireccion());
        txtNombreComercial.setText(objProveedor.getNombre_comercial());
        txtTelefonoDos.setText(objProveedor.getTelefono_dos());
        txtNombre.setText(objProveedor.getNombre());
        txtObservacion.setText(objProveedor.getObservacion());
...
//            Guardar();
    ...
    public void inactivar() {
        int r = JOptionPane.showConfirmDialog(null, "¿ESTA SEGURO DE INACTIVAR A " + objProveedor.getNombre_comercial() + "?", "", JOptionPane.YES_NO_OPTION);
        if (r == JOptionPane.YES_OPTION) {
            objProveedor.setId_usuario(objProveedor.getId_usuario());
            objUsuario.setNomb_usuario(objUsuario.getNomb_usuario());

            try {
                String msg = ctr.InactivarProveedorJoin(objUsuario,objProveedor);
    ...
    private void btnActivarInactivarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActivarInactivarActionPerformed
        if ("A".equals(objProveedor.getEstado())) {
            inactivar();
        }
        if ("I".equals(objProveedor.getEstado())) {
//            inactivar();
        }
    ...
    public void Actualizar() {
        ...
        if (txtNombreComercial.getText().length() < 3) {
            ...
            JOptionPane.showMessageDialog(null, "INGRESE UN NUMERO DE CONTACTO EMPRESARIAL VALIDO!");
            ...
            objProveedor.setFecha_nacimiento(txtNombre.getText());
            objProveedor.setTelefono(txtTelefono.getText());
            objProveedor.setTelefono_dos(txtTelefonoDos.getText());

            objUsuario.setNomb_usuario(objUsuario.getNomb_usuario());
            objProveedor.setId_usuario(objProveedor.getId_usuario());
            objProveedor.setId_persona(objProveedor.getId_persona());

            try {
                String msg = ctr.ActualizarProveedorJoin(objProveedor, objEmpresa, objUsuario);
                JOptionPane.showMessageDialog(this, msg);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmProveedorUpdate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmProveedorUpdate dialog = new FrmProveedorUpdate(new javax.swing.JFrame(), true);
