 ...
 * @author Usuario
 */
public class FrmEditarEnvases extends javax.swing.JDialog {
    ...
    public FrmEditarEnvases(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    public FrmEditarEnvases(java.awt.Frame parent, boolean modal, model_pdt_envase env) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        setLocationRelativeTo(null);
        envase = env;
        txt_nombre.setText(envase.getNombre_envase());
        btn();
    }
    ...
    public void btn() {
        String estado = "" + envase.getEstado();
        if ("A".equals(estado)) {
            btnBoton.setText("INACTIVAR");
        }
        if ("I".equals(estado)) {
    ...
    public void actualizar() {
        try {
            envase.setId_envase(envase.getId_envase());
            envase.setNombre_envase(txt_nombre.getText());
            envase.setU_actualizacion("yo");
            String o = crud.actualizarEnvase(envase);
    ...
    public void activaInactivar() {
        ...
        String estado = "";
        int r = JOptionPane.showConfirmDialog(null, "¿ESTA SEGURO DE " + boton + " A: " + envase.getNombre_envase() + "?", "", JOptionPane.YES_NO_OPTION);
        if (r == JOptionPane.YES_OPTION) {
            ...
            envase.setId_envase(envase.getId_envase());
            envase.setEstado(estado);
            envase.setU_actualizacion("YO");
            try {
                String msg = crud.activarInactivarEnvase(envase);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmEditarEnvases.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmEditarEnvases dialog = new FrmEditarEnvases(new javax.swing.JFrame(), true);
