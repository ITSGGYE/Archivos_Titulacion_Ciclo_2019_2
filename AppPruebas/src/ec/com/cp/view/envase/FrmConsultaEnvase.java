 ...
 * @author Usuario
 */
public class FrmConsultaEnvase extends javax.swing.JDialog {
    ...
    model_pdt_envase envase;
    ctr_pdt_envase crud = new ctr_pdt_envase();

    public FrmConsultaEnvase(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    public void cargarTatbla() {
        listEnvase = crud.listarEnvase(1);
        Tablas.listarEnvase(listEnvase, tabla);
    }
...
public model_pdt_envase devuelveObjeto(Long id, List<model_pdt_envase> lista) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (tabla.getSelectedRow() >= 0) {
            ...
            envase = devuelveObjeto(Long.valueOf(tabla.getValueAt(id, 0).toString()), listEnvase);
            if (envase != null) {
                FrmEditarEnvases Ec = new FrmEditarEnvases(new javax.swing.JFrame(), true, envase);
                Ec.setVisible(true);
                cargarTatbla();
            }
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmConsultaEnvase.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmConsultaEnvase dialog = new FrmConsultaEnvase(new javax.swing.JFrame(), true);
