 ...
 */
package ec.com.cp.view.clientes;
...
public class ConsultaCliente extends javax.swing.JDialog {
    ...
    public ConsultaCliente(java.awt.Frame parent, boolean modal, model_emp_empresa emp) {
        super(parent, modal);
        initComponents();
    }

    public void cargarTbaCliente() {
        listCliente = crudCliente.listarClientes(1);
        Tablas.listarClientes(listCliente, tba_Clientes);
    }
    ...
    private void initComponents() {
        ...
        tba_Clientes.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
    ...
    public model_seg_cliente_join devuelveObjeto(Long id, List<model_seg_cliente_join> lista) {
        model_seg_cliente_join doc = null;
        for (int i = 0; i < lista.size(); i++) {
            if (Objects.equals(lista.get(i).getId_persona(), id)) {
                doc = lista.get(i);
                break;
            }
        }
...
//            listaProVent = selectProdVent.listarProductoVenta();
            objCliente = devuelveObjeto(Long.valueOf(tba_Clientes.getValueAt(id, 0).toString()), listCliente);
            if (objCliente != null) {
//                objJoinProVen.setNombre_producto(tba_productos.getValueAt(id, 2).toString());
    ...
    public model_seg_cliente_join obtenerObjCliente() {
        return objCliente;
    }
    private void tba_ClientesMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tba_ClientesMouseReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_tba_ClientesMouseReleased
...
//        agregarMarca ga = new agregarMarca(new javax.swing.JFrame(), true);
//        ga.setVisible(true);
//        cargarTbaMarca();
