 ...
 * @author carlos
 */
public class FrmEmpleadoInactivoList extends javax.swing.JDialog {
...
//    JoinEmpleados je = new JoinEmpleados();
    ...
    model_seg_usuario_join tabObjetoUsuario;
    String valor = "";

    public FrmEmpleadoInactivoList(java.awt.Frame parent, boolean modal, model_seg_usuario_join usuario, model_emp_empresa_join empresa) {
        super(parent, modal);
        initComponents();
    ...
    public FrmEmpleadoInactivoList(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public void tabla() {
        listar = ctr.ListaUsuarioJoinTodoInactivo();
        Tablas_seg_usaurio_join.listarUsuarios(listar, jtEmpleados);
    }
...
//        lbIdUsuario.setText(us.getId_usuario().toString());
    ...
    public model_seg_usuario_join devuelveObjetoEmpleado(String datos, ArrayList<model_seg_usuario_join> listarobj) {
        model_seg_usuario_join objeto1 = null;
    ...
    private void jtEmpleadosMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtEmpleadosMousePressed
        ...
        try {
            if (evt.getClickCount() == 2) {
                ...
                tabObjetoUsuario = devuelveObjetoEmpleado(jtEmpleados.getValueAt(i, 0).toString(), listar);
                if (tabObjetoUsuario != null) {
                    System.out.println("holaaaaa");
                    FrmEmpeladoUpdate acc = new FrmEmpeladoUpdate(new javax.swing.JFrame(), true, objUsuario, objEmpresa, tabObjetoUsuario);
                    acc.setVisible(true);
                    listar.clear();
                    tabla();
                }
            ...
            Logger.getLogger(FrmEmpleadoInactivoList.class.getName()).log(Level.SEVERE, null, e);
        }
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
        ...
        Tablas_seg_usaurio_join.filtro(valor, jtEmpleados);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmEmpleadoInactivoList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmEmpleadoInactivoList dialog = new FrmEmpleadoInactivoList(new javax.swing.JFrame(), true);
