 ...
 */
package ec.com.cp.view.usuario.cuenta;
...
public class frmMantenimientoUsuario extends javax.swing.JDialog {
    ...
    public frmMantenimientoUsuario(java.awt.Frame parent, boolean modal, model_seg_usuario_join usuario) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        objUsuario = usuario;
        txtUsuario.setText(objUsuario.getNomb_usuario());
        objUsuario = usuario;
    }
    ...
    private void initComponents() {
        ...
        btnActualizar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/actualiza32.png"))); // NOI18N
        ...
        txtConfir.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
...
public void mantenimiento() {
        ...
        if (contra.length() < 6) {
            ...
            JOptionPane.showMessageDialog(this, "USUARIO DEBE TENER AL MENOS 5 CARACTERES!");
        } else {
            if (contra.equals(confir)) {
                model_seg_usuario_join je = new model_seg_usuario_join();
                je.setId_usuario(objUsuario.getId_usuario());
                je.setPassword(txtContra.getText());
                je.setNomb_usuario(txtUsuario.getText());
                String a = ctr.ActualizarUsuario(je);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmMantenimientoUsuario dialog = new frmMantenimientoUsuario(new javax.swing.JFrame(), true);
