 ...
 */
package ec.com.cp.view.ordenPedido;
 ...
 * @author admin1
 */
public class crearOrdenPedido extends javax.swing.JDialog {

    int x, y;
    int contFilas = 1;

    public crearOrdenPedido(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        txtFecha.setText(FechaActual());
//        CargarProveedor();
        Timer tiempo = new Timer(100, new crearOrdenPedido.horas());
        tiempo.start();
...
//    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        consultaProductosOrdenPedido ingre = new consultaProductosOrdenPedido(new javax.swing.JFrame(), true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(crearOrdenPedido.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                crearOrdenPedido dialog = new crearOrdenPedido(new javax.swing.JFrame(), true);
