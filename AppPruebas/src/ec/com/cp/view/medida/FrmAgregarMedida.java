 ...
 * @author Usuario
 */
public class FrmAgregarMedida extends javax.swing.JDialog {
    ...
    int x, y;
    String valor = "";
    model_pdt_medida medida = new model_pdt_medida();
    ctr_pdt_medida crud = new ctr_pdt_medida();

    public FrmAgregarMedida(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    public void guardar() {
        ...
        try {
            if (txt_nombre.getText().length() < 3) {
                JOptionPane.showMessageDialog(this, "ESCRIBA AL MENOS 3 CARACTERES");
            } else {
                medida.setNombre_medida(txt_nombre.getText());
                medida.setU_creacion("YO");

                String o = crud.insertarMedida(medida);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmAgregarMedida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmAgregarMedida dialog = new FrmAgregarMedida(new javax.swing.JFrame(), true);
