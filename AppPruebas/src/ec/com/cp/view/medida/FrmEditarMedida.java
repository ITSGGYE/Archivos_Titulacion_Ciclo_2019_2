 ...
 * @author Usuario
 */
public class FrmEditarMedida extends javax.swing.JDialog {
    ...
    public FrmEditarMedida(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    public FrmEditarMedida(java.awt.Frame parent, boolean modal, model_pdt_medida med) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        setLocationRelativeTo(null);
        medida = med;
        txt_categoria.setText(medida.getNombre_medida());
        btn();
    }
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(28, 28, 28)
                        .addComponent(txt_categoria, javax.swing.GroupLayout.PREFERRED_SIZE, 263, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(36, 36, 36))
        );
    ...
    public void btn() {
        String estado = medida.getEstdao();
        if ("A".equals(estado)) {
            btnBoton.setText("INACTIVAR");
        }
        if ("I".equals(estado)) {
...
//            String estado;
//            if (cbx_Estado.getSelectedItem().equals("ACTIVO")) {
//                estado = "A";
//            } else {
//                estado = "I";
//            }
            medida.setId_medida(medida.getId_medida());
            medida.setNombre_medida(txt_categoria.getText());
//            medida.setEstdao(estado);
            medida.setU_actualizacion("YO");
            String o = crud.actualizarMedida(medida);
    ...
    public void activaInactivar() {
        ...
        String estado = "";
        int r = JOptionPane.showConfirmDialog(null, "¿ESTA SEGURO DE " + boton + " A: " + medida.getNombre_medida() + "?", "", JOptionPane.YES_NO_OPTION);
        if (r == JOptionPane.YES_OPTION) {
            ...
            medida.setU_actualizacion("YO");
            try {
                String msg = crud.activarInactivarMedida(medida);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmEditarMedida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmEditarMedida dialog = new FrmEditarMedida(new javax.swing.JFrame(), true);
