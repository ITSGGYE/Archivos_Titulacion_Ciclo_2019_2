 ...
 * @author Usuario
 */
public class ActualizarTarifario extends javax.swing.JDialog {

    /**
     * Creates new form AgregarTarifario
     */
    model_pdt_producto objPro;
    model_inv_detalle_tarifario tar;
    ...
    public ActualizarTarifario(java.awt.Frame parent, boolean modal, model_inv_detalle_tarifario tarifario) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    public ActualizarTarifario(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        setLocationRelativeTo(null);
    ...
    private void initComponents() {
        ...
        txt_valor_costo.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txt_valor_costoKeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
    ...
    public void form() {
        ...
        txt_valor_min_porcentaje.setText("" + tar.getPorcentaje_venta());
        txt_producto.setText(tar.getNombre_producto());

        txt_valor_costo.setText("" + tar.getValor_costo());

        txt_porcentaje_descuento.setText("" + tar.getPorcentaje_descuento());
        txtDescuent_valor.setText("" + tar.getValor_descuento());
    ...
    private void txt_valor_ventaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_valor_ventaKeyReleased
        String des = txt_porcentaje_descuento.getText();
        if (des != null || !"0.0".equals(des)) {
            try {
                CalcularDescuento();
            } catch (Exception e) {
            }
    ...
    public void guardar() {
        ...
        inv.setPorcentaje_venta(Double.valueOf(txt_valor_min_porcentaje.getText()));
        inv.setPorcentaje_descuento(Double.valueOf(txt_porcentaje_descuento.getText()));
        System.out.println("Aplica_iva: " + tar.getAplica_iva());
        inv.setAplica_iva(tar.getAplica_iva());
        String out = crudDetaTari.GuardarDetalleInventario(inv);
    ...
    private void txt_valor_costoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_valor_costoKeyReleased
        try {
            CalcularValorMinimo();
        } catch (Exception e) {
        }
    }//GEN-LAST:event_txt_valor_costoKeyReleased
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ActualizarTarifario.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ActualizarTarifario dialog = new ActualizarTarifario(new javax.swing.JFrame(), true);
