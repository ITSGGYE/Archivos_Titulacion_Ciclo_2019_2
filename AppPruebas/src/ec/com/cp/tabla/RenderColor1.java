 ...
 * @author Usuario
 */
public class RenderColor1 extends DefaultTableCellRenderer {
...
//            this.setForeground(Color.RED);
            setBackground(Color.RED);
        } else if (Long.parseLong(table.getValueAt(row, 2).toString()) >= Long.parseLong(table.getValueAt(row, 8).toString())) {
