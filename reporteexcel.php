...
?>
         <tr class="even_row">
          ...
          <td><?php echo $reg[$i]['ivainsumo'] == 'SI' ? $imp[0]["valorimpuesto"]."%" : "(E)"; ?></td>
...
?>
         <tr class="even_row">
          ...
          <td><?php echo $reg[$i]['ivasalida'] == 'SI' ? $imp[0]["valorimpuesto"]."%" : "(E)"; ?></td>
...
<table border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
         <tr>
           ...
           <th>PRECIO COMPRA</th>
           <th>PRECIO VENTA</th>
           <th><?php echo $cambio[0]['codmoneda2'] == '' ? "*****" : "PRECIO ".$cambio[0]['siglas']; ?></th>
           <th>EXISTENCIA</th>
<?php if ($documento == "EXCEL") { ?>
           <th>STOCK MINIMO</th>
           <th>STOCK MÁXIMO</th>
...
$TotalMoneda+=$reg[$i]['precioventa']/$cambio[0]['montocambio']-$reg[$i]['descproducto']/100;
