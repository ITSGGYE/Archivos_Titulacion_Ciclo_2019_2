            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group has-feedback">
                        ...
                        <select name="documgerente" id="documgerente" class='form-control' required="" aria-required="true">
                ...
                <div class="col-md-3">
                    <div class="form-group has-feedback">
                        ...
                        <input type="text" class="form-control phone-inputmask" name="tlfgerente" id="tlfgerente" value="<?php echo $reg[0]['tlfgerente']; ?>" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Nº de Teléfono" autocomplete="off" required="" aria-required="true"/>  
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group has-feedback">
                        <label class="control-label">Tipo de Documento: </label>
                        <i class="fa fa-bars form-control-feedback"></i> 
                        <select name="documenhotel" id="documenhotel" class='form-control' required="" aria-required="true">
                            <option value=""> -- SELECCIONE -- </option>
                            <?php
                            $doc = new Login();
                            $doc = $doc->ListarDocumentos();
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group has-feedback">
                        ...
                        <input type="text" class="form-control pho-inputmask" name="tlfhotel" id="tlfhotel" value="<?php echo $reg[0]['tlfhotel']; ?>" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Nº de Teléfono" autocomplete="off" required="" aria-required="true"/>  
                        <i class="fa fa-phone form-control-feedback"></i> 
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group has-feedback">
                        ...
                        <i class="fa fa-bars form-control-feedback"></i>
                        <select name="categoriahotel" id="categoriahotel" class='form-control' required="" aria-required="true">
                        <option value="">-- SELECCIONE --</option>
...
<option value="5"<?php if (!(strcmp('5', $reg[0]['categoriahotel']))) {echo "selected=\"selected\"";} ?>>5 ESTRELLA</option>
            ...
            <div class="row">
                    ...
                    <div class="fileinput fileinput-new" data-provides="fileinput">
                        <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 100px; height: 120px;">
                            <?php if (file_exists("fotos/logo_principal.png")){
                                echo "<img src='fotos/logo_principal.png' class='img-rounded' border='0' width='100' height='120' title='Logo' data-rel='tooltip'>"; 
                            } else {
                ...
                <div class="col-md-4">
                    <div class="fileinput fileinput-new" data-provides="fileinput">
                        <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 100px; height: 120px;">
                            <?php if (file_exists("fotos/logo_admin.png")){
                                echo "<img src='fotos/logo_admin.png' class='img-rounded' border='0' width='100' height='120' title='Logo' data-rel='tooltip'>"; 
                            } else {
                                echo "<img src='fotos/ninguna.png' class='img-rounded' border='0' width='100' height='120' title='Sin Logo' data-rel='tooltip'>"; 
                            } ?>
                        </div>
                    ...
                    <div class="fileinput fileinput-new" data-provides="fileinput">
                        <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 100px; height: 120px;">
                            <?php if (file_exists("fotos/logo_pdf.png")){
                                echo "<img src='fotos/logo_pdf.png' class='img-rounded' border='0' width='100' height='120' title='Logo' data-rel='tooltip'>"; 
                            } else {
                                echo "<img src='fotos/ninguna.png' class='img-rounded' border='0' width='100' height='120' title='Sin Logo' data-rel='tooltip'>"; 
                            } ?>
                        </div>
