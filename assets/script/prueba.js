...
{ 
	 ...
	 $("#updatepassword").validate({
      rules:
	  {
			usuario: {required: true, minlength: 8},
...
{ 
	 ...
	 $("#contacto").validate({
      rules:
	  {
       ...
       messages:
	   {
			nombre:{ required: "Ingrese Nombres y Apellidos" },
			email: { required: "Ingrese Correo Electr&oacute;nico", email: "Ingrese un Correo v&aacute;lido" },
			telefono: { required: "Ingrese N&deg; de Tel&eacute;fono", digits: "Ingrese solo digitos para Tel&eacute;fono" },
			direccion: { required: "Ingrese Direcci&oacute;n Domiciliaria" },
            asunto:{ required: "Ingrese Asunto de Mensaje" },
			mensaje:{ required: "Ingrese Descripci&oacute;n de Mensaje" },
...
{ 
	 ...
	 $("#saveinsumos").validate({
	  ...
	  function submitForm()
	   {		
				var data = $("#saveinsumos").serialize();
	  ...
	  function submitForm()
	   {		
	        ...
	        if (dineroefectivo==0.00 || dineroefectivo==0) {
				...
				$('#dineroefectivo').val("");
				$('#dineroefectivo').css('border-color','#2cabe3');
...
/* FUNCION JQUERY PARA VALIDAR REGISTRO DE ARQUEO DE CAJAS EN RESERVACIONES */	 
$('document').ready(function()
{ 
     /* validation */
	 $("#arqueoreservacion").validate({
      rules:
	  {
			codcaja: { required: true },
			fecharegistro: { required: true },
	  ...
	  function submitForm()
	   {		
				var data = $("#arqueoreservacion").serialize();
...
/*  FIN DE FUNCION PARA VALIDAR REGISTRO DE ARQUEO DE CAJAS EN RESERVACIONES */


/* FUNCION JQUERY PARA VALIDAR CERRAR ARQUEO DE CAJAS EN RESERVACIONES */	 
$('document').ready(function()
{ 
     /* validation */
	 $("#cierrareservacion").validate({
      rules:
	  {
			fecharegistro: { required: true },
			montoinicial: { required: true, number : true},
	  ...
	  function submitForm()
	   {		
				var data = $("#cierrareservacion").serialize();
				var dineroefectivo = $('#dineroefectivo').val();
...
/* FIN DE FUNCION PARA VALIDAR CERRAR ARQUEO DE CAJAS EN RESERVACIONES */
		...
		if (TotalPago==0.00) {
            ...
            return false;
				...
				success :  function(data)
                 ...
                 type: 'warning',
                 timeout: 5000, });
				$("#btn-submit").html('<span class="fa fa-print"></span> Regitrar');
				...
				$("#btn-submit").html('<span class="fa fa-print"></span> Regitrar');
                 ...
                 type: 'warning',
                 timeout: 5000, });
				$("#btn-submit").html('<span class="fa fa-print"></span> Registrar');
