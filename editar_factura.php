<?php
	...
	if (isset($_GET['id_factura']))
	{
		...
		$campos="clientes.id_cliente, clientes.nombre_cliente, clientes.rucid, clientes.telefono_cliente, clientes.email_cliente, facturas.id_vendedor, facturas.fecha_factura, facturas.condiciones, facturas.estado_factura, facturas.numero_factura";
		...
		?>
			<form class="form-horizontal" role="form" id="datos_factura">
				<div class="form-group row">
				  ...
				  <label for="rucid" class="col-md-1 control-label">RUC/ID</label>
							<div class="col-md-2">
								<input type="text" class="form-control input-sm" id="rucid" placeholder="Ruc / Id" value="<?php echo $rucid;?>" readonly>
							</div>
