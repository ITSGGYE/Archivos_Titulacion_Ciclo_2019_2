...
if ($cre18>0)
{
	...
	$sicre=1;
		...
		$estacre=0;
	$mysqli->query("INSERT INTO datoscredito (idcred,idcli,valcre,taza,pla,fecha,fechain,cuota,factu,perio,esta,idticue,idfpa,idven,hora)VALUES('$codicre1','$idcli','$cre18','$taz','$mes','$fecre','$fecre1','$cuota','$codicre','$ano','$estacre','$ticue','$forpa','$idve','$hora')" );	
...
header('Location: imprecuentas.php?mensaje='.urlencode($idcli).'&mensaje1='.($codicre1));
?>
