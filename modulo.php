...
document.formName.cedula2.value="";
    ...
    <div class="contentpanel">
      ...
      <div class="pull-left breadcrumb_admin clear_both">
        ...
        <div class="pull-left page_title theme_color">
          ...
          <h1>Registro de modulos del sistema </h1>
          <h2 class=""></h2>
        </div>
...
<table width="700"  align="center"   border="1">
  ...
  <tr>
    ...
    <td><input name="razon" type="text" class="field2" id="razon" onKeyPress="return soloLetras1(event); "    size="10" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td><div class="label">  
    ...
    <td><input name="descri" type="text" class="field2" id="descri" style="text-transform:capitalize;"  onkeypress="return soloLetras(event); " size="40" maxlength="60"  /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
...
<input name="codi" type="hidden" class="field2" id="codi" value="" /></td>
  ...
  <tr>
    <td><input name="curso" type="hidden" id="curso" ><input name="nombre2" type="hidden" id="nombre2" value="" /></td>
