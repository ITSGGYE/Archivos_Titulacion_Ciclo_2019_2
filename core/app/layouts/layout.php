    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg"><b>ORTAND</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="">
                      <a href="http://evilnapsis.com/" target="_blank" class=""></a>
                      <a href="http://evilnapsis.com/product/inventio-max/" target="_blank" class=""></a>
                  </li>
...
<div class="user-panel">
          ...
          <ul class="sidebar-menu">
            <li class="header">Magno & Asociados</li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="./?view=users">Ingresar</a></li>
    ...
    <?php endif;?>
      ...
      <div class="content">
        ...
        <strong>   <a href="Sistema realizado por ITSGG" target="_blank"></a></strong>
      </footer>
      <?php else:?>
<div class="login-box">
      <div class="login-logo">
        <a href="./"><b>Bienvenido a ORTAND S.A Ortega & Andrade Asociados</b></a>
      </div><!-- /.login-logo -->
