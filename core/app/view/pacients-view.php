...
<div class="card">
  ...
  <div class="card-content table-responsive">
	<a href="index.php?view=newpacient" class="btn btn-default"></i> Nuevo Paciente</a>
		<?php
		...
		if(count($users)>0){
			...
			foreach($users as $user){
				...
				<a href="index.php?view=delpacient&id=<?php echo $user->id;?>" class="btn btn-danger btn-xs" onclick="return confirmation()">Eliminar</a>
				</td>
				</tr>
				<?php
