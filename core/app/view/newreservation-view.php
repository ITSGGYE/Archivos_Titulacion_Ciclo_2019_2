...
<option value="">-- SELECCIONE --</option>
  <?php foreach($medics as $p):?>
    <option value="<?php echo $p->id; ?>"><?php echo $p->profe.". ".$p->name." ".$p->lastname; ?></option>
  <?php endforeach; ?>
</select>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-10">
    <textarea class="form-control" name="dosis" placeholder="Dosis medicinal"></textarea>
    </div> 
  </div>
  <div class="form-group">
...
<div class="input-group">
  <input type="number" class="form-control" name="peso" required placeholder="Peso en KG" step="any">
</div>
    </div>
  </div>
  <div class="form-group">
...
<div class="input-group">
  ...
  <input type="number" class="form-control" name="price" required placeholder="Costo" step="any">
</div>
    </div>
  </div>
  <div class="form-group">
