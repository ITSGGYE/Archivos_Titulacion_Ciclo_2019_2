...
<?php if ($_SESSION['acceso'] == "administrador" || $_SESSION["acceso"]=="secretaria" || $_SESSION["acceso"]=="recepcionista") {  ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group has-feedback">
                                    ...
                                    <input type="text" class="form-control" name="dni" id="dni" value="<?php echo $_SESSION['dni']; ?>" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Nº de Documento" autocomplete="off" readonly required="" aria-required="true"/> 
        ...
        <?php } else { ?>
                          ...
                          <div class="col-md-3">
                            <div class="form-group has-feedback">
                                ...
                                <input type="hidden" name="clave" id="clave" value="<?php echo $_SESSION['password']; ?>" />
                                <input type="text" class="form-control" name="dni" id="dni" value="<?php echo $_SESSION['dnicliente']; ?>" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Nº de Documento" autocomplete="off" readonly required="" aria-required="true"/> 
                                <i class="fa fa-bolt form-control-feedback"></i> 
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group has-feedback">
                                <label class="control-label">Usuario de Acceso: <span class="symbol required"></span></label>
                                <input type="text" class="form-control" name="usuario" id="usuario" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Usuario de Acceso" autocomplete="off" value="<?php echo $_SESSION['dnicliente']; ?>" readonly="" required="" aria-required="true"/>  
                                <i class="fa fa-user form-control-feedback"></i> 
                            </div>
                        </div>
