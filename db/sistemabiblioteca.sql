...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-03-2021 a las 18:32:50
...
(1, 'paul okendo', '', '1616820141.png', 1),
(2, 'Fausto', '', '', 1),
(3, 'Adrian', '', '', 1),
(4, 'Fernando', '', '', 1),
(5, 'Juan', '', '', 1);
...
(1, '12345671', '09567890', 'José Luis Montalvo', 'octavo', 'Av. Portete', '0922763412', '', 1),
(2, '12345672', '09874434', 'Yadira Castillo', 'Decimo', 'Av. Quito', '0978563312', '', 1);
...
INSERT INTO `libro` (`idlibro`, `titulo`, `cantidad_disponible`, `idautor`, `ideditorial`, `year_edicion`, `idmateria`, `numero_paginas`, `descripcion`, `imagen`, `condicion`) VALUES
(1, 'python', 3, 4, 1, '2020', 5, 74, '', '1616973414.png', 1),
(2, 'Curso de Programación Phyton', 12, 3, 2, '2019', 3, 430, '', '1577325959.jpeg', 1),
(3, 'Iniciación a la matemática universitaria', 10, 4, 3, '2019', 4, 250, '', '1577326347.jpeg', 1),
(4, 'La Salud principañ', 5, 5, 2, '2010', 6, 198, '', '1616973440.png', 1),
(5, 'pablo0', 3, 1, 1, '2020', 1, 70, '', '', 1),
(6, 'nuevo mundoo', 8, 1, 1, '2012', 1, 45, '', '', 1),
(7, 'python', 5, 1, 1, '2020', 1, 500, '', '', 1),
(8, 'Ingenieros civil', 6, 4, 1, '2020', 1, 50, '', '', 1);
...
(1, 'Introducción a la Ingeniería de Sistemass', '', 1),
...
(1, 2, 1, '2020-01-02', '2020-01-09', 1, NULL, 'Devuelto'),
(2, 4, 2, '2020-01-01', '2020-01-06', 2, NULL, 'Devuelto'),
(3, 1, 2, '2020-03-19', '2020-03-22', 1, '', 'Prestado');
...
INSERT INTO `usuario` (`idusuario`, `numero_trabajador`, `nombre`, `cargo`, `email`, `login`, `clave`) VALUES
(1, '0976543433', 'Administrador', 'Administrador', '', 'admin', 'admin');
