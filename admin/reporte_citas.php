...
title="click aqui"/>
 ...
 <!--   OTRO BOTON-->
  <button  type="button" class="btn btn-outline-light linea i" style="margin:10px 0px 0px 300px;  background:#717171;  ">
     ...
     <a href="fecha/fecha.php" class="btn btn-link" style="text-decoration-line:none;" > <img width="120" src="iconos/pdf.png" title="click aqui"/>
 <br><center><h5 class="i2 "> <strong>FECHAS</strong></h5></center>     </a> 
