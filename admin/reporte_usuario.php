...
?>
 ...
 <strong> REPORTES USUARIOS PDF</strong></center>
...
<center>
  <button type="button" class="btn btn-outline-light linea i " style="margin:10px 0px 0px 0px; background:#ff9177; ">
    
     <a href="reporte/pdf_administrador.php" class="btn btn-link" style="text-decoration-line:none;"   > 
<img src="iconos/pdf.png" width="120"
title="click aqui"/>


 <br> <h5 class="i2"> <strong>USUARIOS <br> ADMINISTRADORES</strong></h5>    </a> 


  </button>

 <!--   OTRO BOTON-->
  <button  type="button" class="btn btn-outline-light linea i" style="margin:10px 0px 0px 300px;  background:#717171;  ">
    
     <a href="reporte/pdf_paciente_usu.php" class="btn btn-link" style="text-decoration-line:none;"  >
<img src="iconos/pdf.png" width="120"
title="click aqui"/>
 <br> <h5 class="i2"> <strong>USUARIOS <br>PACIENTES</strong></h5>    </a> 
