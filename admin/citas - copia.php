...
<td>  
  ...
  <a  class="btn btn-info" style="color:white;" href="edita_cita.php?id=<?php echo $row->id_cita; ?>">Modificar</a></td>
...
<input  class="form-control" type="date" name="fecha" min="2019-01-01" max="2999-01-01">
...
<label for="">Hora (11:45-20:30)</label>
  <input  class="form-control" type="time" name="hora" min="11:45" max="20:30"  step="60" required >
 </div>
...
<div class="form-group">
 <label>Observaciones:</label>
                        <textarea placeholder="Observacion:" name="observacion"  class="form-control" ><?php echo $row->observacion; ?></textarea>
</div>

  
     <input type="hidden"  name="admin" value="<?php echo $_SESSION['nombre'] ?>">
