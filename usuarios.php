                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group has-feedback">
                            <label class="control-label">Nº de Documento de Identidad: <span class="symbol required"></span></label>
                  ...
                  <div class="col-md-3">
                        <div class="fileinput fileinput-new" data-provides="fileinput">
                           <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 60px; height: 60px;">
                            <?php echo "<img src='fotos/avatar.jpg' class='img-rounded' border='1' width='60' height='60' title='SIN FOTO' data-rel='tooltip'>"; ?>
                           </div>
                        <div>
