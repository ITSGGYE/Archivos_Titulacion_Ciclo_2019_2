...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-info">
                <h4 class="card-title text-white"><i class="fa fa-pencil"></i> Gestión de Habitaciones</h4>
            </div>
    ...
    <?php } ?>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group has-feedback">
                            <label class="control-label">Descripción de Habitación: <span class="symbol required"></span></label>
                    ...
                    <div class="col-md-3">
                        <div class="form-group has-feedback">
                            <label class="control-label">Vista de Habitación: <span class="symbol required"></span></label>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group has-feedback">
                            <label class="control-label">Costo de Habitación: <span class="symbol required"></span></label>
                            <i class="fa fa-bars form-control-feedback"></i>
                            <?php if (isset($reg[0]['codtarifa'])) { ?>
                            <select name="codtarifa" id="codtarifa" class='form-control' required="" aria-required="true">
                    ...
                    <div class="col-md-3">
                        <div class="form-group has-feedback">
                            ...
                            <i class="fa fa-bars form-control-feedback"></i>
                               ...
                               <select name="maxadultos" id="maxadultos" class='form-control' required="" aria-required="true">
                                <option value=""> -- SELECCIONE -- </option>
                    ...
                    <div class="col-md-3">
                        <div class="form-group has-feedback">
                            ...
                            <i class="fa fa-bars form-control-feedback"></i>
                               ...
                               <select name="maxninos" id="maxninos" class='form-control' required="" aria-required="true">
                                <option value=""> -- SELECCIONE -- </option>
...
<option value="5"<?php if (!(strcmp('5', $reg[0]['maxninos']))) {echo "selected=\"selected\"";} ?>>5</option>
                    ...
                    <div class="col-md-3">
                        <div class="form-group has-feedback">
                            <label class="control-label">Descuento de Habitación: <span class="symbol required"></span></label>
                            <input type="text" class="form-control" name="deschabitacion" id="deschabitacion" onKeyUp="this.value=this.value.toUpperCase();" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '2', '.', '')" placeholder="Ingrese Descuento de Habitación" autocomplete="off" <?php if (isset($reg[0]['deschabitacion'])) { ?> value="<?php echo $reg[0]['deschabitacion']; ?>" <?php } ?> required="" aria-required="true"/>  
