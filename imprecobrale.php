...
$codi=$_GET["mensaje"]; ///numero de recibo de pago
...
//sacamos datos de vendedor
	$nombrena =  "";
 	...
 	$result22 = $mysqli->query("select nomape from usuario where idusuario = '$idv'  ");
...
$resucre= $mysqli->query("SELECT * FROM credito WHERE reci = '".$codi."' ");
?>
...
Telefono</label></div></td>
    <td><span class="Estilo3"><?php print $telefono1; ?></span></td>
    </tr>
   <tr>
    <td><div class="label">  
    <label for="COD_DICC" class=""> 
...
Cuenta por cobrar #</label></div> </td>
    <td>
	<span class="Estilo4"><?php print $factucre; ?></span>
      ...
      <td>
        ...
        <?php print $coucre;?>
				 ...
				 <div class="searcherButtons">
						...
						<a href="cobracuenta.php?height=460&width=550&id=<?php echo $codicre;?>"><img src="grafico/nux.png"  /></a>
					
					
					<a href="informes/factucre1.php?height=460&width=550&id=<?php echo $codi;?>&amp;id1=<?php echo $codicre;?>"><img src="grafico/impd.png"  /></a>
  ...
  <tr>
    <td>
		<div class="sqlQueryContent">
					...
					<h3 align="center">Detalle de valores cancelados por el cliente </h3>  
					
                     
		
			<div class="directorioCentros">
		<div class="sqlQueryContent">
			<div class="elements">
...
Cobrador</label></div> </td>
    <td colspan="3">
	<span class="Estilo4"><?php print $nombrena1; ?></span></td>
  </tr>
  <tr>
    <td width="136"><div class="label">  
    <label for="COD_DICC" class=""> 
Recibo de Pago #</label></div> </td>
    <td width="125"><span class="Estilo4">
    <?php print $factu;?>
    </span></td>
    <td width="112"><div class="label">  
    <label for="COD_DICC" class=""> 
Fecha de Pago </label></div></td>
    <td width="189"><span class="Estilo4">
    <?php print $fecha;?>
    </span></td>
  </tr>
  <tr>
...
Cancelado</label></div></td>
    <td><span class="Estilo4"><?php print number_format($cancela, 2);?>
    </span></td>
    <td><div class="label">  
    <label for="COD_DICC" class=""> 
Adeuda</label></div></td>
    <td><span class="Estilo4"><?php print number_format($debe, 2);?>
    </span></td>
  </tr>
</table>
		...
		<div class="searcher sqlQuerySearcher">
							...
							<table border="1" width="100%"  style="background-color: #FFFFFF; width: 100%;  width: 100%;  margin-bottom: 20px; padding: 1px; line-height: 1.4; font-size:12px" >
		<thead>
			<tr>
...
while($row = $resucre->fetch_array() )
{
	...
	<td style="text-align:right"><?php echo $copro;?> </td>
