...
return retorno;
 ...
 if(key == especiales[i]){
	...
	var decripcion11 = document.getElementById("descri");
         ...
         alert('Digite descripcion del programa');
		 document.formName.descri.focus();
		 return false;
    }
			...
			if (ajax.readyState == 4){
				...
				if (jugador.value == 1 || jugador.value == 2 )
				{
								...
								if (jugador.value == 1 )
								{
									...
									window.alert("Favor revise descripcion del programa esye dato ya existe");
  ...
  <?php include "menu.php";?>	
    ...
    <div class="page-content">
	 ...
	 <form method="post" name="formName" action="" onSubmit="enviarDatos(); return false">	   
		   <table width="867">
  <tr>
    <td width="280">Programa Descripcion</td>
    <td width="320" colspan="2"><input name="descri" type="text" class="field2" id="descri" style="height:19px;"  size="40" maxlength="60"  /></td>
    <td width="245"></td>
  </tr>
  <tr>
    <td><input name="cedula2" type="hidden" size="5" class="field2" id="cedula2"  value="" />
      ...
      <input name="op" type="hidden" size="5" class="field2" id="op" value="3" />
