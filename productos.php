...
<?php if ($_SESSION['acceso'] == "administrador" || $_SESSION['acceso'] == "secretaria" || $_SESSION['acceso'] == "recepcionista") { ?><button type="button" class="btn waves-effect waves-light btn-light" data-placement="left" title="Carga Masiva" data-original-title="" data-href="#" data-toggle="modal" data-target="#myModall" data-backdrop="static" data-keyboard="false"><span class="fa fa-cloud-upload"></span> Cargar</font></button><?php } ?>
