...
<html lang="es-419"><!--<![endif]--><head dir="ltr"><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
      ...
      <title>
       Inicio de sesion | Sistema Turistico
      </title>
  

  <link rel="icon" type="image/x-icon" href="dibujo/logo.ico">
  ...
  <header class="global " aria-label="Global Navigation">
    ...
    <ol class="left nav-global">
          ...
          <li class="nav-global-04">
            <a class="cta cta-register" href="#">GESTIÓN ADMINISTRATIVA DE FLOTAS TURÍSTICAS</a>
          </li>
    </ol>
