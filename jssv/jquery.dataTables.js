...
(function($, window, document) {
	 ...
	 *   sFeature: Feature name - just for completeness :-)Mostrar
	 */
	_oExt.aoFeatures = [ ];
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			 ...
			 * Scope:    jQuery.dataTable.classSettings
			 * Notes:    The words in the format _VAR_ are variables which are dynamically replaced _MENU_
			 *   by javascript
			 */
			this.oLanguage = {
				...
				"sEmptyTable": "No se han registrado datos",
				"sInfo": "",
