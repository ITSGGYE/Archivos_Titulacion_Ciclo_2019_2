...
table.page_footer {width: 50%; border: none; background-color: white; padding: 2mm;border-collapse:collapse; border: none;}
}
-->
</style>
<page backtop="12mm" backbottom="12mm" backleft="10mm" backright="120mm" style="font-size: 12pt; font-family: arial" >
        <page_footer>
    ...
    <table cellspacing="0" style="width: 100%;">
        <tr>
			...
			<td style="width: 30%; color: #34495e;font-size:8px;text-align:center">
                <span style="color: #34495e;font-size:10px;font-weight:bold"><?php echo NOMBRE_EMPRESA;?></span>
				<br><?php echo RUC_ID;?><br> 
			...
			ORDEN DE PEDIDO Nº <?php echo $numero_factura;?>
			</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 7pt;">
        <tr>
           <td style="width:%;" class='midnight-blue'>NOTA DE VENTA A</td>
        </tr>
		<tr>
           <td style="width:40%;" >
			<?php 
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 7pt;">
        <tr>
            ...
            <th style="width: 55%" class='midnight-blue'>DESCRIPCION</th>
