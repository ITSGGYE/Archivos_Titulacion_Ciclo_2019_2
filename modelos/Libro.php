...
Class Libro
{
	...
	{
		$sql="INSERT INTO libro (titulo,cantidad_disponible,idautor,ideditorial,year_edicion,idmateria,numero_paginas,descripcion,imagen,condicion)
	...
	{
		$sql="SELECT l.idlibro,l.titulo,l.cantidad_disponible,l.idautor,a.nombre as autor,l.ideditorial,e.nombre as editorial,l.year_edicion,l.idmateria,m.nombre as materia,l.numero_paginas,l.descripcion,l.imagen,l.condicion FROM libro l INNER JOIN autor a on l.idautor=a.idautor INNER JOIN editorial e ON l.ideditorial=e.ideditorial INNER JOIN materia m ON l.idmateria=m.idmateria";
		return ejecutarConsulta($sql);		
	}
