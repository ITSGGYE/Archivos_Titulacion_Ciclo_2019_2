...
$opas=1;
	...
	$result22 = $mysqli->query("select tipoclie from tipoclie where idtipo = '$idpro'  ");
    ...
    <div class="contentpanel">
      ...
      <div class="pull-left breadcrumb_admin clear_both">
        ...
        <div class="pull-left page_title theme_color">
          ...
          <h1>Edicion  de tipo de cliente </h1>
          <h2 class=""></h2>
        </div>
...
Tipo de Cliente</label> 
    ...
    <td><input name="nombre" type="text" class="success" id="nombre" onKeyPress="return soloLetras(event); " value="<?php print $nombre; ?>" maxlength="30" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
