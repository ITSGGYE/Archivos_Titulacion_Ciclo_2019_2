    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-info">
                <h4 class="card-title text-white"><i class="fa fa-pencil"></i> Gestión de Noticias</h4>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group has-feedback">
                                ...
                                <select name="statusnoticia" id="statusnoticia" class="form-control" required="" aria-required="true">
