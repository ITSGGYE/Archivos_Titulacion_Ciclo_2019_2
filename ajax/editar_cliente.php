<?php
	...
	if (empty($_POST['mod_id'])) {
		...
		$rucid=mysqli_real_escape_string($con,(strip_tags($_POST["mod_rucid"],ENT_QUOTES)));
		...
		$sql="UPDATE clientes SET nombre_cliente='".$nombre."', rucid='".$rucid."', telefono_cliente='".$telefono."', email_cliente='".$email."', direccion_cliente='".$direccion."', status_cliente='".$estado."' WHERE id_cliente='".$id_cliente."'";
