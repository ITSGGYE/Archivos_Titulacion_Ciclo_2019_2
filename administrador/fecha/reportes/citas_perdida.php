						...
						<div   class="wrapp">
							<article class="articles" >
								...
								<div class="table-responsive"> 
									<table id="example" class="table table-striped table-bordered table-hover  text-dark" style="text-align: center; font-weight: bold;"   >
										...
										<div id="datatable_length">
											...
											<a onClick="javascript:reportePDF();" class="btn-sm btn-danger" style="padding: 6px 15px; cursor: pointer; position: relative; text-decoration: none; ">Exportar PDF<span><img src="../cargando.gif" class="cargando hide"></span></a>
										</div>
									</div>
									<br><br>
								</div>
								<div class="row">
									...
									<tbody id="actualizar">
										<?php include('../includes/imprimir_bitacoracitas_perdida.php'); ?>
									</tbody>
								</div>
							</table>
						</div>
					...
					<script type="text/javascript">
						(function(){	
							$('#rango_fecha').on('click',function(){
								...
								var url = '../dao/busca_por_fechacitaperdida.php';
								$.ajax({
									type:'POST',
									url:url,
						...
						function reportePDF(){
							var desde = $('#bd-desde').val();
							var hasta = $('#bd-hasta').val();
							var url = '../dao/exportarcitaperdida_pdf.php';
							...
							$.ajax({
								...
								success: function(datos){
									...
									PDFObject.embed("../temp/reportes.pdf", "#view_pdf");
								}
							});
							return false;
						}
