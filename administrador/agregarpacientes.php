                ...
                <div class="modal-body">
                 ...
                 <form action="guardar_paciente.php" method="POST" enctype="multipart/form-data">
                  <div class="form-group">
                    ...
                    <input type="text" name="cedula" class="form-control" placeholder="Ingresar Cedula"  minlength="10" maxlength="10" onKeyPress="return SoloNumeros(event);" required>
                  </div>
                  <div class="form-group">
                    <label for="">NOMBRE PACIENTE</label>
                    <input type="text" name="nombre" class="form-control" placeholder="Ingresar Nombre Paciente"  inlength="10" maxlength="60" onkeypress="return soloLetras(event);" required>
                  </div>
                  <div class="form-group">
                    <label for="">Telefono</label>
                    <input type="text" name="telefono" id="telefono" class="form-control" placeholder=" Telefono"   maxlength="10" onKeyPress="return SoloNumeros(event);" required  >
                  </div>
                  <div class="form-group">
