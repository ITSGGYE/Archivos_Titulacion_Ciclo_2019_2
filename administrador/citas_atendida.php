               ...
               <div class="modal fade" id="editar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    ;color:white;letter-spacing: 10px;" class="alert "><strong> <h5 style="font-size:15px;  font-weight: bold; color:white" class="modal-title" id="exampleModalLabel"><center>EDITAR CITAS ATENDIDAS</center></h5></strong></div>
                  ...
                  <div class="modal-body">
                   ...
                   <form action="editar_citas.php" method="POST" >
                    ...
                    <div class="form-group">
                      ...
                      <input  class="form-control" type="date" name="fecha" id="fecha" class="form-control">
                    </div>
                    <div class="form-group">
                      <label for="">Hora (11:45-20:30)</label>
                      <input  class="form-control" type="time" name="hora" id="hora" value="11:45" max="20:30" min="08:00" step="60" required>
                    </div>
                    <div class="form-group">
                      <label for="">ESTADO</label>
                      <select name="estado" id="estado" class="form-control" >
                        <option  value="Atendido">Atendido</option>
<!--<option  value="cita_perdida">Cita_Perdida</option>
...
<div class="form-group">
 ...
 <textarea   placeholder="Observacion:" name="observacion" id="observacion" class="form-control"></textarea>
</div>
...
<div class="modal fade" id="eliminar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <!----- Formulario  ---->
       <form action="eliminar_citas_atendida.php" method="POST" >
...
</div>  <!--/.main-->  <script src="js/jquery-1.11.1.min.js"></script>
