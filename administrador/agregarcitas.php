            ...
            <div   class="wrapp">
              <article class="articles" >
               ...
               <div class="modal-body">
                 <!----- Formulario  ---->
                 <form action="guardar_citas.php" method="POST" enctype="multipart/form-data">
                    <?php
...
//print_r($var);
                    ...
                    <select name="nombre"  id="controlBuscador" style="width: 100%;"  required>
                  ...
                  <div class="form-group">
                    ...
                    <select name="nombrecapa" id="nombrecapa" class="form-control" required/>
              ...
              <div class="form-group">
                ...
                <input  class="form-control" min="<?php echo date("Y-m-d");?>" type="date" name="fecha" value="<?php echo date("Y-m-d");?>" class="form-control"  >
              </div>
              <?php
              date_default_timezone_set('America/Guayaquil');
              ?>
              ...
              <div class="form-group">
                ...
                <select name="hora" id="hora" class="form-control"  >
                  <option   readonly >Seleccionar Hora</option>
          ...
          $sentencia=$bd->query("SELECT * 
            FROM 
            administrador WHERE usuario= '".$_SESSION['nombre']."'
            ;");
//FecthAll va devolver todas las filas de la base de dato (::)accede a elemtos estatico y costantes y metodos de una clase , fecth_obl devuelve la fila de cada columna 
