...
<button type="button" class="btn btn-info btn-rounded" data-placement="left" title="Editar" onClick="UpdateCliente('<?php echo $reg[$i]["codcliente"]; ?>','<?php echo $reg[$i]["documcliente"]; ?>','<?php echo $reg[$i]["dnicliente"]; ?>','<?php echo $reg[$i]["nomcliente"]; ?>','<?php echo $reg[$i]["paiscliente"]; ?>','<?php echo $reg[$i]["ciudadcliente"]; ?>','<?php echo $reg[$i]["direccliente"]; ?>','<?php echo $reg[$i]["telefcliente"]; ?>','<?php echo $reg[$i]["correocliente"]; ?>','<?php echo $reg[$i]["limitecredito"]; ?>','update')"><i class="fa fa-edit"></i></button>
...
<button type="button" class="btn btn-info btn-rounded" data-placement="left" title="Editar" onClick="UpdateInsumo('<?php echo $reg[$i]["codinsumo"]; ?>','<?php echo $reg[$i]["insumo"]; ?>','<?php echo $reg[$i]["codcategoria"]; ?>','<?php echo $reg[$i]["preciocompra"]; ?>','<?php echo $reg[$i]["precioventa"]; ?>','<?php echo $reg[$i]["existencia"]; ?>','<?php echo $reg[$i]["stockminimo"]; ?>','<?php echo $reg[$i]["ivainsumo"]; ?>','<?php echo $reg[$i]["descinsumo"]; ?>','<?php echo $reg[$i]['fechaexpiracion'] == '0000-00-00' ? "0000-00-00" : date("d-m-Y",strtotime($reg[$i]['fechaexpiracion'])); ?>','<?php echo $reg[$i]['codproveedor'] == '' ? "0" : $reg[$i]['codproveedor']; ?>','<?php echo $reg[$i]["lote"]; ?>','update')"><i class="fa fa-edit"></i></button>
...
<button type="button" class="btn btn-info btn-rounded" data-placement="left" title="Editar" onClick="UpdateSalidaInsumo('<?php echo $reg[$i]["codsalida"]; ?>','<?php echo $reg[$i]["codinsumo"]; ?>','<?php echo $reg[$i]["codinsumo"]." | ".$reg[$i]["insumo"]." | ".$reg[$i]["nomcategoria"]; ?>','<?php echo $reg[$i]["responsable"]; ?>','<?php echo $reg[$i]["existencia"]; ?>','<?php echo $reg[$i]["cantsalida"]; ?>','update')"><i class="fa fa-edit"></i></button>
...
<!--<button type="button" class="btn btn-info btn-rounded" onClick="UpdateReservacion('<?php echo encrypt($reg[$i]["codreservacion"]); ?>')" title="Editar" ><i class="fa fa-edit"></i></button>-->
...
<script src="assets/plugins/datatables/advance/datatable-advanced.init.js"></script>-->
