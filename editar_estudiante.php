    ...
    try {
        ...
        $statement = "UPDATE titulacion_6to_c.tb_registro_estudiante SET est_nombres = ";
        ...
        $statement = $statement.", est_trabaja = ";
        $statement = $statement."'".$_POST["est_trabaja"]."'";
        ...
        if($conexion->query($statement)){
            ...
            echo "<script>alert('ESTUDIANTE ACTUALIZADO CON EXITO');
            window.location.href='historial_estudiante.php?func=mostrar'</script>";
        }
...
$query = "SELECT * FROM titulacion_6to_c.tb_registro_estudiante WHERE est_cedula = :CEDULA";
...
<head>
    ...
    <title>Fundación Ecuador People - Editar datos de estudiante</title>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 d-none d-xl-block">
                    <nav class="mainmenu alignright">
                        <ul>
                            <li class="active"><a style="color: yellow;" href="historial_estudiante.php?func=mostrar">Volver Atrás</a></li>
            ...
            <div class="col-lg-10 m-auto">
                <div class="contact-form">
                    ...
                    <center><img src="imagen/mega-menu.jpg" style="width: 30%; border-radius: 5px;">
                        <h4 style="color: #0A91E4;">Editar registro de información de Estudiante
                        </h4></center>
                    <br>
                    <form style="color:#0A91E4;" enctype="multipart/form-data" action="" method="POST">
                        <div class="form-row">
                            <div class="col-lg-2 col-md-3">
                                <input onkeypress="return soloNumeros(event);" id="est_cedula" type="text" name="est_cedula" maxlength="10"
                                       value="<?php echo $row['est_cedula']; ?>" readonly>
                                <label for="est_cedula">Cedula/Pasaporte:</label>
                            </div>

                            <div class="col-lg-4 col-md-3">
                                <input onkeypress="return soloLetras(event);" id="est_nombres" type="text" name="est_nombres" value="<?php echo $row['est_nombres']; ?>"
                                       required>
                                <label for="est_nombres">Nombres: </label>
                            </div>

                            <div class="col-lg-4 col-md-3">
                                <input onkeypress="return soloLetras(event);" id="est_apellidos" name="est_apellidos" value="<?php echo $row['est_apellidos']; ?>"
                                       type="text" required>
                            ...
                            <div class="col-lg-2 col-md-3">
                                <input onkeypress="return soloNumeros(event);" id="est_convencional" name="est_convencional"
                                       value="<?php echo $row['est_convencional']; ?>" maxlength="9" type="text" required>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-lg-4 col-md-3">
                                <input onkeypress="return soloMail(event);" id="est_correo" name="est_correo" value="<?php echo $row['est_correo']; ?>" type="text"
                                       required>
                                <label for="est_correo">Correo Electronico: </label>
                            </div>

                            <div class="col-lg-4 col-md-3">
                                <input onkeypress="return soloMail(event);" id="est_direccion" name="est_direccion" value="<?php echo $row['est_direccion']; ?>"
                                       type="text" required>
                            ...
                            <div class="col-lg-2 col-md-3">
                                ...
                                <label for="est_fecha_nacimiento">Nacimiento: </label>
                            </div>
                        </div>

                        <div class="form-row">
                            <div class="col-lg-1 col-md-3">
                                <input onkeypress="return soloNumeros(event);" id="est_edad" name="est_edad" value="<?php echo $row['est_edad']; ?>" type="text" required>
                                <label for="est_edad">Edad: </label>
                            </div>

                            <div class="col-lg-3 col-md-3">
                                <input onkeypress="return soloLetras(event);" id="est_enfermedad" name="est_enfermedad" value="<?php echo $row['est_enfermedad']; ?>"
                                       type="text" required>
                                <label for="est_enfermedad">Enfermedad: </label>
                            </div>

                            <div class="col-lg-3 col-md-3">
                                <input onkeypress="return soloLetras(event);" id="est_alergias" name="est_alergias" value="<?php echo $row['est_alergias']; ?>"
                                       type="text" required>
                                <label for="est_alergias">Alergia: </label>
                            </div>

                            <div class="col-lg-1 col-md-3">
                                <input onkeypress="return soloLetras(event);" id="est_tipo_sangre" name="est_tipo_sangre" value="<?php echo $row['est_tipo_sangre']; ?>"
                                       type="text" required>
                                <label for="est_tipo_sangre">Sangre: </label>
                            </div>

                            <div class="col-lg-2 col-md-3">
                                <input onkeypress="return soloLetras(event);" id="est_genero" name="est_genero" value="<?php echo $row['est_genero']; ?>" type="text"
                                       required>
                                <label for="est_genero">Genero: </label>
                            </div>

                            <div class="col-lg-2 col-md-3">
                                <input onkeypress="return soloLetras(event);" id="est_curso" name="est_curso" value="<?php echo $row['est_curso']; ?>" type="text"
                                       required>
                        ...
                        <div class="form-row">
                            <div class="col-lg-2 col-md-3">
                                <input onkeypress="return soloLetras(event);" id="est_jornada" name="est_jornada" value="<?php echo $row['est_jornada']; ?>" type="text"
                                       required>
                                <label for="est_jornada">Jornada: </label>
                            </div>

                            <div class="col-lg-3 col-md-3">
                                <input onkeypress="return soloLetras(event);" id="est_provincia" name="est_provincia" value="<?php echo $row['est_provincia']; ?>"
                                       type="text" required>
                                <label for="est_provincia">Provincia de Nacimiento: </label>
                            </div>

                            <div class="col-lg-2 col-md-3">
                                <input onkeypress="return soloLetras(event);" id="est_ciudad" name="est_ciudad" type="text" value="<?php echo $row['est_ciudad']; ?>"
                                       required>
                                <label for="est_ciudad">Ciudad de recidencia: </label>
                            </div>

                            <div class="col-lg-1 col-md-3">
                                <input onkeypress="return soloLetras(event);" id="est_trabaja" name="est_trabaja" type="text" value="<?php echo $row['est_trabaja']; ?>"
                                       required>
                                <label for="est_trabaja">Trabaja: </label>
                            </div>

                            <div class="col-lg-2 col-md-3">
                                <input onkeypress="return soloLetras(event);" id="est_vive" name="est_vive" type="text" value="<?php echo $row['est_vive']; ?>" required>
                        ...
                        <div class="form-row">
                            <div class="col-lg-2 col-md-3">
                                <input onkeypress="return soloLetras(event);" id="est_civil" name="est_civil" type="text" value="<?php echo $row['est_civil']; ?>"
                                       required>
                                <label for="est_civil">Estado Civil: </label>
                            </div>

                            <div class="col-lg-1 col-md-3">
                                <input onkeypress="return soloLetras(event);" id="est_hijos" name="est_hijos" value="<?php echo $row['est_hijos']; ?>" type="text"
                                       required>
                                <label for="est_hijos">Hijos: </label>
                            </div>

                            <div class="col-lg-3 col-md-3">
                                <input onkeypress="return soloLetras(event);" id="est_nombre_ref" name="est_nombre_ref" value="<?php echo $row['est_nombre_ref']; ?>"
                                       type="text" required>
                                <label for="est_nombre_ref">Nombre de referencia: </label>
                            </div>

                            <div class="col-lg-4 col-md-3">
                                <input id="est_apellidos_ref" name="est_apellidos_ref"
                                       value="<?php echo $row['est_apellidos_ref']; ?>" type="text" required>
                                <label for="est_apellidos_ref">Apellidos de referencia: </label>
                            </div>

                             <div class="col-lg-2 col-md-3">
                                <input onkeypress="return soloNumeros(event);" id="est_cedula_ref" name="est_cedula_ref" value="<?php echo $row['est_cedula_ref']; ?>"
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-lg-4 col-md-3">
                                <input onkeypress="return soloMail(event);" id="est_correo_ref" name="est_correo_ref" value="<?php echo $row['est_correo_ref']; ?>"
                                       type="text" required>
                            ...
                            <div class="col-lg-2 col-md-3">
                                <input id="est_fecha" name="est_fecha" value="<?php echo $row['est_fecha']; ?>" type="text"
                                       readonly="">
...
<section id="footer-area">
    ...
    <div class="container">
        ...
        <p>Copyright &copy;<script>document.write(new Date().getFullYear());</script>Fundación Ecuador People - C.C Design</p>
        </div>
        </div>
        </div>
    </div>
