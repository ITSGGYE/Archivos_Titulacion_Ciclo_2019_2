...
<body class="dark_theme  fixed_header left_nav_fixed">
  ...
  <?php include "menu.php";?>	
    ...
    <div class="page-content">
				 ...
				 <table class="display table-bordered table-striped" id="dynamic-table">
                  <thead>
                    <tr>
					  ...
					  <th width="50"><div align="center">#Cuenta</div></th>
							<th width="93"><div align="center">Cliente</div></th>
							<th width="50"><div align="center">Fec. Ing.</div></th>
							...
							<th width="55"><div align="center">Cobranza</div></th>
	 ...
	 <a href="cobracuentas.php?mensaje=<?php echo $datocliente['idcred'];?> " ><img src="images/ver.png" title="Modificar" alt="Editar" /></a>
    ...
    <a href="javascript:void(0);" target="_parent" onClick="window.open('vercuentas.php?mensaje1='+<?php echo $datocliente['idcred'];?>, 'popup', 'left=90, location=no, directories=no, status=no, menubar=no, top=80, width=1150, height=550, toolbar=0, resizable=1')"><img src="images/ver.png" title="Modificar" alt="Editar" /></a> 
