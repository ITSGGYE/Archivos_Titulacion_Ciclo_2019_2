# +===================================================================
# | Generado el 03-11-2019 a las 03:21:56 PM 
# | Servidor: localhost
# | MySQL Version: 5.5.5-10.1.38-MariaDB
# | PHP Version: 7.3.4
# | Base de datos: 'softhotel'
# | Tablas: abonoscreditos;  abonoscreditosreservaciones;  abonoscreditosventas;  arqueocaja;  cajas;  categorias;  clientes;  compras;  configuracion;  creditosxclientes;  detallecompras;  detallereservaciones;  detalleventas;  documentos;  entrada_insumos;  habitaciones;  impuestos;  insumos;  kardex_insumos;  kardex_productos;  log;  mediospagos;  mensajes;  movimientoscajas;  noticias;  perfil;  productos;  proveedores;  reservaciones;  salida_insumos;  servicios;  tarifas;  temporadas;  tiposcambio;  tiposhabitaciones;  tiposmoneda;  usuarios;  ventas
# +-------------------------------------------------------------------
...
# | Vaciado de tabla 'abonoscreditosreservaciones'
# +-------------------------------------
DROP TABLE IF EXISTS `abonoscreditosreservaciones`;


# | Estructura de la tabla 'abonoscreditosreservaciones'
# +-------------------------------------
...
# | Carga de datos de la tabla 'abonoscreditosreservaciones'
# +-------------------------------------
...
COMMIT;
INSERT IGNORE INTO `clientes` (`idcliente`, `codcliente`, `documcliente`, `dnicliente`, `nomcliente`, `paiscliente`, `ciudadcliente`, `direccliente`, `telefcliente`, `correocliente`, `passwordcliente`, `limitecredito`, `fechaingreso`) VALUES 
...
COMMIT;
INSERT IGNORE INTO `configuracion` (`id`, `documgerente`, `cedgerente`, `nomgerente`, `tlfgerente`, `direcgerente`, `documenhotel`, `nrohotel`, `nomhotel`, `tlfhotel`, `direchotel`, `emailhotel`, `categoriahotel`, `nroactividad`, `iniciofactura`, `fechaautorizacion`, `llevacontabilidad`, `acerca`, `metodopago`, `dsctor`, `dsctov`, `codmoneda`, `codmoneda2`) VALUES 
...
COMMIT;
INSERT IGNORE INTO `creditosxclientes` (`codcredito`, `codcliente`, `montocredito`) VALUES 
      ('1', 'C1', '0.00');
COMMIT;
...
# | Vaciado de tabla 'detallereservaciones'
# +-------------------------------------
DROP TABLE IF EXISTS `detallereservaciones`;


# | Estructura de la tabla 'detallereservaciones'
# +-------------------------------------
CREATE TABLE `detallereservaciones` (
  `coddetallereservacion` int(11) NOT NULL AUTO_INCREMENT,
  `codreservacion` varchar(30) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  ...
  PRIMARY KEY (`coddetallereservacion`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
                
# | Carga de datos de la tabla 'detallereservaciones'
# +-------------------------------------

COMMIT;
INSERT IGNORE INTO `detallereservaciones` (`coddetallereservacion`, `codreservacion`, `codhabitacion`, `adultos`, `children`, `desde`, `hasta`, `deschabitacion`, `valortotal`, `totaldescuento`, `valorneto`, `fechadetalle`) VALUES 
...
COMMIT;
INSERT IGNORE INTO `detalleventas` (`coddetalleventa`, `codventa`, `codproducto`, `cantventa`, `preciocompra`, `precioventa`, `ivaproducto`, `descproducto`, `valortotal`, `totaldescuentov`, `valorneto`, `valorneto2`) VALUES 
...
# | Vaciado de tabla 'entrada_insumos'
# +-------------------------------------
DROP TABLE IF EXISTS `entrada_insumos`;


# | Estructura de la tabla 'entrada_insumos'
# +-------------------------------------
...
# | Carga de datos de la tabla 'entrada_insumos'
# +-------------------------------------

COMMIT;
INSERT IGNORE INTO `entrada_insumos` (`identrada`, `codentrada`, `codinsumo`, `precioentrada`, `cantentrada`, `fechaexpiracion`, `codproveedor`, `fechaentrada`) VALUES 
      ('1', 'C1', 'I1', '0.00', '5', '0000-00-00', '0', '2019-09-01'), 
      ('2', 'C2', 'I5', '0.00', '12', '0000-00-00', '0', '2019-09-01'), 
      ('3', 'C3', 'I5', '0.00', '6', '0000-00-00', '0', '2019-09-01');
COMMIT;

# | Vaciado de tabla 'habitaciones'
# +-------------------------------------
DROP TABLE IF EXISTS `habitaciones`;


# | Estructura de la tabla 'habitaciones'
# +-------------------------------------
...
# | Carga de datos de la tabla 'habitaciones'
# +-------------------------------------

COMMIT;
INSERT IGNORE INTO `habitaciones` (`idhabitacion`, `codhabitacion`, `numhabitacion`, `descriphabitacion`, `piso`, `vista`, `maxadultos`, `maxninos`, `codtarifa`, `deschabitacion`, `statushab`) VALUES 
...
# | Carga de datos de la tabla 'insumos'
# +-------------------------------------

COMMIT;
INSERT IGNORE INTO `insumos` (`idinsumo`, `codinsumo`, `insumo`, `codcategoria`, `preciocompra`, `precioventa`, `existencia`, `stockminimo`, `ivainsumo`, `descinsumo`, `fechaexpiracion`, `codproveedor`, `lote`) VALUES 
...
# | Vaciado de tabla 'kardex_insumos'
# +-------------------------------------
DROP TABLE IF EXISTS `kardex_insumos`;


# | Estructura de la tabla 'kardex_insumos'
# +-------------------------------------
...
# | Carga de datos de la tabla 'kardex_insumos'
# +-------------------------------------

COMMIT;
INSERT IGNORE INTO `kardex_insumos` (`codkardex`, `codproceso`, `codresponsable`, `codinsumo`, `movimiento`, `entradas`, `salidas`, `devolucion`, `stockactual`, `ivainsumo`, `descinsumo`, `precio`, `documento`, `fechakardex`) VALUES 
...
# | Carga de datos de la tabla 'mensajes'
# +-------------------------------------
...
# | Carga de datos de la tabla 'noticias'
# +-------------------------------------

COMMIT;
INSERT IGNORE INTO `noticias` (`codnoticia`, `titulonoticia`, `descripcnoticia`, `publicado`, `statusnoticia`, `codigo`) VALUES 
...
COMMIT;
INSERT IGNORE INTO `perfil` (`codperfil`, `nomperfil`, `descperfil`) VALUES 
...
COMMIT;
INSERT IGNORE INTO `productos` (`idproducto`, `codproducto`, `producto`, `codcategoria`, `preciocompra`, `precioventa`, `existencia`, `stockminimo`, `stockmaximo`, `ivaproducto`, `descproducto`, `codigobarra`, `fechaelaboracion`, `fechaexpiracion`, `codproveedor`, `lote`, `stockteorico`, `motivoajuste`) VALUES 
...
COMMIT;
INSERT IGNORE INTO `proveedores` (`idproveedor`, `codproveedor`, `documproveedor`, `cuitproveedor`, `nomproveedor`, `tlfproveedor`, `direcproveedor`, `emailproveedor`, `vendedor`, `tlfvendedor`, `fechaingreso`) VALUES 
...
# | Vaciado de tabla 'reservaciones'
# +-------------------------------------
...
# | Vaciado de tabla 'salida_insumos'
# +-------------------------------------
DROP TABLE IF EXISTS `salida_insumos`;


# | Estructura de la tabla 'salida_insumos'
# +-------------------------------------
...
# | Carga de datos de la tabla 'salida_insumos'
# +-------------------------------------

# | Vaciado de tabla 'servicios'
# +-------------------------------------
...
# | Carga de datos de la tabla 'servicios'
# +-------------------------------------

COMMIT;
INSERT IGNORE INTO `servicios` (`codservicio`, `descripcionservicio`) VALUES 
      ('1', 'ACCESO A INTERNET'), 
      ('2', 'CAJA DE SEGURIDAD'), 
      ('3', 'SERVICIO DE LAVANDERIA'), 
      ('4', 'AIRE ACONDICIONADO'), 
...
CREATE TABLE `tarifas` (
  `codtarifa` int(11) NOT NULL AUTO_INCREMENT,
...
# | Carga de datos de la tabla 'tarifas'
# +-------------------------------------

COMMIT;
INSERT IGNORE INTO `tarifas` (`codtarifa`, `codtipo`, `baja`, `media`, `alta`) VALUES 
      ('1', '1', '10.00', '15.00', '20.00'), 
      ('2', '2', '18.00', '28.00', '38.00'), 
      ('3', '3', '24.00', '42.00', '45.00');
COMMIT;

# | Vaciado de tabla 'temporadas'
# +-------------------------------------
DROP TABLE IF EXISTS `temporadas`;


# | Estructura de la tabla 'temporadas'
# +-------------------------------------
CREATE TABLE `temporadas` (
  `codtemporada` int(11) NOT NULL AUTO_INCREMENT,
...
# | Carga de datos de la tabla 'temporadas'
# +-------------------------------------

COMMIT;
INSERT IGNORE INTO `temporadas` (`codtemporada`, `temporada`, `desde`, `hasta`) VALUES 
...
# | Vaciado de tabla 'tiposhabitaciones'
# +-------------------------------------
DROP TABLE IF EXISTS `tiposhabitaciones`;


# | Estructura de la tabla 'tiposhabitaciones'
# +-------------------------------------
...
# | Carga de datos de la tabla 'tiposhabitaciones'
# +-------------------------------------

COMMIT;
INSERT IGNORE INTO `tiposhabitaciones` (`codtipo`, `nomtipo`) VALUES 
...
COMMIT;
INSERT IGNORE INTO `usuarios` (`codigo`, `dni`, `nombres`, `sexo`, `direccion`, `telefono`, `email`, `usuario`, `password`, `nivel`, `status`) VALUES 
      ...
      ('2', '18633174', 'RUBEN DARIO CHIRINOS RODRIGUEZ', 'MASCULINO', 'SANTA CRUZ DE MORA', '(0414) 7225970', 'ELSAIYA@GMAIL.COM', 'RUBENCHIRINOS', '3ee657cddb83008a70c1701814c36989456c64e6', 'ADMINISTRADOR(A)', '1'), 
      ('3', '16317737', 'MARBELLA PAREDES MARQUEZ', 'FEMENINO', 'SANTA CRUZ DE MORA', '(0416) 3422924', 'PAREDESMARQUEZMARBELLA@GMAIL.COM', 'MARBELLAPAREDES', '3721ad498dd15cea0235827e328a0f5814ece591', 'RECEPCIONISTA', '1'), 
...
COMMIT;
INSERT IGNORE INTO `ventas` (`idventa`, `tipodocumento`, `codcaja`, `codventa`, `codserie`, `codautorizacion`, `codcliente`, `subtotalivasi`, `subtotalivano`, `iva`, `totaliva`, `descuento`, `totaldescuento`, `totalpago`, `totalpago2`, `tipopago`, `formapago`, `montopagado`, `montodevuelto`, `fechavencecredito`, `fechapagado`, `statusventa`, `fechaventa`, `observaciones`, `codigo`) VALUES 
