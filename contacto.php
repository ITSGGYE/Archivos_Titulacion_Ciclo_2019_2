...
<head> <link rel=icon href='img/logo.jpg' sizes="32x32" type="image/ico">
	...
	<link rel="stylesheet" href="contact-form/css/font-awesome.min.css">
	<!-- Template Main Stylesheets -->
	<link rel="stylesheet" href="contact-form/css/contact-form.css" type="text/css">	
...
<body>
							...
							<div class="row">
								...
								<div class="col-sm-12">
									<div class="item-content colBottomMargin">
										<div class="item-info">
											<h2 class="item-title text-center">Nuestro Restaurante Te esta esperandos</h2>
		...
		<div class="container">			
			...
			<div class="row">					
				<div class="footer-top col-sm-12">
					<p class="text-center copyright">&copy; 2019 <a href="#" class="footer-site-link">Genesis Mendoza</a>LaTenaza todos los derechos reservados. </p>
				</div><!-- end col --> 
			</div><!-- end row -->
	...
	<!-- jQuery Library -->
	<script src="contact-form/js/jquery-3.2.1.min.js"></script>	
	<!-- Popper js -->
	<script src="contact-form/js/popper.min.js"></script>
	<!-- Bootstrap Js -->
	<script src="contact-form/js/bootstrap.min.js"></script>
	<!-- Form Validator -->
	<script src="contact-form/js/validator.min.js"></script>
	<!-- Contact Form Js -->
	<script src="contact-form/js/contact-form.js"></script>
