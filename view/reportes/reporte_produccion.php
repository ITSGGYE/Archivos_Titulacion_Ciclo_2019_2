<div class="row">
    <div class="col-md-12">
        <div class="card card-topline-red">
            <div class="card-head">
                <header>REPORTE DE PRODUCCION</header>
            ...
            <div class="card-body ">
                <div>
                    <form method="post" action="index.php?c=reportes&a=consultarProduccion">
                ...
                <div class="float-right">
                    ...
                    <form method="post"  target="_blank" action="index.php?c=reportes&a=generarReporteProduccionPDF">
                        <div class="input-group input-group-sm">
                        ...
                        <?php if ($datos != null) { ?>
                            <?php foreach ($datos as $dato) : ?>
                                <tr class="odd gradeX">
                                    ...
                                    <td><?php echo $dato['panes']; ?> </td>
                                    <td><?php echo $dato['masas']; ?> </td>
                                    <td><?php echo $dato['bono']; ?> </td>
