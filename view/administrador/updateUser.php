...
<main>
    <div class="title-indicator"> <span>Actualizar Usuario</span> </div>
    <div class="container">
        <div class="row card-panel">
            <form action="../../controller/ClassUsuariosC.php" method="POST" enctype="multipart/form-data" id="buscar_usuario_form" class="col s12">
                <div class="center">
                    <div class="row">
                        <div class="input-field col s6">
                            <input onkeypress="return soloNumeros(event);" required onpaste="return false"  id="find_cedula" name="find_cedula" type="text" class="validate">
                            <label for="find_cedula">CEDULA * </label>
                        </div>

                        <div class="input-field col s6">
                            <button class="btn waves-effect waves-light" type="submit" name="action">BUSCAR USUARIO
    ...
    <div class="container" id="form_agregar">
        <div class="row card-panel">
            <form action="../../controller/ClassUsuariosC.php" method="POST" enctype="multipart/form-data" id="actualizar_usuario_form" class="col s12">
                <div class="center">
                    <div class="row">
                        <div class="input-field col s12">
                            <input readonly="true" onkeypress="return soloNumeros(event);" required onpaste="return false"  id="cedula" name="cedula" type="text" class="validate">
                        ...
                        <div class="input-field col s6">
                            <input id="form_update_usuario" name="form_update_usuario" value="true" type="hidden">
