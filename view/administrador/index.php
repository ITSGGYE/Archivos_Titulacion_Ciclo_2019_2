        ...
        <div class="container">
            <div class="boxes">
                <div class="images-boxes">
                    <a class="boxes-link" href="productos.php"> <img src="../../images/produccion.png" alt="prosuctos-guanabaso" srcset=""></a>
                </div>
                <div class="title-boxes">
                    <a class="boxes-link" href="productos.php"> <span>Productos</span></a>
                </div>
            </div>
            ...
            <div class="boxes">
                ...
                <div class="title-boxes">
                    <a class="boxes-link" href="inventario.php"> <span>Inventario</span></a>
                </div>
            </div>
            ...
            <div class="boxes">
                <div class="images-boxes">
                    <a class="boxes-link" href="usuarios.php"> <img src="../../images/equipo.png" alt="prosuctos-guanabaso" srcset=""></a>
                </div>
                <div class="title-boxes">
                    <a class="boxes-link" href="usuarios.php"> <span>Usuarios</span></a>
                </div>
            </div>
