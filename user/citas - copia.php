                        ...
                        <?php
                          foreach($paciente as $row) {?>
                                  <tr >
                                      ...
                                      <td><button class="btn btn-danger deletebtn" data-toggle="modal" data-target="#eliminar">Cancelar</button> </td>
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true" style="font-size: 40px;">&times;</span></button> 
      	   <div style="background:#222222;color:white;letter-spacing: 12px;" class="alert "><strong> <h5 style="font-size:15px;  font-weight: bold; color:white" class="modal-title" id="exampleModalLabel"><center>AGREGAR CITA</center></h5></strong></div>
            <br> <br>
             </div>
                <div class="modal-body">
                <!----- Formulario  ---->
                  <form action="registrar_citas.php" method="POST" >
                     <div class="form-group">
                      <?php include_once("conexion.php");
                        ...
                        ?>
                          ...
                          <div class="form-group">
                          <label for="">Especialidad del Especialista de Cita</label>
                          ...
                          <div class="form-group">
                          <label>Motivo:</label>
                          <textarea placeholder="Escribir Motivo de Cita:" name="observacion"  class="form-control"></textarea>
                          </div>
                          ...
                          <div class="modal-footer"><br>  
                                  ...
                                  <button style="color: black; background:#ff7655; " type="submit" class="btn ">Guardar Cita</button>
                          </div>
