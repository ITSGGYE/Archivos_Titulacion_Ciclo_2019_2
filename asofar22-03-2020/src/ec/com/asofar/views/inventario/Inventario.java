...
import ec.com.asofar.views.reporteria.*;
...
public class Inventario extends javax.swing.JDialog {
    ...
    public Inventario(java.awt.Frame parent, boolean modal, SeUsuarios us, SeEmpresa em, SeSucursal su) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        seUsuario = us;
    ...
    public PrProductoBodega devuelveObjeto(Long id, List<PrProductoBodega> listabod) {
        PrProductoBodega doc = null;
        for (int i = 0; i < listabod.size(); i++) {
            if (Objects.equals(listabod.get(i).getPrProductoBodegaPK().getIdProducto(), id)) {
                doc = listabod.get(i);
                break;
            }
        }
    ...
    private void tablaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMousePressed
        ...
        if (evt.getClickCount() == 2) {
            ...
            objeto = devuelveObjeto(Long.valueOf(tabla.getValueAt(i, 0).toString()), lista);
            if (objeto != null) {

                ActualizarCantidad ingre = new ActualizarCantidad(new javax.swing.JFrame(), true, objeto);
