...
<body style="background-image: url('imagen/fondo_blanco.jpg'); background-position: center center;      
    ...
    <table class="table table-striped table-hover">
        ...
        <tr>
                ...
                <td scope="row" style="cursor: pointer;"><a href="ver_pasante.php?cargar=ver_pasantes&ver_est=<?php echo $row['pst_cedula']; ?>"><i class="fa fa-file-text fa-2x" style="color:#0985E1;"></i></a>
                    </td>
                <td scope="row"><a href="editar_pasante.php?cargar=editar_pasante&editar_pst=<?php echo $row['pst_cedula']; ?>"><i class="fa fa-pencil-square-o fa-2x" style="color:#0985E1;"></i></a>
                    </td>
                <td scope="row"><a href="<?php echo 'historial_pasante.php?func=delete&codice='.$row['pst_id']; ?>"><i class="fa fa-trash fa-2x" style="color:red;"></i></a>
                </td>
            </tr>
                <?php } ?>
            </tbody>
		  ...
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
			  <div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Imagen del Pasante</h5>
    ...
    <script>
        function verimagen(id,extension){
            ...
            $('#imagenpostulante').append('<img src="../appws/files/pasantes/cufo_'+id+'.'+$ext+'">');
        ...
        function viewImage(id){
            ...
            $.ajax({
                ...
                success: function(result){
                    $('#imagenpostulante').empty();
                    $('#imagenpostulante').append('<img src="../appws/files/pasantes/cufo_'+id+'.'+result+'">');
                    $('#exampleModal').modal('show');
                }
            })
        }
