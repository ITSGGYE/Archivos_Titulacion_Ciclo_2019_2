                            ...
                            <!--chat --><div class="row">
                                <div class="col-md-12">
                                    <div class="form-group has-feedback">
                                        ...
                                        <select name="respuesta" id="respuesta" class='form-control' required="" aria-required="true">
                                        <option value=""> -- SELECCIONE -- </option>
                                        <?php
                                        $activos = new Login();
                                        $activos = $activos->ListarClientesActivos();
                                        for($i=0;$i<sizeof($activos);$i++){ ?>
                                        <option value="<?php echo $activos[$i]['codcliente'] ?>"><?php echo $activos[$i]['nomcliente'] ?></option>        
                                        <?php } ?>
                                        </select>
                                    </div>
                                </div>
