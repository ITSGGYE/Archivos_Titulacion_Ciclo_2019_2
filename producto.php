          ...
          <div class="panel-body">
            <div class="row">
              <div class="col-sm-4 col-sm-offset-2 text-center">
				 <img class="item-img img-responsive" src="img/hoao.png" alt=""> 
				  <br>
              ...
              <div class="col-sm-4 text-left">
                <div class="row margin-btm-20">
                    ...
                    <div class="col-sm-12">
                      <span class="current-stock">Productos disponible</span>
                    </div>
                    <div class="col-sm-12 margin-btm-10">
                      <span class="item-quantity"><?php echo number_format($row['stock'],2);?></span>
                    </div>
					<div class="col-sm-12">
                      <span class="current-stock"> Precio de venta  </span>
                    </div>
					<div class="col-sm-12">
                    ...
                    <div class="col-sm-6 col-xs-6 col-md-4 ">
                      <a href="" data-toggle="modal" data-target="#add-stock"><img width="110px"  src="img/agregar.png"></a>
                    </div>
                    <div class="col-sm-6 col-xs-6 col-md-4">
                      <a href="" data-toggle="modal" data-target="#remove-stock"><img width="110px"  src="img/eliminar.png"></a>
                    </div>
                    <div class="col-sm-12 margin-btm-10">
                    </div>
            ...
            <div class="col-sm-8 col-sm-offset-2 text-left">
                  <div class="row">
                    <?php
						...
						<div class="alert alert-success alert-dismissible" role="alert">
						  ...
						  <strong>Aviso!</strong> Proceso Exitoso.
						</div>	
							<?php
						}
						if (isset($error)){
				 ...
				 <table class='table table-bordered'>
						<tr>
							<th class='text-center' colspan=5 >HISTORIAL DE PRODUCTOS </th>
						</tr>
						<tr>
							<td>Fecha</td>
							<td>Hora</td>
