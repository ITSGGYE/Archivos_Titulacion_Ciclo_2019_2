...
$creanti=$_GET["creanti"];


$factufa ="";

				$result22 = $mysqli->query("select factu from datoscredito where idcred = '$creanti'  ");
		...
		<div class="searcher sqlQuerySearcher">
								...
								<div class="campSearcher">
										...
										<table width="441" border="1">
										  <tr>
                                            <td><div class="label">
                                                <label for="COD_DICC" class=""> # Cuenta Refinanciada</label>
                                            </div></td>
										    <td><span class="Estilo4"><?php print $factufa; ?></span></td>
									      </tr>
      ...
      <td>
        ...
        <?php print $coucre;?>        </span> </td>
				 ...
				 <div class="searcherButtons">
						...
						<a href="refinanciar.php"><img src="grafico/nux.png"  /></a>
