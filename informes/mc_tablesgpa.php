...
function Header()
{
	...
	$this->Image('imgs/cabe3.jpg',5,0,70,0,'',''); //para la imagen del reporte
	
	$this->SetFont('Arial','BU',8);
	$this->Text(175,5,'RUC 0923282172001',0,'C', 0);
	$this->SetFont('Arial','',6);
	$this->Text(175,9,'VENTA AL POR MENOR',0,'C', 0);
	$this->Text(175,11,'DE REPUESTOS ELECTRONICOS',0,'C', 0);
	$this->Text(175,13,'2764464 - 0985977803',0,'C', 0);
	
	$this->SetFont('Arial','BU',9);
	
	
	$this->Text(14,16,'Holguin Anzules Luigi Javier',0,'C', 0);
	
	$this->Ln(2);
	$this->SetFont('Arial','',8);
	 $this->Cell(220,3,'B. Los Angelitos, Av. 15 de Agosto s/n y Cristina Orrala',0,1,'C');

 $this->Cell(220,3,'luigy.l.h@hotmail.com - Playas(General Villamil) - Ecuador',0,0,'C');
