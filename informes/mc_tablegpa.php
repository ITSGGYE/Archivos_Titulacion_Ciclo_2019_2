...
function Header()
{
	...
	$this->Text(110,5,'RUC 0923282172001',0,'C', 0);
	$this->SetFont('Arial','',6);
	$this->Text(110,9,'VENTA AL POR MENOR',0,'C', 0);
	$this->Text(110,11,'DE REPUESTOS ELECTRONICOS',0,'C', 0);
	$this->Text(110,13,'2764464 - 0985977803',0,'C', 0);
	...
	$this->Ln(7);
	$this->SetFont('Arial','',6);
	 $this->Cell(0,3,'B. Los Angelitos, Av. 15 de Agosto s/n y Cristina Orrala',0,1,'C');

 $this->Cell(0,3,'luigy.l.h@hotmail.com - Playas(General Villamil) - Ecuador',0,0,'C');
