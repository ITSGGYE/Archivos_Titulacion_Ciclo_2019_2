...
function Header()
{
//	$this->Image('imgs/cabe2.jpg',9,0,110,25,'',''); //para la imagen del reporte
//	$this->Image('imgs/cabe2.jpg',100,0,20,30,'',''); //para la imagen del reporte
	$this->Image('imgs/cabe2.jpg',0,0,150,0,'',''); //para la imagen del reporte
...
$p1 = gmdate('H:i:s', time() + ($zona_horaria * 3600));
	...
	$this->Cell(0,6,'_______________________________',0,1,'C');
	 $this->Cell(0,6,$p2,0,1,'C');
	$this->Cell(0,6,'Colector',0,1,'C');
