...
function Header()
{
	...
	$this->Image('imgs/cabe2.jpg',30,0,120,0,'',''); //para la imagen del reporte
...
$p1 = gmdate('H:i:s', time() + ($zona_horaria * 3600));
	...
	// $this->Cell(80,10,'Hora '.$p1,0,0,'');
	 ...
	 $this->Cell(0, 6, '________________________________________', 0, 1, 'C');
	 $this->Cell(0, 6, 'Firma Docente', 0, 1, 'C');
	 // $this->Cell(90,10,'Usuario :'.$p2,0,0,'');
   }
