...
<body class="loader-active" style="background-image: url('imagen/fondo_blanco.jpg'); background-position: center center;      
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 d-none d-xl-block">
                        <nav class="mainmenu alignright">
                            <ul>                                    
                                <li class="active"><a style="color: yellow;" href="online_pasantes.php?func=mostrar">Volver Atrás</a></li>
    ...
    <section id="lgoin-page-wrap" style="margin-top:150px;" class="section-padding">
        ...
        <h2 style="text-align: center; color: #0985E1; font-size: 1.5rem;">Ficha de Identificación del Pasante Online</h2><br>
        ...
        <th style="color:#0985E1;">Dependiente:</th>
        ...
        <th style="color:#0985E1;">Universidad:</th>
        ...
        <?php $img = '<img src="../appws/files/pasantes_online/cufo_'. $row["pst_id"].".".$row["pst_foto"].'" style="width: 100%;">'; ?>
        <tr>
        <th style="color:#0985E1;">Foto:</th>
