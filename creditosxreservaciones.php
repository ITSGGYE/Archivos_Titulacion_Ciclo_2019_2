                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" class="form-control" name="nroreservacion" id="nroreservacion" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Nº de Reservación" autocomplete="off" disabled="" aria-required="true"/> 
                            <i class="fa fa-bolt form-control-feedback"></i>
                        </div>
                    </div>
