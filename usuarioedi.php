...
$cocli = "";
	...
	$result22 = $mysqli->query("select cedula,nombres,apellidos,nomape,usuario,clave,tipousuario from usuario where idusuario = '$idpro'  ");
...
$result22 = $mysqli->query("select tipousu from tipousu where idtipo1 = '$tici'  ");
if ($result22->num_rows > 0 )
	{
	$row1 = $result22->fetch_array();
...
Cedula</label> 
 ...
 <input name="cedula" type="text" id="cedula"  style="height:22px; font-size:12px;" onKeyPress="return soloLetras1(event); " value="<?php print $ruc; ?>" maxlength="13" />
</div> 
...
Nombres</label> 
 ...
 <input name="nombre" type="text" id="nombre"  style="height:22px; font-size:12px;" onKeyPress="return soloLetras(event); " value="<?php print $nombre; ?>" maxlength="30" />
</div> 
<div class="field">  
...
Apellidos</label> 
 ...
 <input name="apellido" type="text" id="apellido"  style="height:22px; font-size:12px;" onKeyPress="return soloLetras(event); " value="<?php print $apellido; ?>" maxlength="30" />
</div> 
<div class="field">  
...
Usuario/Alias</label> 
 ...
 <input name="usua" type="text" id="usua"   style="height:22px; font-size:12px;" value="<?php print $feca;?>" maxlength="30" />
</div> 
<div class="field">  
...
Calve</label> 
 ...
 <input name="clav" type="text" id="clav"   style="height:22px; font-size:12px;" value="<?php print $telefono1; ?>" maxlength="30" />
<input name="op" type="hidden" id="op" value="55" />
                            ...
                            <input name="nombre3" type="hidden" id="nombre3" value="<?php print $feca;?>" />
                            <input name="cedula2" type="hidden" class="field2" id="cedula2" />
</div> 
<div class="field">  
