          ...
          <section  class="section">
            <div   class="wrapp">
              <article class="articles" >
                <div class="mensaje">
                  <h2 > CITAS ASIGNADAS </h2></div>
                  <a class="agregar" style="text-decoration: none;" title="Agregar" href="agregarcitas_paciente.php">Agregar Citas</a>  
                  <a class="agregar" style="text-decoration: none;" title="Calendario" href="calendario.php">Calendario</a>
                  <div >
                    <div>
                      <div class="col-8">
...
//print_r($var);
                           ...
                           foreach($paciente as $row) {?>
                            <tr >
                             ...
                             <td> <a href="pdf/reporte_pdf.php?id=<?php echo $row->id_cita?>" class="btn btn-warning"  target="_blank" > Reporte</a> </td>
                           </tr>
                        ...
                        <div class="modal-body">
                         ...
                         <form action="editar_citas.php" method="POST" >
                          ...
                          <div class="form-group">
                            ...
                            <!--<input  class="form-control" type="time" name="hora" id="hora" value="11:45" min="8:00" max="20:30" min="08:00" step="60" required>-->
                          </div>
                          <div class="form-group">
