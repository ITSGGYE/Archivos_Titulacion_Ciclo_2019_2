				...
				<section  class="section">
					<div   class="wrapp">
						<article class="articles" >
							...
							<p  style="color: grey; position: absolute; top:40px; font-weight: bold;">Para Mas Información Doble Click en la Citas Ocupadas </p>
							<div style="font-size:-40px;"  class="container-fluid">
												...
												<form class="form-horizontal" method="POST" action="">
													...
													<div class="modal-body">
														<div class="form-group">
															...
															<div class="col-sm-10">
																<input placeholder="???"  type="text" name="title" class="form-control" id="title"   readonly>
															</div>
														</div>
														<div class="form-group">
