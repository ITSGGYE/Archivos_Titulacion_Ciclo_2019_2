...
if (isset($_POST["pst_cedula"])) {
    ...
    try {
        ...
        if($conexion->query($statement)){
            ...
            echo "<script>alert('PASANTES ACTUALIZADO CON EXITO');
            window.location.href='online_pasantes.php?func=mostrar';</script>";
        }
...
<head>
    ...
    <title>Fundación Ecuador People - Editar pasantes online</title>
...
<body class="loader-active" style="background-image: url('imagen/fondo_blanco.jpg'); background-position: center center;      
    ...
    <section id="lgoin-page-wrap" style="margin-top:150px;" class="section-padding">
        ...
        <h4 style="color: #0985E1;">Editar Datos de Pasante online
        </h4></center><br>
      <form style="color:#0985E1;" enctype="multipart/form-data" action="" method="POST">
          ...
          <div class="form-row">
            ...
            <div class="col-lg-2 col-md-3">
             ...
             <div class="col-lg-1 col-md-3">
                <input onkeypress="return soloCedula(event)" id="pst_edad" name="pst_edad" value="<?php echo $row['pst_edad']; ?>" type="text" required>
        ...
        <div class="form-row">
            ...
            <div class="col-lg-3 col-md-3">
                  <input onkeypress="return soloMail(event)" id="pst_direccion_ref" name="pst_direccion_ref" value="<?php echo $row['pst_direccion_ref']; ?>" type="text" required="">
