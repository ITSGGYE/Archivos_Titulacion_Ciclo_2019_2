...
public class SAdministracionProveedores extends HttpServlet {
	...
	public String listarProveedoresxFiltros(HttpServletRequest request){
		...
		String codigo = (!"".equals(request.getParameter("codigo"))?request.getParameter("codigo"):"");
		String nombre = (!"".equals(request.getParameter("descripcion"))?request.getParameter("descripcion"):"");
		...
		return beanProveedores.listarProveedoresxFiltros(identificacion,tipoidentificacion,codempresa,nombre,codigo);
	}
	...
	public String mantenimientoProveedores(HttpServletRequest request) {
		...
		return beanProveedores.mantenimientoProveedores(codEmpresa,Long.parseLong(codProveedor),nombres,apellidos,tipoidentificacion,identificacion,estransportista,direccion,telefonofijo1,telefonofijo2
														,celular,fax,email,cargocontacto,contacto,observacion,codusuario,fecha,modo);
	}
	...
	public String listarProveedorAgrupador(HttpServletRequest request){
		long codempresa = (Long.parseLong(request.getParameter("codempresa")));
		...
		return beanProveedores.listarProveedorAgrupador(codempresa, codigo, descripcion,tipoRespuesta);
	}
	...
	private void procesar(HttpServletRequest request,
		...
		switch(enumOrdenes){
			...
			case ELIMINAR_PROVEEDOR:
				...
				break;
			case AGRUPADOR_PROVEEDOR:
				out.print(listarProveedorAgrupador(request));
				break;
		}
