...
import ec.com.academico.util.Cargar;
...
public class Frm_CargarSistema extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Frm_CargarSistema
     */
    ...
    public void imagenes() {
        ...
        Image logof = new ImageIcon(getClass().getResource("/ec/com/academico/imagenes/fondo.jpg")).getImage();
    ...
    private void carga_pbStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_carga_pbStateChanged
        ...
        if (carga_pb.getValue() == 100) {
            if (!EntityManagerUtil.obtenerEntityManagerConnection()) {
                ...
                dispose();
                Login2 fl = new Login2(new javax.swing.JFrame(), true);
                fl.setVisible(true);
            }
        }
