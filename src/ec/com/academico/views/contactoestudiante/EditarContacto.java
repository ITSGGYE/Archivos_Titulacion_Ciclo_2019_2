 ...
 * @author Usuario
 */
public class EditarContacto extends javax.swing.JDialog {

    /**
     * Creates new form AgregarContacto
     */
    SeContactoEstudiante ContactEst;
    int x, y;
//    SeContactoEstudiante Contacto = new SeContactoEstudiante();
    ...
    public EditarContacto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public EditarContacto(java.awt.Frame parent, boolean modal, SeContactoEstudiante contacto) {
        super(parent, modal);
        initComponents();
        ContactEst = contacto;
        cargarDatos();
    ...
    public void cargarDatos() {
        txt_nombre_completo.setText(ContactEst.getNombreCompleto());
        txta_direccion.setText(ContactEst.getDireccionDomiciliaria());
        txt_celular.setText(ContactEst.getCelular());
        txt_correo.setText(ContactEst.getEmail());
        txt_telefono.setText(ContactEst.getTelefono());
    }
...
//            Contacto.setIdEstudiante(estudiantes);
            ContactEst.setNombreCompleto(txt_nombre_completo.getText());
            ContactEst.setDireccionDomiciliaria(txta_direccion.getText());
            ContactEst.setTelefono(txt_telefono.getText());
            ContactEst.setCelular(txt_celular.getText());
            ContactEst.setEmail(txt_correo.getText());
            ContactEst.setEstado('A');
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditarContacto dialog = new EditarContacto(new javax.swing.JFrame(), true);
