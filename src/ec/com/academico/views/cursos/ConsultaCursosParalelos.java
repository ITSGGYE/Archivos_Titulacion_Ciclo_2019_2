 ...
 * @author Usuario
 */
public class ConsultaCursosParalelos extends javax.swing.JDialog {

    /**
     * Creates new form ConsultaCursosParalelos
     */
    int x, y;
    int alto = java.awt.Toolkit.getDefaultToolkit().getScreenSize().height;
    int ancho = java.awt.Toolkit.getDefaultToolkit().getScreenSize().width;
    String valor = "";
    List<RelCursoParalelo> listReCurPar;
    RelCursoParaleloJpaController rc = new RelCursoParaleloJpaController(EntityManagerUtil.obtenerEntityManager());

    public ConsultaCursosParalelos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        setLocationRelativeTo(null);
        cargarTbaCursosParalelos();
    }

    public void cargarTbaCursosParalelos() {
        listReCurPar = rc.findRelCursoParaleloEntities();
        Tablas.listarCursoParalelo(listReCurPar, TbaRepresentante);
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        AgregarCursoParalelo ar = new AgregarCursoParalelo(new javax.swing.JFrame(), true);
        ar.setVisible(true);
        cargarTbaCursosParalelos();
...
//        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        for (int i = 0; i < TbaRepresentante.getRowCount(); i++) {
            ClaseReporte tabla1 = new ClaseReporte(TbaRepresentante.getValueAt(i, 0).toString(),
                    " " + TbaRepresentante.getValueAt(i, 1).toString(),
                    " " + TbaRepresentante.getValueAt(i, 2).toString());
            tablac.add(tabla1);
        }
        try {
//            String dir = System.getProperty("user.dir") + "/src/" + "/ec/" + "/com/" + "/academico/" + "/views/" + "/report/"
//                    + "ConsultaCursosParalelos.jasper";

            String dir = "/ec/com/academico/views/report/ConsultaCursosParalelos.jasper";
//            JasperReport reporte = (JasperReport) JRLoader.loadObject(dir);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaCursosParalelos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConsultaCursosParalelos dialog = new ConsultaCursosParalelos(new javax.swing.JFrame(), true);
