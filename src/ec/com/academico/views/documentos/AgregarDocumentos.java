 ...
 * @author Usuario
 */
public class AgregarDocumentos extends javax.swing.JDialog {
    ...
    public AgregarDocumentos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    public void guardar() {
        try {
            ...
            if (valor1 == true) {
                JOptionPane.showMessageDialog(this, "El Documento ya existente");
            } else {
            objDoc.setDocumento(txt_nombres.getText());
            objDoc.setEstado('A');
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AgregarDocumentos dialog = new AgregarDocumentos(new javax.swing.JFrame(), true);
