 ...
 * @author Usuario
 */
public class AgregarParentesco extends javax.swing.JDialog {

    /**
     * Creates new form AgregarDocumentos
     */
    int x, y;
    Parentesco objParen = new Parentesco();
    ParentescoJpaController dc = new ParentescoJpaController(EntityManagerUtil.obtenerEntityManager());

    public AgregarParentesco(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    public void guardar() {
        try {
            boolean valor1 = ValidarDTO.ValidarDocumentos(txt_nombres.getText());
            if (valor1 == true) {
                JOptionPane.showMessageDialog(this, "El Parentesco ya existente");
            } else {
            objParen.setNombre(txt_nombres.getText());
            objParen.setEstado('A');
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AgregarParentesco dialog = new AgregarParentesco(new javax.swing.JFrame(), true);
