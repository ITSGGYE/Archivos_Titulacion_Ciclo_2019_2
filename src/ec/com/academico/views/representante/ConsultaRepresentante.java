 ...
 * @author Usuario
 */
public class ConsultaRepresentante extends javax.swing.JDialog {
    ...
    public ConsultaRepresentante(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        setLocationRelativeTo(null);
        cargarTbaRepresentantes();
    }

    public void cargarTbaRepresentantes() {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        AgregarRepresentante ar = new AgregarRepresentante(new javax.swing.JFrame(), true);
        ar.setVisible(true);
        cargarTbaRepresentantes();
...
//        }
    ...
    public Representante devuelveObjeto(Long id, List<Representante> lista) {
        Representante doc = null;
        for (int i = 0; i < lista.size(); i++) {
            if (Objects.equals(lista.get(i).getIdRepresentante(), id)) {
                doc = lista.get(i);
                break;
            }
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (TbaRepresentante.getSelectedRow() >= 0) {
            ...
            objRepre = devuelveObjeto(Long.valueOf(TbaRepresentante.getValueAt(id, 0).toString()), listRepr);
            if (objRepre != null) {
                EditarRepresentante Pe = new EditarRepresentante(new javax.swing.JFrame(), true, objRepre);
                Pe.setVisible(true);
                cargarTbaRepresentantes();
            }
        } else {
            JOptionPane.showMessageDialog(null, "SELECCIONE UN REPRESENTANTE PARA EDITAR");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaRepresentante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConsultaRepresentante dialog = new ConsultaRepresentante(new javax.swing.JFrame(), true);
