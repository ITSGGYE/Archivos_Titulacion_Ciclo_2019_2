		...
		<q-card style="width: 380px">
			<div class="q-pa-md">
				...
				>
					...
					<!-- <template v-slot:navigation>
        <q-stepper-navigation>
          <q-btn @click="$refs.stepper.next()" color="deep-orange" :label="step === 2 ? '<q-btn color="primary" @click="guardar">Guardar</q-btn>' : 'Continuar'" />
...
<script>
	export default {
		...
		methods: {
			...
			terminar() {
				if(this.id_estudiantes !== null && this.id_estudiantes !== "" )
				{
					this.$q.loading.show();
					_.rpost(`familiares/crearr`, null, {
						_id_estudiantes: this.id_estudiantes,
