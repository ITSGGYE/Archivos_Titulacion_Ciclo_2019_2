	...
	export default {
		...
		methods: {
			...
			editarFamiliar(row) {
				...
				this.id_estudiantesss = row.nombre;
									...
									if (digito_validador == ultimo_digito) {
										...
										_.rput(`familiares/${this.ids}`, null, {
											...
											id_ctlg_profesioness: this
												.id_ctlg_profesioness,
											id_ctlg_estados_civilss: this
												.id_ctlg_estados_civilss,
											id_ctlg_cantoness: this
												.id_ctlg_cantoness,
											id_ctlg_parentescoss: this
												.id_ctlg_parentescoss,
											lugar_trabajoss: this
												.lugar_trabajoss,
											direccion_trabajoss: this
												.direccion_trabajoss,
											telefono_trabajoss: this
												.telefono_trabajoss,
