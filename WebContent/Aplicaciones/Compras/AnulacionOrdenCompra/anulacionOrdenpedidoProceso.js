var PlantillasProceso = function() {
						...
						{dataIndex : "codarticulo",name : "codarticulo",header : "codarticulo",width : 100,hidden : true,hideable : true},
						{
							...
							editor : new Ext.form.ChooserField({
										...
										onTriggerClick : function() {
											//abrirAgrupador(this, "A");
											//alert("on tigger");
											if(componentes.cmbEstadoPedido.getValue() != 3)
												AgrupadorArticulo();
										},
										listeners : {
											scope : this,
	...
	panelSurTotales = new Ext.Panel({
		...
		html : '<div align="right" style="width:50%;float:right">'
				...
				+'<div align="left" style="width:50%;">'
  					+'<table border="0">'
						+'<tr>'
							+'<label class="lbl_totales" for="fname">Mtv. Anulaci&oacute;n:  </label><textarea id="textAreaObservacion" style="width:350px;height:50px;background: #FFFFCC !important;border:1px solid black !important;" id="fname" rows="2" cols="50" width="150px" placeholder="--"></textarea><br>' 
						+'</tr>'
						+'</table>'
				+'</div>'
	});
	...
	var panelPrincipal = new Ext.form.FormPanel({
		...
		buttons : [ botones.cmdVerPDF, botones.cmdAnular/*,botones.cmdGuardar*/,botones.cmdCancelar]
	});
	...
	var prepararVentana = function() {
		...
		botones.cmdAnular.setDisabled(true);
	...
	var cargarRegistro = function(data) {
		...
		document.getElementById("textAreaObservacion").value = data.motivoanula;
