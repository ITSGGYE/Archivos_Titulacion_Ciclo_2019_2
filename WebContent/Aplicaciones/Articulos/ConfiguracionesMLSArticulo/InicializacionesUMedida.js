...
var configuracion = {
	tituloVtnProceso : "AÑADIR UNIDAD MEDIDA",
	icon: "iconoMarca",
	ancho : 320,
	alto: 130,
	orden : "GUARDAR_UMEDIDA",
	...
	cm : [new Ext.grid.RowNumberer(), new Ext.grid.CheckboxSelectionModel(),
		{dataIndex : "codigo",header : "COD. U. MEDIDA",width : 100,hidden : false},
		{dataIndex : "descripcion", id: "DESCRIPCION",header : "descripcion",width : 100,hidden : false},
