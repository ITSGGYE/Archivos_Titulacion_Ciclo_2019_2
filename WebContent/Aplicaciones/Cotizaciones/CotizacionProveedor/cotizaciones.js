var Plantillas = function() {
	...
	var modeloDatos = {
		storeGridPrincipal : new Ext.data.Store({
			...
			baseParams : {
				orden : "LISTAR_COTIZACIONES_FILTROS",
				start : 0,
				limit : 20,
		...
		columnasGridPrincipal : [new Ext.grid.RowNumberer(), check, 
				{dataIndex : "codcotizacion",header : "N° Cotización",width : 100,hidden : false, renderer:obtenerNumeropedido},
				{dataIndex : "codagencia", id: "codagencia",header : "codagencia",width : 100,hidden : true},
				{dataIndex : "grupo",header : "Grupo",width : 100, hidden:false},
				...
				{dataIndex : "fechavalida",header : "Fecha Validez",width : 100,hidden : false,align:'center'},
				...
				{dataIndex : "terminos",header : "terminos",width : 100,align:'center', hidden:true}
		]
	...
	var componentesFiltro = {
		...
		txtcodpedido : new Ext.form.TextField({
					fieldLabel : "Cod. Cotizaci&oacute;n",
					name : "txtcodpedido",
					readOnly : false,
					width : 130,
					maskRe : /[\d\.]/,
	...
	*/
	...
	botones.cmdBorrar.on("click", function() {
				...
				componentesFiltro.txtFechaDesde.setValue(new Date());
				componentesFiltro.txtFechaHasta.setValue(new Date());
	...
	botones.cmdBuscar.on("click", function() {
		//long codpedido, String codproveedor, String numdocumento,
		var codcotizacion = componentesFiltro.txtcodpedido.getValue();
		...
		modeloDatos.storeGridPrincipal.baseParams.codigo = codcotizacion;
		modeloDatos.storeGridPrincipal.baseParams.codproveedor = codproveedor; 
		modeloDatos.storeGridPrincipal.baseParams.grupo = numdocumento;
